...
TEST(std_wobservable_map_test_suite, cpp11_not_supported) {}
#else
...
TEST(std_wobservable_map_test_suite, test_insert_single_element)
{
    ...
    EXPECT_EQ(0, m->size());
    const std::initializer_list<m::wobservable_map<int, int>::value_type> il =
    {
...
TEST(std_wobservable_map_test_suite, test_swap)
{
    ...
    const std::initializer_list<m::wobservable_map<int, int>::value_type> il2 =
    {
        m::wobservable_map<int, int>::value_type(10, 100),
        m::wobservable_map<int, int>::value_type(20, 200),
        m::wobservable_map<int, int>::value_type(30, 300),
        m::wobservable_map<int, int>::value_type(40, 400),
        m::wobservable_map<int, int>::value_type(50, 500),
        m::wobservable_map<int, int>::value_type(60, 600),
        m::wobservable_map<int, int>::value_type(70, 700)
    };
    *m1 = il1;
    *m2 = il2;
    EXPECT_EQ(5, m1->size());
