//
//  placebo_mutex_command_manager_test_suite.cpp
//
...
TEST(std_command_manager_placebo_mutex_test_suite, cpp11_not_supported) {}
#else
...
TEST(std_command_manager_placebo_mutex_test_suite, test_command_manager)
{
    TEST_CASE_SHIPYARD
...
TEST(std_command_manager_placebo_mutex_test_suite, test_spaceship_observer)
{
    TEST_CASE_SHIPYARD
