...
TEST(std_basic_event_manager_test_suite, required_cpp11_feature_not_supported) {}
#else

// Test event_manager
using string_type = s::u8string;
using fleet_commander_type = go_test::fleet_commander<m::basic_event_manager<string_type>, p::u8property<string_type>, p::value_u8property<string_type>, pro::value_u8property<string_type>>;
