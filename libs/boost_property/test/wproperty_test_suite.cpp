...
TEST(boost_wproperty_test_suite, value_scalar_properties)
{
    spaceship s;
...
TEST(boost_wproperty_test_suite, ro_scalar_properties)
{
    ro_spaceship s;
...
TEST(boost_wproperty_test_suite, wo_scalar_properties)
{
    wo_spaceship s;
...
TEST(boost_wproperty_test_suite, ref_scalar_properties)
{
    ref_spaceship s;
...
TEST(boost_wproperty_test_suite, ro_ref_scalar_properties)
{
    ro_ref_spaceship s;
...
TEST(boost_wproperty_test_suite, wo_ref_scalar_properties)
{
    wo_ref_spaceship s;
...
TEST(boost_wproperty_test_suite, ro_value_properties)
{
...
TEST(boost_wproperty_test_suite, wo_value_properties)
{
