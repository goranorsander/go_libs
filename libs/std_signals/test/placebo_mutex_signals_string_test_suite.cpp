//
//  placebo_mutex_signals_string_test_suite.cpp
//
...
TEST(std_signals_string_placebo_mutex_test_suite, cpp11_not_supported) {}
#else
...
public:
    ...
    typedef s::signal<std::function<void(const bool&)>, u::placebo_mutex> fire_lasers_signal;
    typedef s::signal<std::function<bool()>, u::placebo_mutex> fire_proton_torpedoes_signal;
...
TEST(std_signals_string_placebo_mutex_test_suite, test_fire_lasers)
{
    TEST_CASE_SHIPYARD
...
TEST(std_signals_string_placebo_mutex_test_suite, test_fire_proton_torpedoes)
{
    TEST_CASE_SHIPYARD
...
TEST(std_signals_string_placebo_mutex_test_suite, test_fire_all_weapons)
{
    TEST_CASE_SHIPYARD
