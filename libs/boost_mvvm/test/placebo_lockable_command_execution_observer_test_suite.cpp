...
#include <go_boost_test/test_command_execution_observer.hpp>
...
GO_BOOST_USING(test_command_execution_observer, go_boost_test::test_command_execution_observer<test_command_traits>);
