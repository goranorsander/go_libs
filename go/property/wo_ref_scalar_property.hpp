...
template<class T, class S = std::string> class wo_ref_scalar_property : public detail::wo_property_base<T, policy::ref<T>, S>
{
public:
...
public:
    ...
    wo_ref_scalar_property(const string_type& property_name)
        : detail::wo_property_base<value_type, policy::ref<value_type>, string_type>(policy::ref<value_type>(), property_name)
    {
    }

    explicit wo_ref_scalar_property(const string_type& property_name, const value_type& v)
        : detail::wo_property_base<value_type, policy::ref<value_type>, string_type>(policy::ref<value_type>(v), property_name)
    {
    }
