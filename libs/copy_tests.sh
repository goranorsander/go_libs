...
cp ./clang/libs/boost_exception/GO_boost_libraries_diagnostics_tests ./bin/clang/.
...
cp ./clang/libs/std_exception/GO_std_libraries_diagnostics_tests ./bin/clang/.
...
cp ./gcc/libs/boost_exception/GO_boost_libraries_diagnostics_tests ./bin/gcc/.
...
cp ./gcc/libs/std_exception/GO_std_libraries_diagnostics_tests ./bin/gcc/.
