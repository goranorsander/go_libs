...
{
    // Test insert _after single element
    m::wobservable_forward_list<int>::ptr l = m::wobservable_forward_list<int>::create();
    forward_list_observer<int> o;
...
TEST(boost_wobservable_forward_list_test_suite, test_erase_position)
{
    // Test erase after after position
    m::wobservable_forward_list<int>::ptr l = m::wobservable_forward_list<int>::create();
    forward_list_observer<int> o;
...
TEST(boost_wobservable_forward_list_test_suite, test_splice_entire_forward_list)
{
...
TEST(boost_wobservable_forward_list_test_suite, test_splice_single_element)
{
...
TEST(boost_wobservable_forward_list_test_suite, test_splice_element_range)
{
