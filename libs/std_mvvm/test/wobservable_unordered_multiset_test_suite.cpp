...
TEST(std_wobservable_unordered_multiset_test_suite, cpp11_not_supported) {}
#else
...
TEST(std_wobservable_unordered_multiset_test_suite, test_erase_range)
{
    ...
    *s = il;
    ...
    const bool moved_backward = mi::try_move_backward<m::wobservable_unordered_multiset<int>::iterator>(s, end);
