//
//  placebo_mutex_observable_object_test_suite.cpp
//
...
TEST(std_observable_object_placebo_mutex_test_suite, cpp11_not_supported) {}
#else
...
TEST(std_observable_object_placebo_mutex_test_suite, test_observable_object)
{
