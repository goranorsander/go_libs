...
class test_command
    : public m::command_interface
{
public:
    virtual ~test_command() GO_BOOST_DEFAULT_DESTRUCTOR

    test_command()
        : m::command_interface(TEST_COMMAND_NAME, m::command_interface::command_parameters_type())
    ...
    {
        const bool can_execute_ = can_execute(m::command_interface::command_parameters_type());
        _allow_execute = v;
        if(can_execute_ != can_execute(m::command_interface::command_parameters_type()))
        {
            can_execute_changed(this->shared_from_this());
        }
    }
...
class test_command_execution_observer
    : public m::command_execution_observer_interface
{
public:
    ...
    virtual void on_command_executed(const boost::shared_ptr<m::command_interface>& /*c*/) GO_BOOST_OVERRIDE
    {
        ++_number_of_executed_commands;
    }

    virtual void on_command_not_executed(const boost::shared_ptr<m::command_interface>& /*c*/) GO_BOOST_OVERRIDE
    {
...
public:
    ...
    void on_can_execute_changed(const boost::shared_ptr<m::command_interface>& /*c*/)
    {
