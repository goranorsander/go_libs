...
TEST(std_observable_unordered_map_placebo_lockable_test_suite, required_cpp11_feature_not_supported) {}
#else

using container_type = m::observable_unordered_map<int, int, a::placebo_lockable>;
