...
TEST(std_u16property_test_suite, required_cpp11_feature_not_supported) {}
#else
...
public:
    ...
    p::value_u16property<std::string> name;
     ...
     spaceship()
        : crew_complement(std::u16string(u"crew_complement"), 1012)
        , max_speed(std::u16string(u"max_speed"), 9.8)
        , name(std::u16string(u"name"), std::string("USS Enterprise (NCC-1701-D)"))
    {
    }
...
public:
    ...
    reference_spaceship()
        : crew_complement(std::u16string(u"crew_complement"))
        , max_speed(std::u16string(u"max_speed"))
        , name(std::u16string(u"name"))
    {
    }
};
...
public:
    ...
    read_only_reference_spaceship(const int& _crew_complement, const double& _max_speed, const std::string& _name)
        : crew_complement(std::u16string(u"crew_complement"), _crew_complement)
        , max_speed(std::u16string(u"max_speed"), _max_speed)
        , name(std::u16string(u"name"), _name)
    {
    }
};
...
public:
    ...
    armed_spaceship()
        : spaceship()
        , phaser_arrays(std::u16string(u"phaser_arrays"))
        , _armament()
    {
        update_bindings();
    }
