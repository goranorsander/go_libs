...
TEST(std_observable_unordered_multiset_placebo_lockable_test_suite, cpp11_not_supported) {}
#else
...
TEST(std_observable_unordered_multiset_placebo_lockable_test_suite, test_erase_range)
{
    ...
    *s = il;
    ...
    const bool moved_backward = i::try_move_backward<m::observable_unordered_multiset<int, u::placebo_lockable>::iterator>(s, end);
