...
* Manjaro Linux 18.0.4 Illyria, Xfce, 64 bits
  ...
  * Visual Studio Code 1.19.2 - with extensions:
    * C/C++ 0.23.1 _(C/C++ IntelliSense, debugging, and code browsing)_
    * CMake 0.0.17 _(CMake language support)_
    * CMake Tools 1.1.3 _(Extended CMake support)_
    * Git Lens 9.8.2 _(Supercharge Visual Studio Code's Git capabilities)_
    * Markdown All in One 2.3.1 _(All you need to write Markdown)_
* Windows 10 Professional, 64 bit
  ...
  * Visual Studio Code 1.35.1 - with same extensions as in Linux environment
