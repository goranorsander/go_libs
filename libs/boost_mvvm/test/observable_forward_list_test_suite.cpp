...
typedef m::observable_forward_list<int> container_type;
typedef m::observable_forward_list<double> double_container_type;
...
TEST(boost_observable_forward_list_test_suite, test_erase_after_position)
{
...
TEST(boost_observable_forward_list_test_suite, test_splice_after_entire_container)
{
    go_boost_test::sequence::test_splice_after_entire_container<container_type>();
}

TEST(boost_observable_forward_list_test_suite, test_splice_after_single_element)
{
    go_boost_test::sequence::test_splice_after_single_element<container_type>();
}

TEST(boost_observable_forward_list_test_suite, test_splice_after_element_range)
{
