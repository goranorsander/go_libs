...
TEST(boost_boost_wproperty_test_suite, value_scalar_properties)
{
    spaceship s;
...
TEST(boost_boost_wproperty_test_suite, ref_scalar_properties)
{
    ref_spaceship s;
...
TEST(boost_boost_wproperty_test_suite, read_only_ref_scalar_properties)
{
...
TEST(boost_boost_wproperty_test_suite, write_only_ref_scalar_properties)
{
