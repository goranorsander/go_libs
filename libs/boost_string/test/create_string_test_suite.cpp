...
TEST(boost_create_string_test_suite, required_cpp11_feature_not_supported) {}
#else
...
const char* iso_8859_1_printable_characters =
    ...
    "\x60\x61\x62\x63\x64\x65\x66\x67\x68\x69\x6A\x6B\x6C\x6D\x6E\x6F" \
    "\x70\x71\x72\x73\x74\x75\x76\x77\x78\x79\x7A\x7B\x7C\x7D\x7E";
const std::size_t iso_8859_1_printable_characters_count = 95;
...
const char8_t* iso_8859_1_printable_characters = reinterpret_cast<const char8_t*>(
    ...
    "\x70\x71\x72\x73\x74\x75\x76\x77\x78\x79\x7A\x7B\x7C\x7D\x7E");
const std::size_t iso_8859_1_printable_characters_count = 95;
const std::size_t iso_8859_1_printable_characters_size = 95;
...
TEST(boost_create_string_test_suite, test_create_string_from_char)
{
    ...
    const std::string created_string = s::create<std::string>(from_characters);
...
TEST(boost_create_string_test_suite, test_create_string_from_wchar_t)
{
    const char* expected_result = multibyte::iso_8859_1_printable_characters;
...
TEST(boost_create_string_test_suite, test_create_string_from_char2_t)
{
    const char* expected_result = multibyte::iso_8859_1_printable_characters;
    const s::char2_t* from_characters = ucs_2::iso_8859_1_printable_characters;
    const std::string created_string = s::create<std::string>(from_characters);
    const std::size_t string_memory_usage = sizeof(std::string::value_type)*multibyte::iso_8859_1_printable_characters_count;
    EXPECT_EQ(0, std::memcmp(expected_result, created_string.c_str(), string_memory_usage));
}
...
TEST(boost_create_string_test_suite, test_create_string_from_char16_t)
{
    const char* expected_result = multibyte::iso_8859_1_printable_characters;
...
TEST(boost_create_string_test_suite, test_create_string_from_char32_t)
{
    const char* expected_result = multibyte::iso_8859_1_printable_characters;
...
TEST(boost_create_string_test_suite, test_create_wstring_from_char)
{
    const wchar_t* expected_result = system_wide::iso_8859_1_printable_characters;
    const char* from_characters = multibyte::iso_8859_1_printable_characters;
    const std::wstring created_string = s::create<std::wstring>(from_characters);
    const std::size_t string_memory_usage = sizeof(std::wstring::value_type)*system_wide::iso_8859_1_printable_characters_count;
    EXPECT_EQ(0, std::memcmp(expected_result, created_string.c_str(), string_memory_usage));
}

TEST(boost_create_string_test_suite, test_create_wstring_from_wchar_t)
{
    const wchar_t* expected_result = system_wide::iso_8859_1_printable_characters;
    const wchar_t* from_characters = system_wide::iso_8859_1_printable_characters;
    const std::wstring created_string = s::create<std::wstring>(from_characters);
...
TEST(boost_create_string_test_suite, test_create_wstring_from_char2_t)
{
    const wchar_t* expected_result = system_wide::iso_8859_1_printable_characters;
    const s::char2_t* from_characters = ucs_2::iso_8859_1_printable_characters;
    const std::wstring created_string = s::create<std::wstring>(from_characters);
...
TEST(boost_create_string_test_suite, test_create_wstring_from_char16_t)
{
    const wchar_t* expected_result = system_wide::iso_8859_1_printable_characters;
    const char16_t* from_characters = utf_16::iso_8859_1_printable_characters;
    const std::wstring created_string = s::create<std::wstring>(from_characters);
...
TEST(boost_create_string_test_suite, test_create_wstring_from_char32_t)
{
    const wchar_t* expected_result = system_wide::iso_8859_1_printable_characters;
    const char32_t* from_characters = utf_32::iso_8859_1_printable_characters;
    const std::wstring created_string = s::create<std::wstring>(from_characters);
...
GO_BOOST_MESSAGE("This compiler have an issue creating u2string")
TEST(boost_create_string_test_suite, cannot_create_u2string_issue) {}
#else

TEST(boost_create_string_test_suite, test_create_u2string_from_char)
{
    const s::char2_t* expected_result = ucs_2::iso_8859_1_printable_characters;
    const char* from_characters = multibyte::iso_8859_1_printable_characters;
    const s::u2string created_string = s::create<s::u2string>(from_characters);
    const std::size_t string_memory_usage = sizeof(s::u2string::value_type)*ucs_2::iso_8859_1_printable_characters_count;
    EXPECT_EQ(0, std::memcmp(expected_result, created_string.c_str(), string_memory_usage));
}

TEST(boost_create_string_test_suite, test_create_u2string_from_wchar_t)
{
    const s::char2_t* expected_result = ucs_2::iso_8859_1_printable_characters;
    const wchar_t* from_characters = system_wide::iso_8859_1_printable_characters;
    const s::u2string created_string = s::create<s::u2string>(from_characters);
...
TEST(boost_create_string_test_suite, test_create_u2string_from_char2_t)
{
    const s::char2_t* expected_result = ucs_2::iso_8859_1_printable_characters;
    const s::char2_t* from_characters = ucs_2::iso_8859_1_printable_characters;
    const s::u2string created_string = s::create<s::u2string>(from_characters);
...
TEST(boost_create_string_test_suite, test_create_u2string_from_char16_t)
{
    const s::char2_t* expected_result = ucs_2::iso_8859_1_printable_characters;
    const char16_t* from_characters = utf_16::iso_8859_1_printable_characters;
    const s::u2string created_string = s::create<s::u2string>(from_characters);
...
TEST(boost_create_string_test_suite, test_create_u2string_from_char32_t)
{
    const s::char2_t* expected_result = ucs_2::iso_8859_1_printable_characters;
    const char32_t* from_characters = utf_32::iso_8859_1_printable_characters;
    const s::u2string created_string = s::create<s::u2string>(from_characters);
...
TEST(boost_create_string_test_suite, test_create_u8string_from_char)
{
    ...
    const char* from_characters = multibyte::iso_8859_1_printable_characters;
    const s::u8string created_string = s::create<s::u8string>(from_characters);
    const std::size_t string_memory_usage = sizeof(s::u8string::value_type)*utf_8::iso_8859_1_printable_characters_size;
    EXPECT_EQ(0, std::memcmp(expected_result, created_string.c_str(), string_memory_usage));
}
...
TEST(boost_create_string_test_suite, test_create_u16string_from_char)
{
    const char16_t* expected_result = utf_16::iso_8859_1_printable_characters;
    const char* from_characters = multibyte::iso_8859_1_printable_characters;
    const s::u16string created_string = s::create<s::u16string>(from_characters);
    const std::size_t string_memory_usage = sizeof(s::u16string::value_type)*utf_16::iso_8859_1_printable_characters_count;
    EXPECT_EQ(0, std::memcmp(expected_result, created_string.c_str(), string_memory_usage));
}

TEST(boost_create_string_test_suite, test_create_u16string_from_wchar_t)
{
    const char16_t* expected_result = utf_16::iso_8859_1_printable_characters;
    const wchar_t* from_characters = system_wide::iso_8859_1_printable_characters;
    const s::u16string created_string = s::create<s::u16string>(from_characters);
...
TEST(boost_create_string_test_suite, test_create_u16string_from_char2_t)
{
    const char16_t* expected_result = utf_16::iso_8859_1_printable_characters;
    const s::char2_t* from_characters = ucs_2::iso_8859_1_printable_characters;
    const s::u16string created_string = s::create<s::u16string>(from_characters);
...
TEST(boost_create_string_test_suite, test_create_u16string_from_char16_t)
{
    const char16_t* expected_result = utf_16::iso_8859_1_printable_characters;
    const char16_t* from_characters = utf_16::iso_8859_1_printable_characters;
    const s::u16string created_string = s::create<s::u16string>(from_characters);
...
TEST(boost_create_string_test_suite, test_create_u16string_from_char32_t)
{
    const char16_t* expected_result = utf_16::iso_8859_1_printable_characters;
    const char32_t* from_characters = utf_32::iso_8859_1_printable_characters;
    const s::u16string created_string = s::create<s::u16string>(from_characters);
...
TEST(boost_create_string_test_suite, test_create_u32string_from_char)
{
    const char32_t* expected_result = utf_32::iso_8859_1_printable_characters;
    const char* from_characters = multibyte::iso_8859_1_printable_characters;
    const s::u32string created_string = s::create<s::u32string>(from_characters);
    const std::size_t string_memory_usage = sizeof(s::u32string::value_type)*utf_32::iso_8859_1_printable_characters_count;
    EXPECT_EQ(0, std::memcmp(expected_result, created_string.c_str(), string_memory_usage));
}

TEST(boost_create_string_test_suite, test_create_u32string_from_wchar_t)
{
    const char32_t* expected_result = utf_32::iso_8859_1_printable_characters;
    const wchar_t* from_characters = system_wide::iso_8859_1_printable_characters;
    const s::u32string created_string = s::create<s::u32string>(from_characters);
...
TEST(boost_create_string_test_suite, test_create_u32string_from_char2_t)
{
    const char32_t* expected_result = utf_32::iso_8859_1_printable_characters;
    const s::char2_t* from_characters = ucs_2::iso_8859_1_printable_characters;
    const s::u32string created_string = s::create<s::u32string>(from_characters);
...
TEST(boost_create_string_test_suite, test_create_u32string_from_char16_t)
{
    const char32_t* expected_result = utf_32::iso_8859_1_printable_characters;
    const char16_t* from_characters = utf_16::iso_8859_1_printable_characters;
    const s::u32string created_string = s::create<s::u32string>(from_characters);
...
TEST(boost_create_string_test_suite, test_create_u32string_from_char32_t)
{
    const char32_t* expected_result = utf_32::iso_8859_1_printable_characters;
    const char32_t* from_characters = utf_32::iso_8859_1_printable_characters;
    const s::u32string created_string = s::create<s::u32string>(from_characters);
