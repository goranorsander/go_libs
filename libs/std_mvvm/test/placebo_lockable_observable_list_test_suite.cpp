...
TEST(std_observable_list_placebo_lockable_test_suite, required_cpp11_feature_not_supported) {}
#else

using container_type = m::observable_list<int, a::placebo_lockable>;
using double_container_type = m::observable_list<double, a::placebo_lockable>;
...
TEST(std_observable_list_placebo_lockable_test_suite, test_splice_entire_container)
{
