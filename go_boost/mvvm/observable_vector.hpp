...
class basic_observable_vector
    : public basic_observable_sequence_container<S, boost::container::stable_vector<T>, L>
{
public:
...
public:
    virtual ~basic_observable_vector() GO_BOOST_DEFAULT_DESTRUCTOR
...
public:
    ...
    void swap(basic_observable_vector<t, s, m>& x)
    {
...
inline GO_BOOST_CONSTEXPR typename basic_observable_vector<T, S, L>::size_type basic_observable_vector<T, S, L>::size() const BOOST_NOEXCEPT_OR_NOTHROW
{
...
public:
    virtual ~observable_vector() GO_BOOST_DEFAULT_DESTRUCTOR
...
public:
    ...
    void swap(observable_vector<t, m>& x)
    {
        basic_observable_vector<t, string_type, m>::swap(dynamic_cast<basic_observable_vector<t, string_type, m>&>(x));
    }
};
...
public:
    virtual ~wobservable_vector() GO_BOOST_DEFAULT_DESTRUCTOR
...
public:
    template<class t, typename m>
    void swap(wobservable_vector<t, m>& x)
    {
        basic_observable_vector<t, string_type, m>::swap(dynamic_cast<basic_observable_vector<t, string_type, m>&>(x));
    }
};
