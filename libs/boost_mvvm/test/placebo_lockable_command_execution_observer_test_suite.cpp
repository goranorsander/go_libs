...
public:
    ...
    virtual void on_command_executed(const boost::shared_ptr<mst::command_interface>& /*c*/) GO_BOOST_OVERRIDE
    {
        ++_number_of_executed_commands;
    }

    virtual void on_command_not_executed(const boost::shared_ptr<mst::command_interface>& /*c*/) GO_BOOST_OVERRIDE
    {
...
TEST(boost_command_execution_observer_placebo_lockable_test_suite, test_execute_command)
{
...
TEST(boost_command_execution_observer_placebo_lockable_test_suite, test_post_command)
{
    mst::command_manager::ptr command_mgr = mst::command_manager::create();
