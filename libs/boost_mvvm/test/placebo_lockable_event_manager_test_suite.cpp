...
typedef go_boost_test::fleet_commander<m::basic_event_manager<string_type, lockable_type>, p::property<string_type, lockable_type>, p::value_property<string_type, lockable_type>, pro::value_property<string_type, lockable_type>> fleet_commander_type;
