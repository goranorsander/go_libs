...
protected:
    ...
    basic_observable_unordered_multiset(const this_type& x)
        : basic_observable_unordered_associative_container<string_type, container_type>()
    ...
    basic_observable_unordered_multiset(this_type&& x)
        : basic_observable_unordered_associative_container<string_type, container_type>()
        , _container(x._container)
    {
    }
    ...
    basic_observable_unordered_multiset(std::initializer_list<value_type> il)
        : basic_observable_unordered_associative_container<string_type, container_type>()
        , _container(il)
    {
    }
...
public:
    virtual ~observable_unordered_multiset()
    {
    }
...
protected:
    ...
    observable_unordered_multiset(const this_type& x)
    ...
    observable_unordered_multiset(this_type&& x)
        : basic_observable_unordered_multiset<value_type, string_type>(x)
    {
    }
    ...
    observable_unordered_multiset(std::initializer_list<value_type> il)
...
public:
    virtual ~wobservable_unordered_multiset()
    {
    }
...
protected:
    ...
    wobservable_unordered_multiset(const this_type& x)
        : basic_observable_unordered_multiset<value_type, string_type>(x)
    {
    }
    ...
    wobservable_unordered_multiset(this_type&& x)
        : basic_observable_unordered_multiset<value_type, string_type>(x)
    {
    }
    ...
    wobservable_unordered_multiset(std::initializer_list<value_type> il)
        : basic_observable_unordered_multiset<value_type, string_type>(il)
    {
    }
