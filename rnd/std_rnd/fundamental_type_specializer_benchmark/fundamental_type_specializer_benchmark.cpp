...
#include <iostream>
#include <go/diagnostics/benchmark/stopwatch.hpp>
#include <go/type_traits/fundamental_type_specializer.hpp>
#include <go/namespace_alias.hpp>

GO_IMPLEMENT_FUNDAMENTAL_TYPE_SPECIALIZER(UnsignedLongLong, unsigned long long)
GO_IMPLEMENT_FUNDAMENTAL_TYPE_SPECIALIZER(Double, double)
...
#if !defined(GO_NO_CXX14_GENERIC_POLYMORPHIC_LAMBDA_EXPRESSIONS)
...
#endif  // #if !defined(GO_NO_CXX14_GENERIC_POLYMORPHIC_LAMBDA_EXPRESSIONS)
