...
public:
    ...
    using container_type = typename std::unordered_multiset<K>;
    using this_type = basic_observable_unordered_multiset<K, S, L>;
...
public:
    ...
    using lockable_type = L;
    using container_type = typename std::unordered_multiset<K>;
    using this_type = observable_unordered_multiset<K, L>;
    using ptr = typename std::shared_ptr<this_type>;
    using wptr = typename std::weak_ptr<this_type>;
...
public:
    ...
    using lockable_type = L;
    using container_type = typename std::unordered_multiset<K>;
    using this_type = wobservable_unordered_multiset<K, L>;
    using ptr = typename std::shared_ptr<this_type>;
    using wptr = typename std::weak_ptr<this_type>;
