...
class basic_observable_unordered_multimap
    : public basic_observable_unordered_associative_container<S, boost::unordered_multimap<K, T>, L>
{
public:
    typedef S string_type;
    typedef L lockable_type;
    typedef typename boost::unordered_multimap<K, T> container_type;
    typedef basic_observable_unordered_multimap<K, T, S> this_type;
...
public:
    virtual ~basic_observable_unordered_multimap() GO_BOOST_DEFAULT_DESTRUCTOR
...
public:
    virtual ~observable_unordered_multimap() GO_BOOST_DEFAULT_DESTRUCTOR
...
public:
    ...
    void swap(observable_unordered_multimap<k, t, m>& x)
    {
        basic_observable_unordered_multimap<k, t, string_type, m>::swap(dynamic_cast<basic_observable_unordered_multimap<k, t, string_type, m>&>(x));
    }
};
...
public:
    virtual ~wobservable_unordered_multimap() GO_BOOST_DEFAULT_DESTRUCTOR
...
public:
    template<class k, class t, typename m>
    void swap(wobservable_unordered_multimap<k, t, m>& x)
    {
        basic_observable_unordered_multimap<k, t, string_type, m>::swap(dynamic_cast<basic_observable_unordered_multimap<k, t, string_type, m>&>(x));
    }
};
