...
TEST(std_command_execution_observer_placebo_mutex_test_suite, cpp11_not_supported) {}
#else
...
public:
    ...
    virtual void on_command_executed(const std::shared_ptr<mst::command_interface>& /*c*/)
    {
        ++_number_of_executed_commands;
    }

    virtual void on_command_not_executed(const std::shared_ptr<mst::command_interface>& /*c*/)
    {
...
TEST(std_command_execution_observer_placebo_mutex_test_suite, test_execute_command)
{
...
TEST(std_command_execution_observer_placebo_mutex_test_suite, test_post_command)
{
    mst::command_manager::ptr command_mgr = mst::command_manager::create();
