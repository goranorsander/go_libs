...
#if defined(GO_GTEST_FOR_CPP03) && !(defined(GO_NO_CXX20_CHAR8_T) || defined(GO_BOOST_NO_CXX20_CHAR8_T))
...
#endif  // #if defined(GO_GTEST_FOR_CPP03) && !(defined(GO_NO_CXX20_CHAR8_T) || defined(GO_BOOST_NO_CXX20_CHAR8_T))
