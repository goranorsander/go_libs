//
//  placebo_mutex_observable_list_test_suite.cpp
//
...
TEST(std_observable_list_placebo_mutex_test_suite, cpp11_not_supported) {}
#else
...
public:
    ...
    typedef typename m::observable_list<T, u::placebo_mutex>::ptr observable_list_ptr_type;
...
TEST(std_observable_list_placebo_mutex_test_suite, test_assign_range)
{
    // Test assign range
    m::observable_list<int, u::placebo_mutex>::ptr l = m::observable_list<int, u::placebo_mutex>::create();
    list_observer<int> o;
...
TEST(std_observable_list_placebo_mutex_test_suite, test_assign_initializer_list)
{
...
TEST(std_observable_list_placebo_mutex_test_suite, test_assign_fill)
{
    // Test assign fill
    m::observable_list<int, u::placebo_mutex>::ptr l1 = m::observable_list<int, u::placebo_mutex>::create();
    m::observable_list<int, u::placebo_mutex>::ptr l2 = m::observable_list<int, u::placebo_mutex>::create();
    list_observer<int> o;
    ...
    m::observable_list<int, u::placebo_mutex>::iterator begin = l1->begin();
    ++begin;
    m::observable_list<int, u::placebo_mutex>::iterator end = l1->end();
    --end;
...
TEST(std_observable_list_placebo_mutex_test_suite, test_push_back)
{
    // Test push back
    m::observable_list<int, u::placebo_mutex>::ptr l = m::observable_list<int, u::placebo_mutex>::create();
    list_observer<int> o;
...
TEST(std_observable_list_placebo_mutex_test_suite, test_push_front)
{
    // Test push front
    m::observable_list<int, u::placebo_mutex>::ptr l = m::observable_list<int, u::placebo_mutex>::create();
    list_observer<int> o;
...
TEST(std_observable_list_placebo_mutex_test_suite, test_pop_back)
{
    // Test pop back
    m::observable_list<int, u::placebo_mutex>::ptr l = m::observable_list<int, u::placebo_mutex>::create();
    list_observer<int> o;
...
TEST(std_observable_list_placebo_mutex_test_suite, test_pop_front)
{
    // Test pop front
    m::observable_list<int, u::placebo_mutex>::ptr l = m::observable_list<int, u::placebo_mutex>::create();
    list_observer<int> o;
...
TEST(std_observable_list_placebo_mutex_test_suite, test_insert_single_element)
{
    ...
    m::observable_list<int, u::placebo_mutex>::iterator it = l->begin();
    std::advance(it, 2);
    l->insert(it, 3);
    EXPECT_EQ(7, l->size());
...
TEST(std_observable_list_placebo_mutex_test_suite, test_insert_fill)
{
    // Test insert fill
    m::observable_list<int, u::placebo_mutex>::ptr l = m::observable_list<int, u::placebo_mutex>::create();
    list_observer<int> o;
...
TEST(std_observable_list_placebo_mutex_test_suite, test_insert_range)
{
    // Test insert range
    m::observable_list<int, u::placebo_mutex>::ptr l1 = m::observable_list<int, u::placebo_mutex>::create();
    m::observable_list<int, u::placebo_mutex>::ptr l2 = m::observable_list<int, u::placebo_mutex>::create();
    ...
    m::observable_list<int, u::placebo_mutex>::iterator it = l2->begin();
    std::advance(it, 3);
...
TEST(std_observable_list_placebo_mutex_test_suite, test_erase_position)
{
    // Test erase position
    m::observable_list<int, u::placebo_mutex>::ptr l = m::observable_list<int, u::placebo_mutex>::create();
    list_observer<int> o;
    ...
    m::observable_list<int, u::placebo_mutex>::iterator it1 = l->begin();
    std::advance(it1, 3);
    m::observable_list<int, u::placebo_mutex>::iterator it2 = l->erase(it1);
    EXPECT_EQ(6, l->size());
...
TEST(std_observable_list_placebo_mutex_test_suite, test_erase_range)
{
    // Test erase range
    m::observable_list<int, u::placebo_mutex>::ptr l = m::observable_list<int, u::placebo_mutex>::create();
    list_observer<int> o;
    ...
    m::observable_list<int, u::placebo_mutex>::iterator begin = l->begin();
    ++begin;
    m::observable_list<int, u::placebo_mutex>::iterator end = l->end();
    --end;
...
TEST(std_observable_list_placebo_mutex_test_suite, test_swap)
{
    // Test swap
    m::observable_list<int, u::placebo_mutex>::ptr l1 = m::observable_list<int, u::placebo_mutex>::create();
    m::observable_list<int, u::placebo_mutex>::ptr l2 = m::observable_list<int, u::placebo_mutex>::create();
...
TEST(std_observable_list_placebo_mutex_test_suite, test_clear)
{
    // Test clear
    m::observable_list<int, u::placebo_mutex>::ptr l = m::observable_list<int, u::placebo_mutex>::create();
    list_observer<int> o;
...
TEST(std_observable_list_placebo_mutex_test_suite, test_emplace)
{
    // Test emplace
    m::observable_list<int, u::placebo_mutex>::ptr l = m::observable_list<int, u::placebo_mutex>::create();
    list_observer<int> o;
    ...
    m::observable_list<int, u::placebo_mutex>::iterator begin = l->begin();
    ++begin;
    m::observable_list<int, u::placebo_mutex>::iterator it = l->emplace(begin, 4);
    EXPECT_EQ(4, *it);
...
TEST(std_observable_list_placebo_mutex_test_suite, test_emplace_back)
{
    // Test emplace back
    m::observable_list<int, u::placebo_mutex>::ptr l = m::observable_list<int, u::placebo_mutex>::create();
    list_observer<int> o;
...
TEST(std_observable_list_placebo_mutex_test_suite, test_emplace_front)
{
    // Test emplace front
    m::observable_list<int, u::placebo_mutex>::ptr l = m::observable_list<int, u::placebo_mutex>::create();
    list_observer<int> o;
...
TEST(std_observable_list_placebo_mutex_test_suite, test_splice_entire_list)
{
    ...
    m::observable_list<int, u::placebo_mutex>::iterator it1 = l1->begin();
    ++it1;
    EXPECT_EQ(2, *it1);
    ...
    m::observable_list<int, u::placebo_mutex>::iterator it = l1->begin();
    EXPECT_EQ(1, *it);
    ++it;
    EXPECT_EQ(10, *it);
    ++it;
...
TEST(std_observable_list_placebo_mutex_test_suite, test_splice_single_element)
{
    ...
    m::observable_list<int, u::placebo_mutex>::iterator it2 = l2->begin();
    std::advance(it2, 4);
    EXPECT_EQ(2, *it2);
...
TEST(std_observable_list_placebo_mutex_test_suite, test_splice_element_range)
{
    ...
    m::observable_list<int, u::placebo_mutex>::iterator it2first = l2->begin();
    ++it2first;
    EXPECT_EQ(20, *it2first);

    m::observable_list<int, u::placebo_mutex>::iterator it2last = l2->begin();
...
TEST(std_observable_list_placebo_mutex_test_suite, test_remove)
{
    // Test remove
    m::observable_list<int, u::placebo_mutex>::ptr l = m::observable_list<int, u::placebo_mutex>::create();
    list_observer<int> o;
...
TEST(std_observable_list_placebo_mutex_test_suite, test_remove_if)
{
    // Test remove if
    m::observable_list<int, u::placebo_mutex>::ptr l = m::observable_list<int, u::placebo_mutex>::create();
    list_observer<int> o;
...
TEST(std_observable_list_placebo_mutex_test_suite, test_unique)
{
    // Test unique
    m::observable_list<int, u::placebo_mutex>::ptr l = m::observable_list<int, u::placebo_mutex>::create();
    list_observer<int> o;
...
TEST(std_observable_list_placebo_mutex_test_suite, test_unique_binary_predicate)
{
    // Test unique binary predicate
    m::observable_list<double, u::placebo_mutex>::ptr l = m::observable_list<double, u::placebo_mutex>::create();
...
TEST(std_observable_list_placebo_mutex_test_suite, test_merge)
{
    // Test merge
    m::observable_list<double, u::placebo_mutex>::ptr l1 = m::observable_list<double, u::placebo_mutex>::create();
    m::observable_list<double, u::placebo_mutex>::ptr l2 = m::observable_list<double, u::placebo_mutex>::create();
...
TEST(std_observable_list_placebo_mutex_test_suite, test_merge_compare_predicate)
{
