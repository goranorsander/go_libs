...
TEST(std_observable_list_test_suite, cpp11_not_supported) {}
#else
...
TEST(std_observable_list_test_suite, test_emplace)
{
    ...
    m::observable_list<int>::iterator begin = l->begin();
    ++begin;
    m::observable_list<int>::iterator it = l->emplace(begin, 4);
    EXPECT_EQ(4, *it);
...
TEST(std_observable_list_test_suite, test_splice_entire_list)
{
