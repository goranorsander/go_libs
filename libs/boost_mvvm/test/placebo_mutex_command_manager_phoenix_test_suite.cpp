//
//  placebo_mutex_command_manager_phoenix_test_suite.cpp
//
...
TEST(boost_command_manager_phoenix_placebo_mutex_test_suite, boost_phoenix_not_supported) {}
#else
...
TEST(boost_command_manager_phoenix_placebo_mutex_test_suite, test_command_manager)
{
    TEST_CASE_SHIPYARD
...
TEST(boost_command_manager_phoenix_placebo_mutex_test_suite, test_spaceship_observer)
{
    TEST_CASE_SHIPYARD
