...
public:
    ...
    typedef basic_observable_ordered_associative_container<S, C, M> this_type;
...
inline basic_observable_ordered_associative_container<S, C, M>::~basic_observable_ordered_associative_container()
{
}
