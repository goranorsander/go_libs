#ifndef GO_TYPE_TRAITS_PRIMITIVE_TYPE_SPECIALIZER_HPP_INCLUDED
#define GO_TYPE_TRAITS_PRIMITIVE_TYPE_SPECIALIZER_HPP_INCLUDED
...
#include <go/type_traits/detail/primitive_type_specializer_base.hpp>

#define GO_IMPLEMENT_PRIMITIVE_TYPE_SPECIALIZER( _class_name_, _primitive_type_ ) \
struct _class_name_##_tag {}; \
using _class_name_ = go::type_traits::primitive_type_specializer<_primitive_type_, _class_name_##_tag>;
...
#define GO_IMPLEMENT_PRIMITIVE_TYPE_SPECIALIZER_CONSTRUCTORS( _class_name_, _primitive_type_ ) \
    _class_name_() GO_NOEXCEPT_OR_NOTHROW : go::type_traits::primitive_type_specializer<_primitive_type_>(static_cast<_primitive_type_>(0)) {} \
    _class_name_(const _class_name_& t) GO_NOEXCEPT_OR_NOTHROW : go::type_traits::primitive_type_specializer<_primitive_type_>(t) {} \
    _class_name_(_class_name_&& t) GO_NOEXCEPT_OR_NOTHROW : go::type_traits::primitive_type_specializer<_primitive_type_>(std::move(t)) {} \
    explicit _class_name_(const value_type& t) GO_NOEXCEPT_OR_NOTHROW : go::type_traits::primitive_type_specializer<_primitive_type_>(t) {} \
    explicit _class_name_(value_type&& t) GO_NOEXCEPT_OR_NOTHROW : go::type_traits::primitive_type_specializer<_primitive_type_>(std::move(t)) {}
...
#define GO_IMPLEMENT_PRIMITIVE_TYPE_SPECIALIZER_ASSIGNMENT_OPERATORS( _class_name_, _primitive_type_ ) \
    _class_name_& operator=(const _class_name_& t) GO_NOEXCEPT_OR_NOTHROW { if(&t != this) { go::type_traits::primitive_type_specializer<_primitive_type_>::operator=(t); } return *this; } \
...
class _class_name_ \
    : public go::type_traits::primitive_type_specializer<_primitive_type_> \
{ \
public: \
...
#endif  // #ifndef GO_TYPE_TRAITS_PRIMITIVE_TYPE_SPECIALIZER_HPP_INCLUDED
