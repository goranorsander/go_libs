//
//  placebo_mutex_event_manager_test_suite.cpp
//
...
TEST(std_event_manager_placebo_mutex_test_suite, cpp11_not_supported) {}
#else
...
TEST(std_event_manager_placebo_mutex_test_suite, test_command_manager)
{
    TEST_CASE_SHIPYARD
