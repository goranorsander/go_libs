...
```c++
<go_boost/property/write_only_value_property.hpp>
```
...
*assign name, bind getter and setter (2)* | public | **basic_value_property**(const **string_type**& property_name, const **value_type**& other)
