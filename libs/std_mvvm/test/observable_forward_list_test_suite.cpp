...
TEST(std_observable_forward_list_test_suite, required_cpp11_feature_not_supported) {}
#else

using container_type = m::observable_forward_list<int>;
using double_container_type = m::observable_forward_list<double>;
...
TEST(std_observable_forward_list_test_suite, test_erase_after_position)
{
...
TEST(std_observable_forward_list_test_suite, test_splice_after_entire_container)
{
