...
TEST(std_observable_unordered_set_test_suite, cpp11_not_supported) {}
#else
...
TEST(std_observable_unordered_set_test_suite, test_erase_range)
{
    ...
    *s = il;
    ...
    const bool moved_backward = mi::try_move_backward<m::observable_unordered_set<int>::iterator>(s, end);
