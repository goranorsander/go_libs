...
TEST(std_observable_unordered_map_test_suite, cpp11_not_supported) {}
#else
...
TEST(std_observable_unordered_map_test_suite, test_erase_range)
{
    ...
    *m = il;
    ...
    const bool moved_backward = i::try_move_iterator_backward<m::observable_unordered_map<int, int>::iterator>(m, end);
...
TEST(std_observable_unordered_map_test_suite, test_swap)
{
    ...
    const std::initializer_list<m::observable_unordered_map<int, int>::value_type> il2 =
    {
        m::observable_unordered_map<int, int>::value_type(10, 100),
        m::observable_unordered_map<int, int>::value_type(20, 200),
        m::observable_unordered_map<int, int>::value_type(30, 300),
        m::observable_unordered_map<int, int>::value_type(40, 400),
        m::observable_unordered_map<int, int>::value_type(50, 500),
        m::observable_unordered_map<int, int>::value_type(60, 600),
        m::observable_unordered_map<int, int>::value_type(70, 700)
    };
    *m1 = il1;
    *m2 = il2;
    EXPECT_EQ(5, m1->size());
