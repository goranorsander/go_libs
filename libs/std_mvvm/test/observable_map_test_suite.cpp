...
TEST(std_observable_map_test_suite, cpp11_not_supported) {}
#else
...
TEST(std_observable_map_test_suite, test_insert_single_element)
{
    ...
    *m = il;
    ...
    for(const m::observable_map<int, int>::value_type& i : *m)
    {
        ++count;
...
TEST(std_observable_map_test_suite, test_swap)
{
    ...
    const std::initializer_list<m::observable_map<int, int>::value_type> il2 =
    {
        m::observable_map<int, int>::value_type(10, 100),
        m::observable_map<int, int>::value_type(20, 200),
        m::observable_map<int, int>::value_type(30, 300),
        m::observable_map<int, int>::value_type(40, 400),
        m::observable_map<int, int>::value_type(50, 500),
        m::observable_map<int, int>::value_type(60, 600),
        m::observable_map<int, int>::value_type(70, 700)
    };
    *m1 = il1;
    *m2 = il2;
    ...
    unsigned int count = 0u;
    for(const m::observable_map<int, int>::value_type& i : *m1)
    {
        ++count;
    ...
    count = 0;
    for(const m::observable_map<int, int>::value_type& i : *m2)
    {
        ++count;
        EXPECT_EQ(static_cast<int>(count), i.first);
        EXPECT_EQ(static_cast<int>(count)*10, i.second);
