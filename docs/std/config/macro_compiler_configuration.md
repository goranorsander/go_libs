...
GO_NO_CXX11_TEMPLATE_ALIASES | Template aliases | [N2258](https://wg21.link/N2258)
...
GO_NO_CXX17_PACK_EXPANSIONS_IN_USING_DECLARATIONS | Pack expansions in using-declarations | [P0195R2](https://wg21.link/P0195R2)
...
GO_NO_CXX17_STD_SHARED_PTR_AND_STD_WEAK_PTR_WITH_ARRAY_SUPPORT | std::shared_ptr and std::weak_ptr with array support | [P0414R2](https://wg21.link/P0414R2)
...
Macro | Description
-|-
GO_NO_CXX2A | The compiler does not support C++2a

### Compiler C++2a language support

Macro | Unsupported language feature | Paper(s)
-|-
GO_NO_CXX2A___VA_OPT__ | \_\_VA\_OPT\_\_ | [P0306R4](https://wg21.link/P0306R4), [P1042R1](https://wg21.link/P1042R1)
GO_NO_CXX2A_ACCESS_CHECKING_ON_SPECIALIZATIONS | Access checking on specializations | [P0692R1](https://wg21.link/P0692R1)
GO_NO_CXX2A_ADL_AND_FUNCTION_TEMPLATES_THAT_ARE_NOT_VISIBLE | ADL and function templates that are not visible | [P0846R0](https://wg21.link/P0846R0)
GO_NO_CXX2A_ALLOW_LAMBDA_CAPTURE_ASSIGN_THIS | Allow lambda-capture [=, this] | [P0409R2](https://wg21.link/P0409R2)
GO_NO_CXX2A_ATTRIBUTE_NO_UNIQUE_ADDRESS | Attribute [[no_unique_address]] | [P0840R2](https://wg21.link/P0840R2)
GO_NO_CXX2A_ATTRIBUTES_LIKELY_AND_UNLIKELY | Attributes [[likely]] and [[unlikely]] | [P0479R5](https://wg21.link/P0479R5)
GO_NO_CXX2A_CHANGING_THE_ACTIVE_MEMBER_OF_A_UNION_INSIDE_CONSTEXPR | Changing the active member of a union inside constexpr | [P1330R0](https://wg21.link/P1330R0)
GO_NO_CXX2A_CHAR8_T | char8_t | [P0482R6](https://wg21.link/P0482R6)
GO_NO_CXX2A_CLASS_TYPES_IN_NON_TYPE_TEMPLATE_PARAMETERS | Class types in non-type template parameters | [P0732R2](https://wg21.link/P0732R2)
GO_NO_CXX2A_CONCEPTS | Concepts | [P0734R0](https://wg21.link/P0734R0)
GO_NO_CXX2A_CONSISTENCY_IMPROVEMENTS_FOR_COMPARISONS | Consistency improvements for comparisons | [P1120R0](https://wg21.link/P1120R0)
GO_NO_CXX2A_CONST_MISMATCH_WITH_DEFAULTED_COPY_CONSTRUCTOR | const mismatch with defaulted copy constructor | [P0641R2](https://wg21.link/P0641R2)
GO_NO_CXX2A_CONST_REF_QUALIFIED_POINTERS_TO_MEMBERS | const&-qualified pointers to members | [P0704R1](https://wg21.link/P0704R1)
GO_NO_CXX2A_CONSTEXPR_DYNAMIC_CAST_AND_POLYMORPHIC_TYPEID | constexpr dynamic_cast and polymorphic typeid | [P1327R1](https://wg21.link/P1327R1)
GO_NO_CXX2A_CONSTEXPR_TRY_CATCH_BLOCKS | constexpr try-catch blocks | [P1002R1](https://wg21.link/P1002R1)
GO_NO_CXX2A_CONSTEXPR_VIRTUAL_FUNCTION | constexpr virtual function | [P1064R0](https://wg21.link/P1064R0)
GO_NO_CXX2A_CONSTINIT | constinit | [P1143R2](https://wg21.link/P1143R2)
GO_NO_CXX2A_COROUTINES | Coroutines | [P0912R5](https://wg21.link/P0912R5)
GO_NO_CXX2A_DEFAULT_CONSTRUCTIBLE_AND_ASSIGNABLE_STATELESS_LAMBDAS | Default constructible and assignable stateless lambdas | [P0624R2](https://wg21.link/P0624R2)
GO_NO_CXX2A_DEFAULT_MEMBER_INITIALIZERS_FOR_BIT_FIELDS | Default member initializers for bit-fields | [P0683R1](https://wg21.link/P0683R1)
GO_NO_CXX2A_DEPRECATE_COMMA_OPERATOR_IN_SUBSCRIPTS | Deprecate comma operator in subscripts | [P1161R3](https://wg21.link/P1161R3)
GO_NO_CXX2A_DEPRECATE_IMPLICIT_CAPTURE_OF_THIS_VIA_ASSIGN | Deprecate implicit capture of this via [=] | [P0806R2](https://wg21.link/P0806R2)
GO_NO_CXX2A_DEPRECATING_SOME_USES_OF_VOLATILE | Deprecating some uses of volatile | [P1152R4](https://wg21.link/P1152R4)
GO_NO_CXX2A_DESIGNATED_INITIALIZERS | Designated initializers | [P0329R4](https://wg21.link/P0329R4)
GO_NO_CXX2A_DESTROYING_OPERATOR_DELETE | Destroying operator delete | [P0722R3](https://wg21.link/P0722R3)
GO_NO_CXX2A_DR_ALLOW_STRUCTURED_BINDINGS_TO_ACCESSIBLE_MEMBERS | DR: Allow structured bindings to accessible members | [P0969R0](https://wg21.link/P0969R0)
GO_NO_CXX2A_DR_ARRAY_SIZE_DEDUCTION_IN_NEW_EXPRESSIONS | DR: Array size deduction in new-expressions | [P1009R2](https://wg21.link/P1009R2)
GO_NO_CXX2A_DR_EXPLICITLY_DEFAULTED_FUNCTIONS_WITH_DIFFERENT_EXCEPTION_SPECIFICATIONS | DR: Explicitly defaulted functions with different exception specifications | [P1286R2](https://wg21.link/P1286R2)
GO_NO_CXX2A_DR_IMPLICIT_MOVE_FOR_MORE_LOCAL_OBJECTS_AND_RVALUE_REFERENCES | DR: Implicit move for more local objects and rvalue references | [P1825R0](https://wg21.link/P1825R0)
GO_NO_CXX2A_DR_NODISCARD_FOR_CONSTRUCTORS | DR: [[nodiscard]] for constructors | [P1771R1](https://wg21.link/P1771R1)
GO_NO_CXX2A_DR_RELAXING_THE_RANGE_FOR_LOOP_CUSTOMIZATION_POINT_FINDING_RULES | DR: Relaxing the range-for loop customization point finding rules | [P0962R1](https://wg21.link/P0962R1)
GO_NO_CXX2A_DR_RELAXING_THE_STRUCTURED_BINDINGS_CUSTOMIZATION_POINT_FINDING_RULES | DR: Relaxing the structured bindings customization point finding rules | [P0961R1](https://wg21.link/P0961R1)
GO_NO_CXX2A_EXPLICIT_BOOL | explicit(bool) | [P0892R2](https://wg21.link/P0892R2)
GO_NO_CXX2A_IMMEDIATE_FUNCTIONS | Immediate functions | [P1073R3](https://wg21.link/P1073R3)
GO_NO_CXX2A_INIT_STATEMENTS_FOR_RANGE_BASED_FOR | init-statements for range-based for | [P0614R1](https://wg21.link/P0614R1)
GO_NO_CXX2A_INITIALIZER_LIST_CONSTRUCTORS_IN_CLASS_TEMPLATE_ARGUMENT_DEDUCTION | Initializer list constructors in class template argument deduction | [P0702R1](https://wg21.link/P0702R1)
GO_NO_CXX2A_INTEGRATING_FEATURE_TEST_MACROS | Integrating feature-test macros | [P0941R2](https://wg21.link/P0941R2)
GO_NO_CXX2A_LAMBDA_CAPTURE_AND_STORAGE_CLASS_SPECIFIERS_OF_STRUCTURED_BINDINGS | Lambda capture and storage class specifiers of structured bindings | [P1091R3](https://wg21.link/P1091R3), [P1381R1](https://wg21.link/P1381R1)
GO_NO_CXX2A_LAMBDAS_IN_UNEVALUATED_CONTEXTS | Lambdas in unevaluated contexts | [P0315R4](https://wg21.link/P0315R4)
GO_NO_CXX2A_LESS_EAGER_INSTANTIATION_OF_CONSTEXPR_FUNCTIONS | Less eager instantiation of constexpr functions | [P0859R0](https://wg21.link/P0859R0)
GO_NO_CXX2A_MAKE_TYPENAME_MORE_OPTIONAL | Make typename more optional | [P0634R3](https://wg21.link/P0634R3)
GO_NO_CXX2A_MODULES | Modules | [P1103R3](https://wg21.link/P1103R3)
GO_NO_CXX2A_MORE_CONSTEXPR_CONTAINERS | More constexpr containers | [P0784R7](https://wg21.link/P0784R7)
GO_NO_CXX2A_NESTED_INLINE_NAMESPACES | Nested inline namespaces | [P1094R2](https://wg21.link/P1094R2)
GO_NO_CXX2A_NODISCARD_WITH_MESSAGE | [[nodiscard]] with message | [P1301R4](https://wg21.link/P1301R4)
GO_NO_CXX2A_PACK_EXPANSION_IN_LAMBDA_INIT_CAPTURE | Pack expansion in lambda init-capture | [P0780R2](https://wg21.link/P0780R2)
GO_NO_CXX2A_PARENTHESIZED_INITIALIZATION_OF_AGGREGATES | Parenthesized initialization of aggregates | [P0960R3](https://wg21.link/P0960R3)
GO_NO_CXX2A_PERMIT_CONVERSIONS_TO_ARRAYS_OF_UNKNOWN_BOUND | Permit conversions to arrays of unknown bound | [P0388R4](https://wg21.link/P0388R4)
GO_NO_CXX2A_PROHIBIT_AGGREGATES_WITH_USER_DECLARED_CONSTRUCTORS | Prohibit aggregates with user-declared constructors | [P1008R1](https://wg21.link/P1008R1)
GO_NO_CXX2A_SIGNED_INTEGERS_ARE_TWOS_COMPLEMENT | Signed integers are two's complement | [P1236R1](https://wg21.link/P1236R1)
GO_NO_CXX2A_SIMPLIFYING_IMPLICIT_LAMBDA_CAPTURE | Simplifying implicit lambda capture | [P0588R1](https://wg21.link/P0588R1)
GO_NO_CXX2A_STD_IS_CONSTANT_EVALUATED | std::is_constant_evaluated() | [P0595R2](https://wg21.link/P0595R2)
GO_NO_CXX2A_STRONGER_UNICODE_REQUIREMENTS | Stronger Unicode requirements | [P1041R4](https://wg21.link/P1041R4), [P1139R2](https://wg21.link/P1139R2)
GO_NO_CXX2A_TEMPLATE_PARAMETER_LIST_FOR_GENERIC_LAMBDAS | template-parameter-list for generic lambdas | [P0428R2](https://wg21.link/P0428R2)
GO_NO_CXX2A_THREE_WAY_COMPARE_NOT_EQUAL_AND_EQUAL | <=> != == | [P1185R2](https://wg21.link/P1185R2)
GO_NO_CXX2A_THREE_WAY_COMPARISON_OPERATOR | Three-way comparison operator | [P0515R3](https://wg21.link/P0515R3)
GO_NO_CXX2A_TRIVIAL_DEFAULT_INITIALIZATION_IN_CONSTEXPR_FUNCTIONS | Trivial default initialization in constexpr functions | [P1331R2](https://wg21.link/P1331R2)
GO_NO_CXX2A_UNEVALUATED_ASM_DECLARATION_IN_CONSTEXPR_FUNCTIONS | Unevaluated asm-declaration in constexpr functions | [P1668R1](https://wg21.link/P1668R1)
GO_NO_CXX2A_YET_ANOTHER_APPROACH_FOR_CONSTRAINED_DECLARATIONS | Yet another approach for constrained declarations | [P1141R2](https://wg21.link/P1141R2)

### Compiler C++2a standard library support

Macro | Unsupported library feature | Paper(s)
-|-
GO_NO_CXX2A_A_SANE_STD_VARIANT_CONVERTING_CONSTRUCTOR | A sane std::variant converting constructor | [P0608R3](https://wg21.link/P0608R3)
GO_NO_CXX2A_ADD_SHIFT_TO_ALGORITHM | Add shift to <algorithm> | [P0769R2](https://wg21.link/P0769R2)
GO_NO_CXX2A_ATOMIC_STD_SHARED_PTR_AND_STD_WEAK_PTR | Atomic std::shared_ptr and std::weak_ptr | [P0718R2](https://wg21.link/P0718R2)
GO_NO_CXX2A_BIT_OPERATIONS | Bit operations | [P0553R4](https://wg21.link/P0553R4)
GO_NO_CXX2A_CALENDAR_AND_TIMEZONE | Calendar and timezone | [P0355R7](https://wg21.link/P0355R7)
GO_NO_CXX2A_CHRONO_ZERO_MIN_AND_MAX_SHOULD_BE_NOEXCEPT | <chrono> zero(), min(), and max() should be noexcept | [P0972R0](https://wg21.link/P0972R0)
GO_NO_CXX2A_COMPARING_UNORDERED_CONTAINERS | Comparing unordered containers | [P0809R0](https://wg21.link/P0809R0)
GO_NO_CXX2A_CONCEPTS_LIBRARY | Concepts library | [P0898R3](https://wg21.link/P0898R3)
GO_NO_CXX2A_CONSISTENT_CONTAINER_ERASURE | Consistent container erasure | [P1209R0](https://wg21.link/P1209R0)
GO_NO_CXX2A_CONSTEXPR_COMPARISON_OPERATORS_FOR_STD_ARRAY | constexpr comparison operators for std::array | [P1023R0](https://wg21.link/P1023R0)
GO_NO_CXX2A_CONSTEXPR_FOR_ALGORITHM_AND_UTILITY | constexpr for <algorithm> and <utility> | [P0202R3](https://wg21.link/P0202R3)
GO_NO_CXX2A_CONSTEXPR_FOR_STD_SWAP_AND_SWAP_RELATED_FUNCTIONS | Constexpr for std::swap() and swap related functions | [P0879R0](https://wg21.link/P0879R0)
GO_NO_CXX2A_CONSTEXPR_IN_STD_POINTER_TRAITS | constexpr in std::pointer_traits | [P1006R1](https://wg21.link/P1006R1)
GO_NO_CXX2A_CONSTEXPRITERATOR_REQUIREMENTS | ConstexprIterator requirements | [P0858R0](https://wg21.link/P0858R0)
GO_NO_CXX2A_CONTAINS_MEMBER_FUNCTION_OF_ASSOCIATIVE_CONTAINERS | contains() member function of associative containers | [P0458R2](https://wg21.link/P0458R2)
GO_NO_CXX2A_DR_GUARANTEED_COPY_ELISION_FOR_PIECEWISE_CONSTRUCTION | DR: Guaranteed copy elision for piecewise construction | [P0475R1](https://wg21.link/P0475R1)
GO_NO_CXX2A_DR_MAKE_CREATE_DIRECTORY_INTUITIVE | DR: Make create_directory() Intuitive | [P1164R1](https://wg21.link/P1164R1)
GO_NO_CXX2A_DR_STD_VARIANT_AND_STD_OPTIONAL_SHOULD_PROPAGATE_COPY_MOVE_TRIVIALITY | DR: std::variant and std::optional should propagate copy/move triviality | [P0602R4](https://wg21.link/P0602R4)
GO_NO_CXX2A_EXTENDING_STD_MAKE_SHARED_TO_SUPPORT_ARRAYS | Extending std::make_shared() to support arrays | [P0674R1](https://wg21.link/P0674R1)
GO_NO_CXX2A_FIXING_INPUT_STREAM_OPERATOR_BASIC_ISTREAM_REF_CHART_POINTER | Fixing operator>>(basic_istream&, CharT*) | [P0487R1](https://wg21.link/P0487R1)
GO_NO_CXX2A_FLOATING_POINT_ATOMIC | Floating point atomic | [P0020R6](https://wg21.link/P0020R6)
GO_NO_CXX2A_HETEROGENEOUS_LOOKUP_FOR_UNORDERED_CONTAINERS | Heterogeneous lookup for unordered containers | [P0919R3](https://wg21.link/P0919R3)
GO_NO_CXX2A_IMPROVING_THE_RETURN_VALUE_OF_ERASE_LIKE_ALGORITHMS | Improving the return value of erase-like algorithms | [P0646R1](https://wg21.link/P0646R1)
GO_NO_CXX2A_INTEGRAL_POWER_OF_2_OPERATIONS | Integral power-of-2 operations | [P0556R3](https://wg21.link/P0556R3)
GO_NO_CXX2A_LIBRARY_SUPPORT_FOR_CHAR8_T | Library support for char8_t | [P0482R6](https://wg21.link/P0482R6)
GO_NO_CXX2A_LIBRARY_SUPPORT_FOR_OPERATOR_THREE_WAY_COMPARE | Library support for operator<=> <compare> | [P0515R3](https://wg21.link/P0515R3)
GO_NO_CXX2A_MAKE_STATEFUL_ALLOCATOR_PROPAGATION_MORE_CONSISTENT_FOR_OPERATOR_PLUS_BASIC_STRING | Make stateful allocator propagation more consistent for operator+(basic_string) | [P1165R1](https://wg21.link/P1165R1)
GO_NO_CXX2A_MAKE_STD_MEMORY_ORDER_A_SCOPED_ENUMERATION | Make std::memory_order a scoped enumeration | [P0439R0](https://wg21.link/P0439R0)
GO_NO_CXX2A_MORE_CONSTEXPR_FOR_COMPLEX | More constexpr for <complex> | [P0415R1](https://wg21.link/P0415R1)
GO_NO_CXX2A_NODISCARD_IN_THE_STANDARD_LIBRARY | [[nodiscard]] in the standard library | [P0600R1](https://wg21.link/P0600R1)
GO_NO_CXX2A_REMOVE_COMPARISON_OPERATORS_OF_STD_SPAN | Remove comparison operators of std::span | [P1085R2](https://wg21.link/P1085R2)
GO_NO_CXX2A_STD_ASSUME_ALIGNED | std::assume_aligned() | [P1007R3](https://wg21.link/P1007R3)
GO_NO_CXX2A_STD_ATOMIC_REF | std::atomic_ref | [P0019R8](https://wg21.link/P0019R8)
GO_NO_CXX2A_STD_BASIC_STRING_RESERVE_SHOULD_NOT_SHRINK | std::basic_string::reserve() should not shrink | [P0966R1](https://wg21.link/P0966R1)
GO_NO_CXX2A_STD_BIND_FRONT | std::bind_front() | [P0356R5](https://wg21.link/P0356R5)
GO_NO_CXX2A_STD_BIT_CAST | std::bit_cast() | [P0476R2](https://wg21.link/P0476R2)
GO_NO_CXX2A_STD_DESTROYING_DELETE | std::destroying_delete | [P0722R3](https://wg21.link/P0722R3)
GO_NO_CXX2A_STD_ENDIAN | std::endian | [P0463R1](https://wg21.link/P0463R1)
GO_NO_CXX2A_STD_FUNCTIONS_MOVE_CONSTRUCTOR_SHOULD_BE_NOEXCEPT | std::function's move constructor should be noexcept | [P0771R1](https://wg21.link/P0771R1)
GO_NO_CXX2A_STD_IS_NOTHROW_CONVERTIBLE | std::is_nothrow_convertible | [P0758R1](https://wg21.link/P0758R1)
GO_NO_CXX2A_STD_LERP_AND_STD_MIDPOINT | std::lerp() and std::midpoint() | [P0811R3](https://wg21.link/P0811R3)
GO_NO_CXX2A_STD_REFERENCE_WRAPPER_FOR_INCOMPLETE_TYPES | std::reference_wrapper for incomplete types | [P0357R3](https://wg21.link/P0357R3)
GO_NO_CXX2A_STD_REMOVE_CVREF | std::remove_cvref | [P0550R2](https://wg21.link/P0550R2)
GO_NO_CXX2A_STD_SOURCE_LOCATION | std::source_location | [P1208R5](https://wg21.link/P1208R5)
GO_NO_CXX2A_STD_SPAN | std::span | [P0122R7](https://wg21.link/P0122R7)
GO_NO_CXX2A_STD_SSIZE_AND_UNSIGNED_EXTENT_FOR_STD_SPAN | std::ssize() and unsigned extent for std::span | [P1227R2](https://wg21.link/P1227R2)
GO_NO_CXX2A_STD_TYPE_IDENTITY | std::type_identity | [P0887R1](https://wg21.link/P0887R1)
GO_NO_CXX2A_STD_UNWRAP_REF_DECAY_AND_STD_UNWRAP_REFERENCE | std::unwrap_ref_decay and std::unwrap_reference | [P0318R1](https://wg21.link/P0318R1)
GO_NO_CXX2A_STRING_PREFIX_AND_SUFFIX_CHECKING | String prefix and suffix checking | [P0457R2](https://wg21.link/P0457R2)
GO_NO_CXX2A_SYNCHRONIZED_BUFFERED_OSTREAM | Synchronized buffered ostream | [P0053R7](https://wg21.link/P0053R7)
GO_NO_CXX2A_THE_ONE_RANGES_PROPOSAL | The One Ranges Proposal | [P0896R4](https://wg21.link/P0896R4)
GO_NO_CXX2A_TRAITS_FOR_BOUNDED_AND_UNBOUNDED_ARRAYS | Traits for (un)bounded arrays | [P1357R0](https://wg21.link/P1357R0)
GO_NO_CXX2A_USABILITY_ENHANCEMENTS_FOR_STD_SPAN | Usability enhancements for std::span | [P1024R3](https://wg21.link/P1024R3)
GO_NO_CXX2A_USING_STD_MOVE_IN_NUMERIC_ALGORITHMS | Using std::move in numeric algorithms | [P616R0](https://wg21.link/P616R0)
GO_NO_CXX2A_UTILITY_FUNCTIONS_TO_IMPLEMENT_USES_ALLOCATOR_CONSTRUCTION | Utility functions to implement uses-allocator construction | [P0591R4](https://wg21.link/P0591R4)
GO_NO_CXX2A_UTILITY_TO_CONVERT_A_POINTER_TO_A_RAW_POINTER | Utility to convert a pointer to a raw pointer | [P0653R2](https://wg21.link/P0653R2)
GO_NO_CXX2A_VERSION | <version> | [P0754R2](https://wg21.link/P0754R2)
