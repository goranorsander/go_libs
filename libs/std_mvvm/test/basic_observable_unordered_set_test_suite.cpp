...
TEST(std_basic_observable_unordered_set_test_suite, required_cpp11_feature_not_supported) {}
#else

using container_type = m::basic_observable_unordered_set<int, s::u8string>;
