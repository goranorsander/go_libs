#ifndef GO_BOOST_UTILITY_U8STRING_HPP_INCLUDED
#define GO_BOOST_UTILITY_U8STRING_HPP_INCLUDED
...
#if defined(GO_BOOST_NO_CXX20_CHAR8_T)
typedef unsigned char char8_t;
#endif  // #if defined(GO_BOOST_NO_CXX20_CHAR8_T)
...
public:
    ...
    u8string(u8string&& other) BOOST_NOEXCEPT_OR_NOTHROW;
...
inline u8string::u8string(u8string&& other) BOOST_NOEXCEPT_OR_NOTHROW
    : std::basic_string<char8_t, std::char_traits<char8_t>, std::allocator<char8_t>>(other)
{
}
...
#endif  // #ifndef GO_BOOST_UTILITY_U8STRING_HPP_INCLUDED
