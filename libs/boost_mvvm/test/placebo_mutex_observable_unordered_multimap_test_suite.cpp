//
//  placebo_mutex_observable_unordered_multimap_test_suite.cpp
//
...
public:
    ...
    typedef typename m::observable_unordered_multimap<K, T, u::placebo_mutex>::ptr observable_unordered_multimap_ptr_type;
...
TEST(boost_observable_unordered_multimap_placebo_mutex_test_suite, test_insert_single_element)
{
    // Test insert single element
    m::observable_unordered_multimap<int, int, u::placebo_mutex>::ptr m = m::observable_unordered_multimap<int, int, u::placebo_mutex>::create();
    unordered_multimap_observer<int, int> o;

    // TODO: Find a way to test insert without using insert to prepare the test
    EXPECT_EQ(0, m->size());
    m->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(1, 10));
    m->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(2, 20));
    m->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(4, 40));
    m->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(5, 50));
    m->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(6, 60));
    m->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(7, 70));
    EXPECT_EQ(6, m->size());

    o.connect(m);

    m->insert(m::observable_unordered_multimap<int, int, u::placebo_mutex>::value_type(3, 30));
    EXPECT_EQ(7, m->size());
...
TEST(boost_observable_unordered_multimap_placebo_mutex_test_suite, test_insert_single_element_with_hint)
{
    ...
    m::observable_unordered_multimap<int, int, u::placebo_mutex>::iterator it = m->insert(m->begin(), m::observable_unordered_multimap<int, int, u::placebo_mutex>::value_type(3, 30));
    EXPECT_EQ(5, m->size());

    it = m->insert(it, m::observable_unordered_multimap<int, int, u::placebo_mutex>::value_type(4, 40));
    EXPECT_EQ(6, m->size());

    it = m->insert(it, m::observable_unordered_multimap<int, int, u::placebo_mutex>::value_type(4, 40));
    EXPECT_EQ(7, m->size());

    it = m->insert(it, m::observable_unordered_multimap<int, int, u::placebo_mutex>::value_type(6, 60));
    EXPECT_EQ(8, m->size());
...
TEST(boost_observable_unordered_multimap_placebo_mutex_test_suite, test_insert_range)
{
    // Test insert range
    m::observable_unordered_multimap<int, int, u::placebo_mutex>::ptr m1 = m::observable_unordered_multimap<int, int, u::placebo_mutex>::create();
    m::observable_unordered_multimap<int, int, u::placebo_mutex>::ptr m2 = m::observable_unordered_multimap<int, int, u::placebo_mutex>::create();
    unordered_multimap_observer<int, int> o;

    EXPECT_EQ(0, m1->size());
    EXPECT_EQ(0, m2->size());

    m1->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(1, 10));
    m1->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(2, 20));
    m1->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(5, 50));
    m1->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(7, 70));
    EXPECT_EQ(4, m1->size());

    m2->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(3, 30));
    m2->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(4, 40));
    m2->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(6, 60));
    EXPECT_EQ(3, m2->size());
...
TEST(boost_observable_unordered_multimap_placebo_mutex_test_suite, test_insert_initializer_list)
{
    ...
    const std::initializer_list<m::observable_unordered_multimap<int, int, u::placebo_mutex>::value_type> il1 =
    {
        m::observable_unordered_multimap<int, int, u::placebo_mutex>::value_type(1, 10),
        m::observable_unordered_multimap<int, int, u::placebo_mutex>::value_type(2, 20),
        m::observable_unordered_multimap<int, int, u::placebo_mutex>::value_type(5, 50),
        m::observable_unordered_multimap<int, int, u::placebo_mutex>::value_type(7, 70)
    };
    *m = il1;
    EXPECT_EQ(4, m->size());

    const std::initializer_list<m::observable_unordered_multimap<int, int, u::placebo_mutex>::value_type> il2 =
    {
        m::observable_unordered_multimap<int, int, u::placebo_mutex>::value_type(3, 30),
        m::observable_unordered_multimap<int, int, u::placebo_mutex>::value_type(4, 40),
        m::observable_unordered_multimap<int, int, u::placebo_mutex>::value_type(6, 60)
    };
...
TEST(boost_observable_unordered_multimap_placebo_mutex_test_suite, test_erase_position)
{
    // Test erase position
    m::observable_unordered_multimap<int, int, u::placebo_mutex>::ptr m = m::observable_unordered_multimap<int, int, u::placebo_mutex>::create();
    unordered_multimap_observer<int, int> o;
    ...
    m::observable_unordered_multimap<int, int, u::placebo_mutex>::iterator it1 = m->begin();
    std::advance(it1, 3);
    m::observable_unordered_multimap<int, int, u::placebo_mutex>::iterator it2 = m->erase(it1);
    EXPECT_EQ(6, m->size());
...
TEST(boost_observable_unordered_multimap_placebo_mutex_test_suite, test_erase_value)
{
    // Test erase value
    m::observable_unordered_multimap<int, int, u::placebo_mutex>::ptr m = m::observable_unordered_multimap<int, int, u::placebo_mutex>::create();
    unordered_multimap_observer<int, int> o;
...
TEST(boost_observable_unordered_multimap_placebo_mutex_test_suite, test_erase_range)
{
    // Test erase range
    m::observable_unordered_multimap<int, int, u::placebo_mutex>::ptr m = m::observable_unordered_multimap<int, int, u::placebo_mutex>::create();
    unordered_multimap_observer<int, int> o;
    ...
    m::observable_unordered_multimap<int, int, u::placebo_mutex>::iterator begin = m->begin();
    ++begin;
    m::observable_unordered_multimap<int, int, u::placebo_mutex>::iterator end = begin;
    std::advance(end, 5);
...
TEST(boost_observable_unordered_multimap_placebo_mutex_test_suite, test_swap)
{
    // Test swap
    m::observable_unordered_multimap<int, int, u::placebo_mutex>::ptr m1 = m::observable_unordered_multimap<int, int, u::placebo_mutex>::create();
    m::observable_unordered_multimap<int, int, u::placebo_mutex>::ptr m2 = m::observable_unordered_multimap<int, int, u::placebo_mutex>::create();
    ...
    m1->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(1, 10));
    m1->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(2, 20));
    m1->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(3, 30));
    m1->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(4, 40));
    m1->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(5, 50));
    EXPECT_EQ(5, m1->size());

    m2->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(10, 100));
    m2->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(20, 200));
    m2->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(30, 300));
    m2->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(40, 400));
    m2->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(50, 500));
    m2->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(60, 600));
    m2->insert(m::observable_multimap<int, int, u::placebo_mutex>::value_type(70, 700));
    EXPECT_EQ(7, m2->size());
...
TEST(boost_observable_unordered_multimap_placebo_mutex_test_suite, test_clear)
{
    // Test clear
    m::observable_unordered_multimap<int, int, u::placebo_mutex>::ptr m = m::observable_unordered_multimap<int, int, u::placebo_mutex>::create();
    unordered_multimap_observer<int, int> o;
...
TEST(boost_observable_unordered_multimap_placebo_mutex_test_suite, test_emplace)
{
    // Test emplace
    m::observable_unordered_multimap<int, int, u::placebo_mutex>::ptr m = m::observable_unordered_multimap<int, int, u::placebo_mutex>::create();
    unordered_multimap_observer<int, int> o;
    ...
    m::observable_unordered_multimap<int, int, u::placebo_mutex>::iterator it = m->emplace(m::observable_unordered_multimap<int, int, u::placebo_mutex>::value_type(4, 40));
    EXPECT_EQ(4, it->first);
    EXPECT_EQ(40, it->second);

    it = m->emplace(m::observable_unordered_multimap<int, int, u::placebo_mutex>::value_type(5, 50));
    EXPECT_EQ(5, it->first);
    EXPECT_EQ(50, it->second);

    it = m->emplace(m::observable_unordered_multimap<int, int, u::placebo_mutex>::value_type(4, 40));
    EXPECT_EQ(4, it->first);
    EXPECT_EQ(40, it->second);

    it = m->emplace(m::observable_unordered_multimap<int, int, u::placebo_mutex>::value_type(6, 60));
...
TEST(boost_observable_unordered_multimap_placebo_mutex_test_suite, test_emplace_hint)
{
    // Test emplace hint
    m::observable_unordered_multimap<int, int, u::placebo_mutex>::ptr m = m::observable_unordered_multimap<int, int, u::placebo_mutex>::create();
    unordered_multimap_observer<int, int> o;
    ...
    m::observable_unordered_multimap<int, int, u::placebo_mutex>::iterator it = m->emplace_hint(m->begin(), m::observable_unordered_multimap<int, int, u::placebo_mutex>::value_type(3, 30));
    EXPECT_EQ(3, it->first);
    EXPECT_EQ(30, it->second);

    it = m->emplace_hint(it, m::observable_unordered_multimap<int, int, u::placebo_mutex>::value_type(4, 40));
    EXPECT_EQ(4, it->first);
    EXPECT_EQ(40, it->second);
    ...
    it = m->emplace_hint(it, m::observable_unordered_multimap<int, int, u::placebo_mutex>::value_type(6, 60));
    EXPECT_EQ(6, it->first);
    EXPECT_EQ(60, it->second);
