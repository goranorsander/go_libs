...
TEST(std_property_test_suite, value_scalar_properties)
{
    spaceship s;
...
TEST(std_property_test_suite, read_only_scalar_properties)
{
...
TEST(std_property_test_suite, write_only_scalar_properties)
{
...
TEST(std_property_test_suite, ref_scalar_properties)
{
    ref_spaceship s;
...
TEST(std_property_test_suite, read_only_ref_scalar_properties)
{
...
TEST(std_property_test_suite, write_only_ref_scalar_properties)
{
