...
TEST(std_basic_observable_forward_list_test_suite, test_erase_after_position)
{
...
TEST(std_basic_observable_forward_list_test_suite, test_splice_after_entire_container)
{
