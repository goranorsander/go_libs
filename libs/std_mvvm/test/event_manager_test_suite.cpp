...
\
    std::shared_ptr<spaceship_type> ship1 = spaceship_type::create("Millennium Falcon", "Han Solo", "General Jan Dodonna"); \
    std::shared_ptr<spaceship_type> ship2 = spaceship_type::create("X-Wing Red Leader", "Garven Dreis", "General Jan Dodonna"); \
    std::shared_ptr<spaceship_type> ship3 = spaceship_type::create("X-Wing Red Two", "Wedge Antilles", "General Jan Dodonna"); \
    std::shared_ptr<spaceship_type> ship4 = spaceship_type::create("X-Wing Red Three", "Biggs Darklighter", "General Jan Dodonna"); \
    std::shared_ptr<spaceship_type> ship5 = spaceship_type::create("X-Wing Red Four", "John D. Branon", "General Jan Dodonna"); \
    std::shared_ptr<spaceship_type> ship6 = spaceship_type::create("X-Wing Red Five", "Luke Skywalker", "General Jan Dodonna"); \
    std::shared_ptr<spaceship_type> ship7 = spaceship_type::create("Y-Wing Gold Leader", "Jon 'Dutch' Vander", "General Jan Dodonna"); \
    std::shared_ptr<spaceship_type> ship8 = spaceship_type::create("Y-Wing Gold Two", "Dex Tiree", "General Jan Dodonna"); \
\
