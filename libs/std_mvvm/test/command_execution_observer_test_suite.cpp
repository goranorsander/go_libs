...
public:
    ...
    virtual void on_command_executed(const std::shared_ptr<m::command_interface>& /*c*/) override
    {
        ++_number_of_executed_commands;
    }

    virtual void on_command_not_executed(const std::shared_ptr<m::command_interface>& /*c*/) override
    {
