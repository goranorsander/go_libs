...
TEST(std_nameless_property_placebo_lockable_test_suite, cpp11_not_supported) {}
#else
...
template <>
class TypeWithoutFormatter<np::value_property<double, u::placebo_lockable>, kConvertibleToInteger>
{
public:
	static void PrintValue(const np::value_property<double, u::placebo_lockable>& value, ::std::ostream* os)
	{
...
TEST(std_nameless_property_placebo_lockable_test_suite, value_properties)
{
    spaceship s;
...
TEST(std_nameless_property_placebo_lockable_test_suite, read_only_value_properties)
{
...
TEST(std_nameless_property_placebo_lockable_test_suite, write_only_value_properties)
{
...
TEST(std_nameless_property_placebo_lockable_test_suite, reference_properties)
{
...
TEST(std_nameless_property_placebo_lockable_test_suite, read_only_reference_properties)
{
    int store_crew_complement = 1012;
    double store_max_speed = 9.8;
    std::string store_name("USS Enterprise (NCC-1701-D)");
...
TEST(std_nameless_property_placebo_lockable_test_suite, write_only_reference_properties)
{
...
TEST(std_nameless_property_placebo_lockable_test_suite, proxy_properties)
{
    armed_spaceship s;
...
TEST(std_nameless_property_placebo_lockable_test_suite, read_only_proxy_properties)
{
...
TEST(std_nameless_property_placebo_lockable_test_suite, write_only_proxy_properties)
{
