//
//  placebo_mutex_observable_deque_test_suite.cpp
//
...
TEST(std_observable_deque_placebo_mutex_test_suite, cpp11_not_supported) {}
#else
...
public:
    ...
    typedef typename m::observable_deque<T, u::placebo_mutex>::ptr observable_deque_ptr_type;
...
TEST(std_observable_deque_placebo_mutex_test_suite, test_assign_range)
{
    // Test assign range
    m::observable_deque<int, u::placebo_mutex>::ptr d = m::observable_deque<int, u::placebo_mutex>::create();
...
TEST(std_observable_deque_placebo_mutex_test_suite, test_assign_initializer_list)
{
...
TEST(std_observable_deque_placebo_mutex_test_suite, test_assign_fill)
{
    // Test assign fill
    m::observable_deque<int, u::placebo_mutex>::ptr d1 = m::observable_deque<int, u::placebo_mutex>::create();
    m::observable_deque<int, u::placebo_mutex>::ptr d2 = m::observable_deque<int, u::placebo_mutex>::create();
    deque_observer<int> o;
    ...
    m::observable_deque<int, u::placebo_mutex>::iterator it = d1->begin() + 1;
...
TEST(std_observable_deque_placebo_mutex_test_suite, test_push_back)
{
    // Test push back
    m::observable_deque<int, u::placebo_mutex>::ptr d = m::observable_deque<int, u::placebo_mutex>::create();
    deque_observer<int> o;
...
TEST(std_observable_deque_placebo_mutex_test_suite, test_push_front)
{
    // Test push front
    m::observable_deque<int, u::placebo_mutex>::ptr d = m::observable_deque<int, u::placebo_mutex>::create();
    deque_observer<int> o;
...
TEST(std_observable_deque_placebo_mutex_test_suite, test_pop_back)
{
    // Test pop back
    m::observable_deque<int, u::placebo_mutex>::ptr d = m::observable_deque<int, u::placebo_mutex>::create();
    deque_observer<int> o;
...
TEST(std_observable_deque_placebo_mutex_test_suite, test_pop_front)
{
    // Test pop front
    m::observable_deque<int, u::placebo_mutex>::ptr d = m::observable_deque<int, u::placebo_mutex>::create();
    deque_observer<int> o;
...
TEST(std_observable_deque_placebo_mutex_test_suite, test_insert_single_element)
{
    ...
    m::observable_deque<int, u::placebo_mutex>::iterator it = d->begin();
    d->insert(it + 2, 3);
    EXPECT_EQ(7, d->size());
...
TEST(std_observable_deque_placebo_mutex_test_suite, test_insert_fill)
{
    // Test insert fill
    m::observable_deque<int, u::placebo_mutex>::ptr d = m::observable_deque<int, u::placebo_mutex>::create();
    deque_observer<int> o;
...
TEST(std_observable_deque_placebo_mutex_test_suite, test_insert_range)
{
    // Test insert range
    m::observable_deque<int, u::placebo_mutex>::ptr d1 = m::observable_deque<int, u::placebo_mutex>::create();
    m::observable_deque<int, u::placebo_mutex>::ptr d2 = m::observable_deque<int, u::placebo_mutex>::create();
    ...
    m::observable_deque<int, u::placebo_mutex>::iterator it = d2->begin();
...
TEST(std_observable_deque_placebo_mutex_test_suite, test_erase_position)
{
    // Test erase position
    m::observable_deque<int, u::placebo_mutex>::ptr d = m::observable_deque<int, u::placebo_mutex>::create();
    deque_observer<int> o;
    ...
    m::observable_deque<int, u::placebo_mutex>::iterator it1 = d->begin();
    m::observable_deque<int, u::placebo_mutex>::iterator it2 = d->erase(it1 + 3);
    EXPECT_EQ(6, d->size());
...
TEST(std_observable_deque_placebo_mutex_test_suite, test_erase_range)
{
    // Test erase range
    m::observable_deque<int, u::placebo_mutex>::ptr d = m::observable_deque<int, u::placebo_mutex>::create();
    deque_observer<int> o;
...
TEST(std_observable_deque_placebo_mutex_test_suite, test_swap)
{
    // Test swap
    m::observable_deque<int, u::placebo_mutex>::ptr d1 = m::observable_deque<int, u::placebo_mutex>::create();
    m::observable_deque<int, u::placebo_mutex>::ptr d2 = m::observable_deque<int, u::placebo_mutex>::create();
...
TEST(std_observable_deque_placebo_mutex_test_suite, test_clear)
{
    // Test clear
    m::observable_deque<int, u::placebo_mutex>::ptr d = m::observable_deque<int, u::placebo_mutex>::create();
    deque_observer<int> o;
...
TEST(std_observable_deque_placebo_mutex_test_suite, test_emplace)
{
    // Test emplace
    m::observable_deque<int, u::placebo_mutex>::ptr d = m::observable_deque<int, u::placebo_mutex>::create();
    deque_observer<int> o;
    ...
    m::observable_deque<int, u::placebo_mutex>::iterator it = d->emplace(d->begin() + 1, 4);
    EXPECT_EQ(4, *it);
...
TEST(std_observable_deque_placebo_mutex_test_suite, test_emplace_back)
{
    // Test emplace back
    m::observable_deque<int, u::placebo_mutex>::ptr d = m::observable_deque<int, u::placebo_mutex>::create();
    deque_observer<int> o;
...
TEST(std_observable_deque_placebo_mutex_test_suite, test_emplace_front)
{
    // Test emplace front
    m::observable_deque<int, u::placebo_mutex>::ptr d = m::observable_deque<int, u::placebo_mutex>::create();
    deque_observer<int> o;
