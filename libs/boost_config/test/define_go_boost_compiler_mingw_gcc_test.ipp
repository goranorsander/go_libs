//
//  define_go_boost_compiler_mingw_gcc_test.ipp
//
...
TEST(boost_define_go_boost_compiler_test_suite, test_define_go_boost_comp_gcc)
{
...
TEST(boost_define_go_boost_compiler_test_suite, test_define_go_boost_comp_gcc_mingw)
{
...
TEST(boost_define_go_boost_compiler_test_suite, test_define_go_boost_gcc_version)
{
    #if defined(GO_BOOST_GCC_VERSION)
    const int expected_version = __GNUC__ * 10000 + __GNUC_MINOR__ * 100 + __GNUC_PATCHLEVEL__;
    const int go_boost_gcc_version = GO_BOOST_GCC_VERSION;
    EXPECT_EQ(expected_version, go_boost_gcc_version);
    #else
    EXPECT_TRUE(false);
    #endif
}
