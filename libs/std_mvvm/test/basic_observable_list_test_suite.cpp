...
TEST(std_basic_observable_list_test_suite, cpp11_not_supported) {}
#else
...
public:
    ...
    typedef typename m::basic_observable_list<T, u::u8string>::ptr observable_list_ptr_type;
...
TEST(std_basic_observable_list_test_suite, test_assign_range)
{
    // Test assign range
    m::basic_observable_list<int, u::u8string>::ptr l = m::basic_observable_list<int, u::u8string>::create();
    list_observer<int> o;
...
TEST(std_basic_observable_list_test_suite, test_assign_initializer_list)
{
...
TEST(std_basic_observable_list_test_suite, test_assign_fill)
{
    // Test assign fill
    m::basic_observable_list<int, u::u8string>::ptr l1 = m::basic_observable_list<int, u::u8string>::create();
    m::basic_observable_list<int, u::u8string>::ptr l2 = m::basic_observable_list<int, u::u8string>::create();
    list_observer<int> o;
    ...
    m::basic_observable_list<int, u::u8string>::iterator begin = l1->begin();
    ++begin;
    m::basic_observable_list<int, u::u8string>::iterator end = l1->end();
    --end;
...
TEST(std_basic_observable_list_test_suite, test_push_back)
{
    // Test push back
    m::basic_observable_list<int, u::u8string>::ptr l = m::basic_observable_list<int, u::u8string>::create();
    list_observer<int> o;
...
TEST(std_basic_observable_list_test_suite, test_push_front)
{
    // Test push front
    m::basic_observable_list<int, u::u8string>::ptr l = m::basic_observable_list<int, u::u8string>::create();
    list_observer<int> o;
...
TEST(std_basic_observable_list_test_suite, test_pop_back)
{
    // Test pop back
    m::basic_observable_list<int, u::u8string>::ptr l = m::basic_observable_list<int, u::u8string>::create();
    list_observer<int> o;
...
TEST(std_basic_observable_list_test_suite, test_pop_front)
{
    // Test pop front
    m::basic_observable_list<int, u::u8string>::ptr l = m::basic_observable_list<int, u::u8string>::create();
    list_observer<int> o;
...
TEST(std_basic_observable_list_test_suite, test_insert_single_element)
{
    ...
    m::basic_observable_list<int, u::u8string>::iterator it = l->begin();
    std::advance(it, 2);
    l->insert(it, 3);
    EXPECT_EQ(7, l->size());
...
TEST(std_basic_observable_list_test_suite, test_insert_fill)
{
    // Test insert fill
    m::basic_observable_list<int, u::u8string>::ptr l = m::basic_observable_list<int, u::u8string>::create();
    list_observer<int> o;
...
TEST(std_basic_observable_list_test_suite, test_insert_range)
{
    // Test insert range
    m::basic_observable_list<int, u::u8string>::ptr l1 = m::basic_observable_list<int, u::u8string>::create();
    m::basic_observable_list<int, u::u8string>::ptr l2 = m::basic_observable_list<int, u::u8string>::create();
    ...
    m::basic_observable_list<int, u::u8string>::iterator it = l2->begin();
    std::advance(it, 3);
...
TEST(std_basic_observable_list_test_suite, test_erase_position)
{
    // Test erase position
    m::basic_observable_list<int, u::u8string>::ptr l = m::basic_observable_list<int, u::u8string>::create();
    list_observer<int> o;
    ...
    m::basic_observable_list<int, u::u8string>::iterator it1 = l->begin();
    std::advance(it1, 3);
    m::basic_observable_list<int, u::u8string>::iterator it2 = l->erase(it1);
    EXPECT_EQ(6, l->size());
...
TEST(std_basic_observable_list_test_suite, test_erase_range)
{
    // Test erase range
    m::basic_observable_list<int, u::u8string>::ptr l = m::basic_observable_list<int, u::u8string>::create();
    list_observer<int> o;
    ...
    m::basic_observable_list<int, u::u8string>::iterator begin = l->begin();
    ++begin;
    m::basic_observable_list<int, u::u8string>::iterator end = l->end();
    --end;
...
TEST(std_basic_observable_list_test_suite, test_swap)
{
    // Test swap
    m::basic_observable_list<int, u::u8string>::ptr l1 = m::basic_observable_list<int, u::u8string>::create();
    m::basic_observable_list<int, u::u8string>::ptr l2 = m::basic_observable_list<int, u::u8string>::create();
...
TEST(std_basic_observable_list_test_suite, test_clear)
{
    // Test clear
    m::basic_observable_list<int, u::u8string>::ptr l = m::basic_observable_list<int, u::u8string>::create();
    list_observer<int> o;
...
TEST(std_basic_observable_list_test_suite, test_emplace)
{
    // Test emplace
    m::basic_observable_list<int, u::u8string>::ptr l = m::basic_observable_list<int, u::u8string>::create();
    list_observer<int> o;
    ...
    m::basic_observable_list<int, u::u8string>::iterator begin = l->begin();
    ++begin;
    m::basic_observable_list<int, u::u8string>::iterator it = l->emplace(begin, 4);
    EXPECT_EQ(4, *it);
...
TEST(std_basic_observable_list_test_suite, test_emplace_back)
{
    // Test emplace back
    m::basic_observable_list<int, u::u8string>::ptr l = m::basic_observable_list<int, u::u8string>::create();
    list_observer<int> o;
...
TEST(std_basic_observable_list_test_suite, test_emplace_front)
{
    // Test emplace front
    m::basic_observable_list<int, u::u8string>::ptr l = m::basic_observable_list<int, u::u8string>::create();
    list_observer<int> o;
...
TEST(std_basic_observable_list_test_suite, test_splice_entire_list)
{
    ...
    m::basic_observable_list<int, u::u8string>::iterator it1 = l1->begin();
    ++it1;
    EXPECT_EQ(2, *it1);
    ...
    m::basic_observable_list<int, u::u8string>::iterator it = l1->begin();
    EXPECT_EQ(1, *it);
    ++it;
    EXPECT_EQ(10, *it);
    ++it;
...
TEST(std_basic_observable_list_test_suite, test_splice_single_element)
{
    ...
    m::basic_observable_list<int, u::u8string>::iterator it2 = l2->begin();
    std::advance(it2, 4);
    EXPECT_EQ(2, *it2);
...
TEST(std_basic_observable_list_test_suite, test_splice_element_range)
{
    ...
    m::basic_observable_list<int, u::u8string>::iterator it2first = l2->begin();
    ++it2first;
    EXPECT_EQ(20, *it2first);

    m::basic_observable_list<int, u::u8string>::iterator it2last = l2->begin();
...
TEST(std_basic_observable_list_test_suite, test_remove)
{
    // Test remove
    m::basic_observable_list<int, u::u8string>::ptr l = m::basic_observable_list<int, u::u8string>::create();
    list_observer<int> o;
...
TEST(std_basic_observable_list_test_suite, test_remove_if)
{
    // Test remove if
    m::basic_observable_list<int, u::u8string>::ptr l = m::basic_observable_list<int, u::u8string>::create();
    list_observer<int> o;
...
TEST(std_basic_observable_list_test_suite, test_unique)
{
    // Test unique
    m::basic_observable_list<int, u::u8string>::ptr l = m::basic_observable_list<int, u::u8string>::create();
    list_observer<int> o;
...
TEST(std_basic_observable_list_test_suite, test_unique_binary_predicate)
{
    // Test unique binary predicate
    m::basic_observable_list<double, u::u8string>::ptr l = m::basic_observable_list<double, u::u8string>::create();
    ...
    m::basic_observable_list<double, u::u8string>::iterator it = l->begin();
    EXPECT_EQ(2.72, *it);
    ++it;
    EXPECT_EQ(3.14, *it);
    ++it;
...
TEST(std_basic_observable_list_test_suite, test_merge)
{
    // Test merge
    m::basic_observable_list<double, u::u8string>::ptr l1 = m::basic_observable_list<double, u::u8string>::create();
    m::basic_observable_list<double, u::u8string>::ptr l2 = m::basic_observable_list<double, u::u8string>::create();
    ...
    m::basic_observable_list<double, u::u8string>::iterator it = l1->begin();
    EXPECT_EQ(1.4, *it);
    ++it;
    EXPECT_EQ(2.2, *it);
    ++it;
...
TEST(std_basic_observable_list_test_suite, test_merge_compare_predicate)
{
