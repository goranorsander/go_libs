...
// C++11 support
#if (GO_BOOST_GCC_VERSION < 30300)
#define GO_BOOST_NO_CXX11 1
#endif  // #if (GO_BOOST_GCC_VERSION < 30300)

// C++11 language support
#if (GO_BOOST_GCC_VERSION < 40801)
#define GO_BOOST_NO_CXX11_DECLTYPE 1
#define GO_BOOST_NO_CXX11_REF_QUALIFIERS 1
#endif  // #if (GO_BOOST_GCC_VERSION < 40801)
...
#if (GO_BOOST_GCC_VERSION < 40600)
#define GO_BOOST_NO_CXX11_CONSTEXPRv
...
#endif  // #if (GO_BOOST_GCC_VERSION < 40600)
#if (GO_BOOST_GCC_VERSION < 40500)
...
#endif  // #if (GO_BOOST_GCC_VERSION < 40500)
#if (GO_BOOST_GCC_VERSION < 40400)
...
#endif  // #if (GO_BOOST_GCC_VERSION < 40400)
#if (GO_BOOST_GCC_VERSION < 40300)
...
#endif  // #if (GO_BOOST_GCC_VERSION < 40300)
#if (GO_BOOST_GCC_VERSION < 30300)
...
// C++14 support
#if (GO_BOOST_GCC_VERSION < 40900)
#define GO_BOOST_NO_CXX14 1
#endif  // #if (GO_BOOST_GCC_VERSION < 40900)
...
#endif  // #if (GO_BOOST_GCC_VERSION < 30000)

// C++17 language support
#if (GO_BOOST_GCC_VERSION < 70000)
...
#endif  // #if (GO_BOOST_GCC_VERSION < 70000)
#if (GO_BOOST_GCC_VERSION < 60000)
...
#endif  // #if (GO_BOOST_GCC_VERSION < 90000)
#if (GO_BOOST_GCC_VERSION < 80000)
#define GO_BOOST_NO_CXX17_ELEMENTARY_STRING_CONVERSIONS
#define GO_BOOST_NO_CXX17_FILE_SYSTEM_LIBRARY
#endif  // #if (GO_BOOST_GCC_VERSION < 80000)
#if (GO_BOOST_GCC_VERSION < 70000)
...
#if (GO_BOOST_GCC_VERSION < 100000)
...
#endif  // #if (GO_BOOST_GCC_VERSION < 100000)
#if (GO_BOOST_GCC_VERSION < 90000)
...
#if (GO_BOOST_GCC_VERSION < 100000)
#define GO_BOOST_NO_CXX2A_A_SANE_STD_VARIANT_CONVERTING_CONSTRUCTOR 1
#define GO_BOOST_NO_CXX2A_CONSTEXPR_COMPARISON_OPERATORS_FOR_STD_ARRAY 1
#define GO_BOOST_NO_CXX2A_CONSTEXPR_FOR_ALGORITHM_AND_UTILITY 1
#define GO_BOOST_NO_CXX2A_CONSTEXPR_FOR_STD_SWAP_AND_SWAP_RELATED_FUNCTIONS 1
#define GO_BOOST_NO_CXX2A_FLOATING_POINT_ATOMIC 1
#define GO_BOOST_NO_CXX2A_MAKE_STATEFUL_ALLOCATOR_PROPAGATION_MORE_CONSISTENT_FOR_OPERATOR_PLUS_BASIC_STRING 1
#define GO_BOOST_NO_CXX2A_REMOVE_COMPARISON_OPERATORS_OF_STD_SPAN 1
#define GO_BOOST_NO_CXX2A_STD_ATOMIC_REF 1
#define GO_BOOST_NO_CXX2A_STD_SPAN 1
#define GO_BOOST_NO_CXX2A_STD_SSIZE_AND_UNSIGNED_EXTENT_FOR_STD_SPAN 1
#define GO_BOOST_NO_CXX2A_USABILITY_ENHANCEMENTS_FOR_STD_SPAN 1
#endif  // #if (GO_BOOST_GCC_VERSION < 100000)
#if (GO_BOOST_GCC_VERSION < 90000)
#define GO_BOOST_NO_CXX2A_BIT_OPERATIONS 1
#define GO_BOOST_NO_CXX2A_CHRONO_ZERO_MIN_AND_MAX_SHOULD_BE_NOEXCEPT 1
#define GO_BOOST_NO_CXX2A_CONSISTENT_CONTAINER_ERASURE 1
#define GO_BOOST_NO_CXX2A_CONSTEXPR_IN_STD_POINTER_TRAITS 1
#define GO_BOOST_NO_CXX2A_CONSTEXPRITERATOR_REQUIREMENTS 1
#define GO_BOOST_NO_CXX2A_CONTAINS_MEMBER_FUNCTION_OF_ASSOCIATIVE_CONTAINERS 1
#define GO_BOOST_NO_CXX2A_DR_GUARANTEED_COPY_ELISION_FOR_PIECEWISE_CONSTRUCTION 1
#define GO_BOOST_NO_CXX2A_IMPROVING_THE_RETURN_VALUE_OF_ERASE_LIKE_ALGORITHMS 1
#define GO_BOOST_NO_CXX2A_INTEGRAL_POWER_OF_2_OPERATIONS 1
#define GO_BOOST_NO_CXX2A_LIBRARY_SUPPORT_FOR_CHAR8_T 1
#define GO_BOOST_NO_CXX2A_MAKE_STD_MEMORY_ORDER_A_SCOPED_ENUMERATION 1
#define GO_BOOST_NO_CXX2A_MORE_CONSTEXPR_FOR_COMPLEX 1
#define GO_BOOST_NO_CXX2A_NODISCARD_IN_THE_STANDARD_LIBRARY 1
#define GO_BOOST_NO_CXX2A_STD_ASSUME_ALIGNED 1
#define GO_BOOST_NO_CXX2A_STD_BIND_FRONT 1
#define GO_BOOST_NO_CXX2A_STD_DESTROYING_DELETE 1
#define GO_BOOST_NO_CXX2A_STD_IS_NOTHROW_CONVERTIBLE 1
#define GO_BOOST_NO_CXX2A_STD_LERP_AND_STD_MIDPOINT 1
#define GO_BOOST_NO_CXX2A_STD_REFERENCE_WRAPPER_FOR_INCOMPLETE_TYPES 1
#define GO_BOOST_NO_CXX2A_STD_REMOVE_CVREF 1
#define GO_BOOST_NO_CXX2A_STD_TYPE_IDENTITY 1
#define GO_BOOST_NO_CXX2A_STD_UNWRAP_REF_DECAY_AND_STD_UNWRAP_REFERENCE 1
#define GO_BOOST_NO_CXX2A_STRING_PREFIX_AND_SUFFIX_CHECKING 1
#define GO_BOOST_NO_CXX2A_TRAITS_FOR_BOUNDED_AND_UNBOUNDED_ARRAYS 1
#define GO_BOOST_NO_CXX2A_USING_STD_MOVE_IN_NUMERIC_ALGORITHMS 1
#define GO_BOOST_NO_CXX2A_UTILITY_FUNCTIONS_TO_IMPLEMENT_USES_ALLOCATOR_CONSTRUCTION 1
#define GO_BOOST_NO_CXX2A_VERSION 1
#endif  // #if (GO_BOOST_GCC_VERSION < 90000)
#if (GO_BOOST_GCC_VERSION < 80300)
#define GO_BOOST_NO_CXX2A_DR_MAKE_CREATE_DIRECTORY_INTUITIVE 1
#define GO_BOOST_NO_CXX2A_DR_STD_VARIANT_AND_STD_OPTIONAL_SHOULD_PROPAGATE_COPY_MOVE_TRIVIALITY 1
#endif  // #if (GO_BOOST_GCC_VERSION < 80300)
#if (GO_BOOST_GCC_VERSION < 80000)
#define GO_BOOST_NO_CXX2A_STD_ENDIAN 1
#define GO_BOOST_NO_CXX2A_UTILITY_TO_CONVERT_A_POINTER_TO_A_RAW_POINTER 1
#endif  // #if (GO_BOOST_GCC_VERSION < 80000)
#if (GO_BOOST_GCC_VERSION < 70200)
#define GO_BOOST_NO_CXX2A_STD_FUNCTIONS_MOVE_CONSTRUCTOR_SHOULD_BE_NOEXCEPT 1
#endif  // #if (GO_BOOST_GCC_VERSION < 70200)
#if defined(GO_BOOST_GCC_VERSION)
#define GO_BOOST_NO_CXX2A_ADD_SHIFT_TO_ALGORITHM 1
#define GO_BOOST_NO_CXX2A_ATOMIC_STD_SHARED_PTR_AND_STD_WEAK_PTR 1
#define GO_BOOST_NO_CXX2A_CALENDAR_AND_TIMEZONE 1
#define GO_BOOST_NO_CXX2A_COMPARING_UNORDERED_CONTAINERS 1
#define GO_BOOST_NO_CXX2A_CONCEPTS_LIBRARY 1
#define GO_BOOST_NO_CXX2A_EXTENDING_STD_MAKE_SHARED_TO_SUPPORT_ARRAYS 1
#define GO_BOOST_NO_CXX2A_FIXING_INPUT_STREAM_OPERATOR_BASIC_ISTREAM_REF_CHART_POINTER 1
#define GO_BOOST_NO_CXX2A_HETEROGENEOUS_LOOKUP_FOR_UNORDERED_CONTAINERS 1
#define GO_BOOST_NO_CXX2A_LIBRARY_SUPPORT_FOR_OPERATOR_THREE_WAY_COMPARE 1
#define GO_BOOST_NO_CXX2A_STD_BASIC_STRING_RESERVE_SHOULD_NOT_SHRINK 1
#define GO_BOOST_NO_CXX2A_STD_BIT_CAST 1
#define GO_BOOST_NO_CXX2A_STD_SOURCE_LOCATION 1
#define GO_BOOST_NO_CXX2A_SYNCHRONIZED_BUFFERED_OSTREAM 1
#define GO_BOOST_NO_CXX2A_THE_ONE_RANGES_PROPOSAL 1
#endif  // #if defined(GO_BOOST_GCC_VERSION)
