...
TEST(std_create_string_test_suite, test_create_string_from_wchar_t)
{
    const char* expected_result = multibyte::iso_8859_1_printable_characters;
...
TEST(std_create_string_test_suite, test_create_string_from_char2_t)
{
    const char* expected_result = multibyte::iso_8859_1_printable_characters;
...
TEST(std_create_string_test_suite, test_create_string_from_char8_t)
{
    const char* expected_result = multibyte::iso_8859_1_printable_characters;
...
TEST(std_create_string_test_suite, test_create_wstring_from_wchar_t)
{
    const wchar_t* expected_result = system_wide::iso_8859_1_printable_characters;
    const wchar_t* from_characters = system_wide::iso_8859_1_printable_characters;
    const std::wstring created_string = s::create<std::wstring>(from_characters);
...
TEST(std_create_string_test_suite, test_create_wstring_from_char2_t)
{
    const wchar_t* expected_result = system_wide::iso_8859_1_printable_characters;
    const s::char2_t* from_characters = ucs_2::iso_8859_1_printable_characters;
    const std::wstring created_string = s::create<std::wstring>(from_characters);
...
TEST(std_create_string_test_suite, test_create_wstring_from_char8_t)
{
    const wchar_t* expected_result = system_wide::iso_8859_1_printable_characters;
    const char8_t* from_characters = utf_8::iso_8859_1_printable_characters;
    const std::wstring created_string = s::create<std::wstring>(from_characters);
...
TEST(std_create_string_test_suite, cannot_create_u2string_issue) {}
#else

TEST(std_create_string_test_suite, test_create_u2string_from_char)
{
...
TEST(std_create_string_test_suite, test_create_u2string_from_wchar_t)
{
    const s::char2_t* expected_result = ucs_2::iso_8859_1_printable_characters;
    const wchar_t* from_characters = system_wide::iso_8859_1_printable_characters;
    const s::u2string created_string = s::create<s::u2string>(from_characters);
...
TEST(std_create_string_test_suite, test_create_u2string_from_char2_t)
{
    const s::char2_t* expected_result = ucs_2::iso_8859_1_printable_characters;
    const s::char2_t* from_characters = ucs_2::iso_8859_1_printable_characters;
    const s::u2string created_string = s::create<s::u2string>(from_characters);
...
TEST(std_create_string_test_suite, test_create_u2string_from_char8_t)
{
    const s::char2_t* expected_result = ucs_2::iso_8859_1_printable_characters;
    const char8_t* from_characters = utf_8::iso_8859_1_printable_characters;
    const s::u2string created_string = s::create<s::u2string>(from_characters);
...
TEST(std_create_string_test_suite, test_create_u8string_from_char)
{
...
TEST(std_create_string_test_suite, test_create_u8string_from_wchar_t)
{
    const char8_t* expected_result = utf_8::iso_8859_1_printable_characters;
    const wchar_t* from_characters = system_wide::iso_8859_1_printable_characters;
    const s::u8string created_string = s::create<s::u8string>(from_characters);
...
TEST(std_create_string_test_suite, test_create_u8string_from_char2_t)
{
    const char8_t* expected_result = utf_8::iso_8859_1_printable_characters;
    const s::char2_t* from_characters = ucs_2::iso_8859_1_printable_characters;
    const s::u8string created_string = s::create<s::u8string>(from_characters);
...
TEST(std_create_string_test_suite, test_create_u8string_from_char8_t)
{
    const char8_t* expected_result = utf_8::iso_8859_1_printable_characters;
    const char8_t* from_characters = utf_8::iso_8859_1_printable_characters;
    const s::u8string created_string = s::create<s::u8string>(from_characters);
...
TEST(std_create_string_test_suite, test_create_u16string_from_char)
{
    ...
    const char* from_characters = multibyte::iso_8859_1_printable_characters;
    const std::u16string created_string = s::create<std::u16string>(from_characters);
    const std::size_t string_memory_usage = sizeof(std::u16string::value_type)*utf_16::iso_8859_1_printable_characters_count;
    EXPECT_EQ(0, std::memcmp(expected_result, created_string.c_str(), string_memory_usage));
}

TEST(std_create_string_test_suite, test_create_u16string_from_wchar_t)
{
    const char16_t* expected_result = utf_16::iso_8859_1_printable_characters;
    const wchar_t* from_characters = system_wide::iso_8859_1_printable_characters;
    const std::u16string created_string = s::create<std::u16string>(from_characters);
...
TEST(std_create_string_test_suite, test_create_u16string_from_char2_t)
{
    const char16_t* expected_result = utf_16::iso_8859_1_printable_characters;
    const s::char2_t* from_characters = ucs_2::iso_8859_1_printable_characters;
    const std::u16string created_string = s::create<std::u16string>(from_characters);
...
TEST(std_create_string_test_suite, test_create_u16string_from_char8_t)
{
    const char16_t* expected_result = utf_16::iso_8859_1_printable_characters;
    const char8_t* from_characters = utf_8::iso_8859_1_printable_characters;
    const std::u16string created_string = s::create<std::u16string>(from_characters);
...
TEST(std_create_string_test_suite, test_create_u16string_from_char16_t)
{
    const char16_t* expected_result = utf_16::iso_8859_1_printable_characters;
    const char16_t* from_characters = utf_16::iso_8859_1_printable_characters;
    const std::u16string created_string = s::create<std::u16string>(from_characters);
...
TEST(std_create_string_test_suite, test_create_u16string_from_char32_t)
{
    const char16_t* expected_result = utf_16::iso_8859_1_printable_characters;
    const char32_t* from_characters = utf_32::iso_8859_1_printable_characters;
    const std::u16string created_string = s::create<std::u16string>(from_characters);
...
TEST(std_create_string_test_suite, test_create_u32string_from_char)
{
    ...
    const char* from_characters = multibyte::iso_8859_1_printable_characters;
    const std::u32string created_string = s::create<std::u32string>(from_characters);
    const std::size_t string_memory_usage = sizeof(std::u32string::value_type)*utf_32::iso_8859_1_printable_characters_count;
    EXPECT_EQ(0, std::memcmp(expected_result, created_string.c_str(), string_memory_usage));
}

TEST(std_create_string_test_suite, test_create_u32string_from_wchar_t)
{
    const char32_t* expected_result = utf_32::iso_8859_1_printable_characters;
    const wchar_t* from_characters = system_wide::iso_8859_1_printable_characters;
    const std::u32string created_string = s::create<std::u32string>(from_characters);
...
TEST(std_create_string_test_suite, test_create_u32string_from_char2_t)
{
    const char32_t* expected_result = utf_32::iso_8859_1_printable_characters;
    const s::char2_t* from_characters = ucs_2::iso_8859_1_printable_characters;
    const std::u32string created_string = s::create<std::u32string>(from_characters);
...
TEST(std_create_string_test_suite, test_create_u32string_from_char8_t)
{
    const char32_t* expected_result = utf_32::iso_8859_1_printable_characters;
    const char8_t* from_characters = utf_8::iso_8859_1_printable_characters;
    const std::u32string created_string = s::create<std::u32string>(from_characters);
...
TEST(std_create_string_test_suite, test_create_u32string_from_char16_t)
{
    const char32_t* expected_result = utf_32::iso_8859_1_printable_characters;
    const char16_t* from_characters = utf_16::iso_8859_1_printable_characters;
    const std::u32string created_string = s::create<std::u32string>(from_characters);
...
TEST(std_create_string_test_suite, test_create_u32string_from_char32_t)
{
    const char32_t* expected_result = utf_32::iso_8859_1_printable_characters;
    const char32_t* from_characters = utf_32::iso_8859_1_printable_characters;
    const std::u32string created_string = s::create<std::u32string>(from_characters);
