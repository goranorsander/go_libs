...
TEST(std_relay_command_placebo_lockable_test_suite, required_cpp11_feature_not_supported) {}
#else
...
{
public:
    using can_execute_changed_signal = GO_TYPENAME go::signals::signal<void(const std::shared_ptr<mst::command_interface>&)>;
