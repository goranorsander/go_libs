...
def generate_markdown_report(xml_source_directory_name, md_file)
    ...
    md_file.puts("")
    md_file.puts("* " + reports.to_s + " unit test applications executed, " + (reports/11).to_s + " for each toolset" )
    md_file.puts("* " + testsuites.to_s + " unit test suites, on average " + (testsuites/11).to_s + " for each toolset")
    md_file.puts("* " + testcases.to_s + " unit test cases, on average " + (testcases/11).to_s + " for each toolset")
