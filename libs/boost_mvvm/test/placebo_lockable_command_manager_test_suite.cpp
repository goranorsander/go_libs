...
private:
    ...
    mst::command_interface::ptr get_impulse_speed_command()
    {
        ...
        {
            _impulse_speed_command = mst::relay_command::create("impulse_speed", boost::bind(&spaceship::go_to_impulse, this, boost::placeholders::_1), boost::bind(&spaceship::can_go_to_impulse, this, boost::placeholders::_1), m::command_parameters::create());
        }
    ...
    mst::command_interface::ptr get_warp_speed_command()
    {
        ...
        {
            _warp_speed_command = mst::relay_command::create("warp_speed", boost::bind(&spaceship::go_to_warp, this, boost::placeholders::_1), boost::bind(&spaceship::can_go_to_warp, this, boost::placeholders::_1), m::command_parameters::create());
        }
