...
TEST(std_wobservable_forward_list_test_suite, cpp11_not_supported) {}
#else
...
TEST(std_wobservable_forward_list_test_suite, test_assign_range)
{
    // Test assign range
    m::wobservable_forward_list<int>::ptr l = m::wobservable_forward_list<int>::create();
...
TEST(std_wobservable_forward_list_test_suite, test_assign_initializer_list)
{
...
TEST(std_wobservable_forward_list_test_suite, test_assign_fill)
{
    // Test assign fill
    m::wobservable_forward_list<int>::ptr l1 = m::wobservable_forward_list<int>::create();
    m::wobservable_forward_list<int>::ptr l2 = m::wobservable_forward_list<int>::create();
    forward_list_observer<int> o;
    ...
    m::wobservable_forward_list<int>::iterator begin = l1->begin();
    ++begin;
    m::wobservable_forward_list<int>::iterator end = begin;
    std::advance(end, 5);
...
TEST(std_wobservable_forward_list_test_suite, test_push_front)
{
    // Test push front
    m::wobservable_forward_list<int>::ptr l = m::wobservable_forward_list<int>::create();
    forward_list_observer<int> o;
...
TEST(std_wobservable_forward_list_test_suite, test_pop_front)
{
    // Test pop front
    m::wobservable_forward_list<int>::ptr l = m::wobservable_forward_list<int>::create();
    forward_list_observer<int> o;
...
TEST(std_wobservable_forward_list_test_suite, test_insert_after_single_element)
{
    ...
    m::wobservable_forward_list<int>::iterator it = l->begin();
    std::advance(it, 2);
    l->insert_after(it, 4);
    EXPECT_EQ(7u, l->size());
...
TEST(std_wobservable_forward_list_test_suite, test_insert_after_fill)
{
...
TEST(std_wobservable_forward_list_test_suite, test_insert_after_range)
{
    ...
    m::wobservable_forward_list<int>::iterator it = l2->begin();
    std::advance(it, 3);
...
TEST(std_wobservable_forward_list_test_suite, test_erase_position)
{
    // Test erase position
    m::wobservable_forward_list<int>::ptr l = m::wobservable_forward_list<int>::create();
    forward_list_observer<int> o;
    ...
    m::wobservable_forward_list<int>::iterator it1 = l->begin();
    std::advance(it1, 3);
    m::wobservable_forward_list<int>::iterator it2 = l->erase_after(it1);
    EXPECT_EQ(6u, l->size());
...
TEST(std_wobservable_forward_list_test_suite, test_erase_range)
{
    // Test erase range
    m::wobservable_forward_list<int>::ptr l = m::wobservable_forward_list<int>::create();
    forward_list_observer<int> o;
    ...
    m::wobservable_forward_list<int>::iterator begin = l->begin();
    ++begin;
    m::wobservable_forward_list<int>::iterator end = begin;
    std::advance(end, 5);
...
TEST(std_wobservable_forward_list_test_suite, test_swap)
{
    // Test swap
    m::wobservable_forward_list<int>::ptr l1 = m::wobservable_forward_list<int>::create();
    m::wobservable_forward_list<int>::ptr l2 = m::wobservable_forward_list<int>::create();
...
TEST(std_wobservable_forward_list_test_suite, test_clear)
{
    // Test clear
    m::wobservable_forward_list<int>::ptr l = m::wobservable_forward_list<int>::create();
    forward_list_observer<int> o;
...
TEST(std_wobservable_forward_list_test_suite, test_emplace_after)
{
    // Test emplace after
    m::wobservable_forward_list<int>::ptr l = m::wobservable_forward_list<int>::create();
    forward_list_observer<int> o;
    ...
    m::wobservable_forward_list<int>::iterator begin = l->begin();
    ++begin;
    m::wobservable_forward_list<int>::iterator it = l->emplace_after(begin, 4);
    EXPECT_EQ(4, *it);
...
TEST(std_wobservable_forward_list_test_suite, test_emplace_back)
{
    // Test emplace back
    m::wobservable_forward_list<int>::ptr l = m::wobservable_forward_list<int>::create();
    forward_list_observer<int> o;
...
TEST(std_wobservable_forward_list_test_suite, test_emplace_front)
{
    // Test emplace front
    m::wobservable_forward_list<int>::ptr l = m::wobservable_forward_list<int>::create();
    forward_list_observer<int> o;
...
TEST(std_wobservable_forward_list_test_suite, test_splice_after_entire_forward_list)
{
    ...
    m::wobservable_forward_list<int>::iterator it1 = l1->begin();
    ++it1;
    EXPECT_EQ(2, *it1);
    ...
    m::wobservable_forward_list<int>::iterator it = l1->begin();
    EXPECT_EQ(1, *it);
    ++it;
    EXPECT_EQ(2, *it);
    ++it;
...
TEST(std_wobservable_forward_list_test_suite, test_splice_after_single_element)
{
    ...
    m::wobservable_forward_list<int>::iterator it2 = l2->begin();
    std::advance(it2, 4);
    EXPECT_EQ(3, *it2);
...
TEST(std_wobservable_forward_list_test_suite, test_splice_after_element_range)
{
    ...
    m::wobservable_forward_list<int>::iterator it2first = l2->begin();
    ++it2first;
    EXPECT_EQ(20, *it2first);

    m::wobservable_forward_list<int>::iterator it2last = l2->begin();
...
TEST(std_wobservable_forward_list_test_suite, test_remove)
{
    // Test remove
    m::wobservable_forward_list<int>::ptr l = m::wobservable_forward_list<int>::create();
    forward_list_observer<int> o;
...
TEST(std_wobservable_forward_list_test_suite, test_remove_if)
{
    // Test remove if
    m::wobservable_forward_list<int>::ptr l = m::wobservable_forward_list<int>::create();
    forward_list_observer<int> o;
...
TEST(std_wobservable_forward_list_test_suite, test_unique)
{
    // Test unique
    m::wobservable_forward_list<int>::ptr l = m::wobservable_forward_list<int>::create();
    forward_list_observer<int> o;
...
TEST(std_wobservable_forward_list_test_suite, test_unique_binary_predicate)
{
    // Test unique binary predicate
    m::wobservable_forward_list<double>::ptr l = m::wobservable_forward_list<double>::create();
    ...
    m::wobservable_forward_list<double>::iterator it = l->begin();
    EXPECT_EQ(2.72, *it);
    ++it;
    EXPECT_EQ(3.14, *it);
    ++it;
...
TEST(std_wobservable_forward_list_test_suite, test_merge)
{
    // Test merge
    m::wobservable_forward_list<double>::ptr l1 = m::wobservable_forward_list<double>::create();
    m::wobservable_forward_list<double>::ptr l2 = m::wobservable_forward_list<double>::create();
    ...
    m::wobservable_forward_list<double>::iterator it = l1->begin();
    EXPECT_EQ(1.4, *it);
    ++it;
    EXPECT_EQ(2.2, *it);
    ++it;
...
TEST(std_wobservable_forward_list_test_suite, test_merge_compare_predicate)
{
