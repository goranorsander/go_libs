...
TEST(boost_observable_unordered_multimap_test_suite, test_insert_single_element)
{
    ...
    int count = 0;
    int sum = 0;
    BOOST_FOREACH(const typename observable_unordered_multimap_type::value_type& i, *m)
    {
        sum += i.second;
        ++count;
    }
...
TEST(boost_observable_unordered_multimap_test_suite, test_swap)
{
    ...
    int count = 0;
    int sum = 0;
    BOOST_FOREACH(const typename observable_unordered_multimap_type::value_type& i, *m1)
    {
        sum += i.second;
        ++count;
    }
    ...
    count = 0;
    sum = 0;
    BOOST_FOREACH(const typename observable_unordered_multimap_type::value_type& i, *m2)
    {
        sum += i.second;
        ++count;
    }
