...
public:
    ...
    virtual void on_command_executed(const std::shared_ptr<m::wcommand_interface>& /*c*/)
    {
        ++_number_of_executed_commands;
    }

    virtual void on_command_not_executed(const std::shared_ptr<m::wcommand_interface>& /*c*/)
    {
