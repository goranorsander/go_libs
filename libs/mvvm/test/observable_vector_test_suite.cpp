//
//  observable_vector_test_suite.cpp
//
...
TEST(std_observable_vector_test_suite, cpp11_not_supported) {}
#else
...
public:
    ...
    typedef typename m::observable_vector<T>::ptr observable_vector_ptr_type;
...
TEST(std_observable_vector_test_suite, test_assign_range)
{
    // Test assign range
...
TEST(std_observable_vector_test_suite, test_assign_initializer_list)
{
...
TEST(std_observable_vector_test_suite, test_assign_fill)
{
    // Test assign fill
    m::observable_vector<int>::ptr v1 = m::observable_vector<int>::create();
    m::observable_vector<int>::ptr v2 = m::observable_vector<int>::create();
    vector_observer<int> o;
    ...
    m::observable_vector<int>::iterator it = v1->begin() + 1;
...
TEST(std_observable_vector_test_suite, test_push_back)
{
    // Test push back
    m::observable_vector<int>::ptr v = m::observable_vector<int>::create();
    vector_observer<int> o;
...
TEST(std_observable_vector_test_suite, test_pop_back)
{
    // Test pop back
    m::observable_vector<int>::ptr v = m::observable_vector<int>::create();
    vector_observer<int> o;
...
TEST(std_observable_vector_test_suite, test_insert_single_element)
{
    ...
    m::observable_vector<int>::iterator it = v->begin();
    v->insert(it + 2, 3);
    EXPECT_EQ(7, v->size());
...
TEST(std_observable_vector_test_suite, test_insert_fill)
{
    // Test insert fill
    m::observable_vector<int>::ptr v = m::observable_vector<int>::create();
    vector_observer<int> o;
...
TEST(std_observable_vector_test_suite, test_insert_range)
{
    // Test insert range
    m::observable_vector<int>::ptr v1 = m::observable_vector<int>::create();
    m::observable_vector<int>::ptr v2 = m::observable_vector<int>::create();
    ...
    m::observable_vector<int>::iterator it = v2->begin();
...
TEST(std_observable_vector_test_suite, test_erase_position)
{
    // Test erase position
    m::observable_vector<int>::ptr v = m::observable_vector<int>::create();
    vector_observer<int> o;
    ...
    m::observable_vector<int>::iterator it1 = v->begin();
    m::observable_vector<int>::iterator it2 = v->erase(it1 + 3);
    EXPECT_EQ(6, v->size());
...
TEST(std_observable_vector_test_suite, test_erase_range)
{
    // Test erase range
    m::observable_vector<int>::ptr v = m::observable_vector<int>::create();
    vector_observer<int> o;
...
TEST(std_observable_vector_test_suite, test_swap)
{
    // Test swap
    m::observable_vector<int>::ptr v1 = m::observable_vector<int>::create();
    m::observable_vector<int>::ptr v2 = m::observable_vector<int>::create();
...
TEST(std_observable_vector_test_suite, test_clear)
{
    // Test clear
    m::observable_vector<int>::ptr v = m::observable_vector<int>::create();
    vector_observer<int> o;
...
TEST(std_observable_vector_test_suite, test_emplace)
{
    // Test emplace
    m::observable_vector<int>::ptr v = m::observable_vector<int>::create();
    vector_observer<int> o;
...
TEST(std_observable_vector_test_suite, test_emplace_back)
{
    // Test emplace back
    m::observable_vector<int>::ptr v = m::observable_vector<int>::create();
    vector_observer<int> o;
