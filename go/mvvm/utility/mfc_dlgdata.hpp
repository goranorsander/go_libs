...
// go::property::property<go::utility::primitive_type_specializer>

template<class PrimitiveTypeSpecializer>
typename std::enable_if<std::is_base_of<go::utility::detail::primitive_type_specializer_base, PrimitiveTypeSpecializer>::value && std::is_same<typename PrimitiveTypeSpecializer::primitive_type, BYTE>::value, void>::type AFXAPI DDX_Text(CDataExchange* pDX, int nIDC, go::property::property<PrimitiveTypeSpecializer>& value)
{
...
template<class PrimitiveTypeSpecializer>
typename std::enable_if<std::is_base_of<go::utility::detail::primitive_type_specializer_base, PrimitiveTypeSpecializer>::value && std::is_same<typename PrimitiveTypeSpecializer::primitive_type, short>::value, void>::type AFXAPI DDX_Text(CDataExchange* pDX, int nIDC, go::property::property<PrimitiveTypeSpecializer>& value)
{
...
template<class PrimitiveTypeSpecializer>
typename std::enable_if<std::is_base_of<go::utility::detail::primitive_type_specializer_base, PrimitiveTypeSpecializer>::value && std::is_same<typename PrimitiveTypeSpecializer::primitive_type, int>::value, void>::type AFXAPI DDX_Text(CDataExchange* pDX, int nIDC, go::property::property<PrimitiveTypeSpecializer>& value)
{
...
template<class PrimitiveTypeSpecializer>
typename std::enable_if<std::is_base_of<go::utility::detail::primitive_type_specializer_base, PrimitiveTypeSpecializer>::value && std::is_same<typename PrimitiveTypeSpecializer::primitive_type, UINT>::value, void>::type AFXAPI DDX_Text(CDataExchange* pDX, int nIDC, go::property::property<PrimitiveTypeSpecializer>& value)
{
...
template<class PrimitiveTypeSpecializer>
typename std::enable_if<std::is_base_of<go::utility::detail::primitive_type_specializer_base, PrimitiveTypeSpecializer>::value && std::is_same<typename PrimitiveTypeSpecializer::primitive_type, long>::value, void>::type AFXAPI DDX_Text(CDataExchange* pDX, int nIDC, go::property::property<PrimitiveTypeSpecializer>& value)
{
...
template<class PrimitiveTypeSpecializer>
typename std::enable_if<std::is_base_of<go::utility::detail::primitive_type_specializer_base, PrimitiveTypeSpecializer>::value && std::is_same<typename PrimitiveTypeSpecializer::primitive_type, DWORD>::value, void>::type AFXAPI DDX_Text(CDataExchange* pDX, int nIDC, go::property::property<PrimitiveTypeSpecializer>& value)
{
...
template<class PrimitiveTypeSpecializer>
typename std::enable_if<std::is_base_of<go::utility::detail::primitive_type_specializer_base, PrimitiveTypeSpecializer>::value && std::is_same<typename PrimitiveTypeSpecializer::primitive_type, LONGLONG>::value, void>::type AFXAPI DDX_Text(CDataExchange* pDX, int nIDC, go::property::property<PrimitiveTypeSpecializer>& value)
{
...
template<class PrimitiveTypeSpecializer>
typename std::enable_if<std::is_base_of<go::utility::detail::primitive_type_specializer_base, PrimitiveTypeSpecializer>::value && std::is_same<typename PrimitiveTypeSpecializer::primitive_type, ULONGLONG>::value, void>::type AFXAPI DDX_Text(CDataExchange* pDX, int nIDC, go::property::property<PrimitiveTypeSpecializer>& value)
{
...
template<class PrimitiveTypeSpecializer>
typename std::enable_if<std::is_base_of<go::utility::detail::primitive_type_specializer_base, PrimitiveTypeSpecializer>::value && std::is_same<typename PrimitiveTypeSpecializer::primitive_type, float>::value, void>::type AFXAPI DDX_Text(CDataExchange* pDX, int nIDC, go::property::property<PrimitiveTypeSpecializer>& value)
{
...
template<class PrimitiveTypeSpecializer>
typename std::enable_if<std::is_base_of<go::utility::detail::primitive_type_specializer_base, PrimitiveTypeSpecializer>::value && std::is_same<typename PrimitiveTypeSpecializer::primitive_type, double>::value, void>::type AFXAPI DDX_Text(CDataExchange* pDX, int nIDC, go::property::property<PrimitiveTypeSpecializer>& value)
{
...
// go::property::wproperty<go::utility::primitive_type_specializer>

template<class PrimitiveTypeSpecializer>
typename std::enable_if<std::is_base_of<go::utility::detail::primitive_type_specializer_base, PrimitiveTypeSpecializer>::value && std::is_same<typename PrimitiveTypeSpecializer::primitive_type, BYTE>::value, void>::type AFXAPI DDX_Text(CDataExchange* pDX, int nIDC, go::property::wproperty<PrimitiveTypeSpecializer>& value)
{
...
template<class PrimitiveTypeSpecializer>
typename std::enable_if<std::is_base_of<go::utility::detail::primitive_type_specializer_base, PrimitiveTypeSpecializer>::value && std::is_same<typename PrimitiveTypeSpecializer::primitive_type, short>::value, void>::type AFXAPI DDX_Text(CDataExchange* pDX, int nIDC, go::property::wproperty<PrimitiveTypeSpecializer>& value)
{
...
template<class PrimitiveTypeSpecializer>
typename std::enable_if<std::is_base_of<go::utility::detail::primitive_type_specializer_base, PrimitiveTypeSpecializer>::value && std::is_same<typename PrimitiveTypeSpecializer::primitive_type, int>::value, void>::type AFXAPI DDX_Text(CDataExchange* pDX, int nIDC, go::property::wproperty<PrimitiveTypeSpecializer>& value)
{
...
template<class PrimitiveTypeSpecializer>
typename std::enable_if<std::is_base_of<go::utility::detail::primitive_type_specializer_base, PrimitiveTypeSpecializer>::value && std::is_same<typename PrimitiveTypeSpecializer::primitive_type, UINT>::value, void>::type AFXAPI DDX_Text(CDataExchange* pDX, int nIDC, go::property::wproperty<PrimitiveTypeSpecializer>& value)
{
...
template<class PrimitiveTypeSpecializer>
typename std::enable_if<std::is_base_of<go::utility::detail::primitive_type_specializer_base, PrimitiveTypeSpecializer>::value && std::is_same<typename PrimitiveTypeSpecializer::primitive_type, long>::value, void>::type AFXAPI DDX_Text(CDataExchange* pDX, int nIDC, go::property::wproperty<PrimitiveTypeSpecializer>& value)
{
...
template<class PrimitiveTypeSpecializer>
typename std::enable_if<std::is_base_of<go::utility::detail::primitive_type_specializer_base, PrimitiveTypeSpecializer>::value && std::is_same<typename PrimitiveTypeSpecializer::primitive_type, DWORD>::value, void>::type AFXAPI DDX_Text(CDataExchange* pDX, int nIDC, go::property::wproperty<PrimitiveTypeSpecializer>& value)
{
...
template<class PrimitiveTypeSpecializer>
typename std::enable_if<std::is_base_of<go::utility::detail::primitive_type_specializer_base, PrimitiveTypeSpecializer>::value && std::is_same<typename PrimitiveTypeSpecializer::primitive_type, LONGLONG>::value, void>::type AFXAPI DDX_Text(CDataExchange* pDX, int nIDC, go::property::wproperty<PrimitiveTypeSpecializer>& value)
{
...
template<class PrimitiveTypeSpecializer>
typename std::enable_if<std::is_base_of<go::utility::detail::primitive_type_specializer_base, PrimitiveTypeSpecializer>::value && std::is_same<typename PrimitiveTypeSpecializer::primitive_type, float>::value, void>::type AFXAPI DDX_Text(CDataExchange* pDX, int nIDC, go::property::wproperty<PrimitiveTypeSpecializer>& value)
{
...
template<class PrimitiveTypeSpecializer>
typename std::enable_if<std::is_base_of<go::utility::detail::primitive_type_specializer_base, PrimitiveTypeSpecializer>::value && std::is_same<typename PrimitiveTypeSpecializer::primitive_type, double>::value, void>::type AFXAPI DDX_Text(CDataExchange* pDX, int nIDC, go::property::wproperty<PrimitiveTypeSpecializer>& value)
{
