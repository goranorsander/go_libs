...
public:
    static ptr create(const m::basic_event_manager<u::u8string>::ptr& event_manager_, const u::u8string& commander_, const u::u8string& battle_)
    {
        ...
        ptr commander = std::make_shared<make_shared_enabler, const m::basic_event_manager<u::u8string>::ptr&, const u::u8string&, const u::u8string&>(event_manager_, commander_, battle_);
