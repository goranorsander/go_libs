...
protected:
    ...
    explicit basic_observable_list(const boost::initializer_list<value_type>& il);
...
Constructs a new **basic_observable_list<value_type, string_type, lockable_type>** object and return it as a
**basic_observable_list<value_type, string_type, lockable_type>\::ptr** object.
...
*constructor (7)* | protected explicit | **basic_observable_list**(const boost::initializer_list<value_type>& il)
