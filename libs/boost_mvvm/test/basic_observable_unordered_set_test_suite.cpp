...
TEST(boost_basic_observable_unordered_set_test_suite, test_erase_value)
{
    ...
    typedef m::basic_observable_unordered_set<int, u::u8string> observable_unordered_set_type;
    int count = 0;
    int sum = 0;
...
TEST(boost_basic_observable_unordered_set_test_suite, test_erase_range)
{
    ...
    ++begin;
    m::basic_observable_unordered_set<int, u::u8string>::iterator end = begin;
    std::advance(end, 5);
