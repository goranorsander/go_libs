#ifndef GO_TEST_FRAMEWORK_GO_BOOST_TEST_FLEET_COMMANDER_HPP_INCLUDED
#define GO_TEST_FRAMEWORK_GO_BOOST_TEST_FLEET_COMMANDER_HPP_INCLUDED
...
public:
    static ptr create(const event_manager_ptr& event_manager_, const string_identifier_type& commander_, const string_identifier_type& battle_)
    {
        ...
        ptr fleet_cmdr = boost::make_shared<make_shared_enabler, const event_manager_ptr&, const string_identifier_type&, const string_identifier_type&>(event_manager_, commander_, battle_);
#else
...
private:
    ...
    {
        this->commander.getter(boost::bind(&fleet_commander::get_commander, this));
        this->commander.setter(boost::bind(&fleet_commander::set_commander, this, boost::placeholders::_1));
    }
...
#endif  // #ifndef GO_TEST_FRAMEWORK_GO_BOOST_TEST_FLEET_COMMANDER_HPP_INCLUDED
