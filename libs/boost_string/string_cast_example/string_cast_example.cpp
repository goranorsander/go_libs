...
{
    {
        ...
        const s::u16string utf_16_swedish = s::string_cast<s::u16string>(multibyte_swedish_source);
        const s::u32string utf_32_swedish = s::string_cast<s::u32string>(multibyte_swedish_source);
...
#else
        print_hex<s::u16string, unsigned int>(utf_16_swedish);
#endif  // #if !defined(BOOST_NO_CXX11_FUNCTION_TEMPLATE_DEFAULT_ARGS)
...
#else
        print_hex<s::u32string, unsigned int>(utf_32_swedish);
#endif  // #if !defined(BOOST_NO_CXX11_FUNCTION_TEMPLATE_DEFAULT_ARGS)
...
#else
        print_hex<s::u8string, unsigned int>(utf_8_swedish);
#endif  // #if !defined(BOOST_NO_CXX11_FUNCTION_TEMPLATE_DEFAULT_ARGS)
    }
    {
        ...
        const s::u16string utf_16_tibetan = s::string_cast<s::u16string>(utf_8_tibetan_source);
        const s::u32string utf_32_tibetan = s::string_cast<s::u32string>(utf_8_tibetan_source);
...
#else
        print_hex<s::u16string, unsigned int>(utf_16_tibetan);
#endif  // #if !defined(BOOST_NO_CXX11_FUNCTION_TEMPLATE_DEFAULT_ARGS)
...
#else
        print_hex<s::u32string, unsigned int>(utf_32_tibetan);
#endif  // #if !defined(BOOST_NO_CXX11_FUNCTION_TEMPLATE_DEFAULT_ARGS)
...
#else
        print_hex<s::u8string, unsigned int>(utf_8_tibetan);
#endif  // #if !defined(BOOST_NO_CXX11_FUNCTION_TEMPLATE_DEFAULT_ARGS)
    }
    return 0;
}
