//
//  placebo_mutex_property_test_suite.cpp
//
...
TEST(std_property_placebo_mutex_test_suite, cpp11_not_supported) {}
#else
...
{
public:
    p::value_property<int, u::placebo_mutex> crew_complement;
    p::value_property<double, u::placebo_mutex> max_speed;
    p::value_property<std::string, u::placebo_mutex> name;
...
TEST(std_property_placebo_mutex_test_suite, value_properties)
{
    spaceship s;
...
{
public:
    rop::value_property<int, u::placebo_mutex> crew_complement;
    rop::value_property<double, u::placebo_mutex> max_speed;
    rop::value_property<std::string, u::placebo_mutex> name;
...
TEST(std_property_placebo_mutex_test_suite, read_only_value_properties)
{
...
{
public:
    wop::value_property<int, u::placebo_mutex> crew_complement;
    wop::value_property<double, u::placebo_mutex> max_speed;
    wop::value_property<std::string, u::placebo_mutex> name;
...
TEST(std_property_placebo_mutex_test_suite, write_only_value_properties)
{
...
{
public:
    p::reference_property<int, u::placebo_mutex> crew_complement;
    p::reference_property<double, u::placebo_mutex> max_speed;
    p::reference_property<std::string, u::placebo_mutex> name;
...
TEST(std_property_placebo_mutex_test_suite, reference_properties)
{
...
{
public:
    rop::reference_property<int, u::placebo_mutex> crew_complement;
    rop::reference_property<double, u::placebo_mutex> max_speed;
    rop::reference_property<std::string, u::placebo_mutex> name;
...
TEST(std_property_placebo_mutex_test_suite, read_only_reference_properties)
{
    int store_crew_complement = 1012;
    double store_max_speed = 9.8;
    std::string store_name("USS Enterprise (NCC-1701-D)");
...
{
public:
    wop::reference_property<int, u::placebo_mutex> crew_complement;
    wop::reference_property<double, u::placebo_mutex> max_speed;
    wop::reference_property<std::string, u::placebo_mutex> name;
...
TEST(std_property_placebo_mutex_test_suite, write_only_reference_properties)
{
    int store_crew_complement = 1012;
    double store_max_speed = 9.8;
    std::string store_name("USS Enterprise (NCC-1701-D)");
...
{
public:
    p::property<int, u::placebo_mutex> phaser_arrays;
...
TEST(std_property_placebo_mutex_test_suite, proxy_properties)
{
    armed_spaceship s;
...
{
public:
    rop::property<int, u::placebo_mutex> phaser_arrays;
...
TEST(std_property_placebo_mutex_test_suite, read_only_proxy_properties)
{
...
{
public:
    wop::property<int, u::placebo_mutex> phaser_arrays;
...
TEST(std_property_placebo_mutex_test_suite, write_only_proxy_properties)
{
