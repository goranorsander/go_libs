...
public:
    ...
    rop::wproperty<mst::wcommand_interface::ptr> on_activate_spaceship_view_command;
    rop::wproperty<mst::wcommand_interface::ptr> on_close_spaceship_view_command;
    rop::wproperty<mst::wcommand_interface::ptr> on_add_equipment_command;
    rop::wproperty<mst::wcommand_interface::ptr> on_remove_equipment_command;
...
private:
    ...
    mst::wcommand_interface::ptr _on_activate_spaceship_view_command;
    mst::wcommand_interface::ptr _on_close_spaceship_view_command;
    mst::wcommand_interface::ptr _on_add_equipment_command;
    mst::wcommand_interface::ptr _on_remove_equipment_command;
};
