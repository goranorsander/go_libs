...
typedef m::observable_list<int, a::placebo_lockable> container_type;
typedef m::observable_list<double, a::placebo_lockable> double_container_type;
...
TEST(boost_observable_list_placebo_lockable_test_suite, test_splice_entire_container)
{
