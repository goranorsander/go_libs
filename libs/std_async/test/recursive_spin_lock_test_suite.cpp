...
TEST(std_recursive_spin_lock_test_suite, required_cpp11_feature_not_supported) {}
#else
...
TEST(std_recursive_spin_lock_test_suite, test_recursive_spin_lock_lock_guard)
{
    ...
    {
        std::lock_guard<a::recursive_spin_lock> guard(lock);
...
TEST(std_recursive_spin_lock_test_suite, test_recursive_spin_lock_two_threads)
{
    ...
    {
        std::lock_guard<a::recursive_spin_lock> guard(t.lock);
