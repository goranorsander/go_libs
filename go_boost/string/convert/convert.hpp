#ifndef GO_BOOST_STRING_CONVERT_CONVERT_HPP_INCLUDED
#define GO_BOOST_STRING_CONVERT_CONVERT_HPP_INCLUDED
...
#include <go_boost/string/convert/convert_linux.hpp>
#endif  // #if defined(GO_BOOST_PLATFORM_LINUX)
#if defined(GO_BOOST_PLATFORM_WINDOWS) && !defined(GO_BOOST_COMP_GCC_MINGW)
#include <go_boost/string/convert/convert_windows.hpp>
#endif  // #if defined(GO_BOOST_PLATFORM_WINDOWS)

#include <go_boost/string/convert/try_convert_ucs2.hpp>
...
inline u2string convert_u8string_to_u2string(const u8string& s)
{
    ...
    {
        char2_t ucs2ch = 0;
        if (go_boost::string::convert::try_convert_to_ucs2(ucs2ch, it->second))
        {
            u2s += ucs2ch;
        }
        ++it;
...
#endif  // #ifndef GO_BOOST_STRING_CONVERT_CONVERT_HPP_INCLUDED
