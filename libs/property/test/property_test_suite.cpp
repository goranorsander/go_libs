...
class optional_camera
{
public:
    p::optional_scalar_property<int> width;
    p::optional_scalar_property<double> height;
    p::optional_scalar_property<std::string> name;
...
TEST(properties_test_suite, optional_scalar_properties)
{
    optional_camera c;
...
class ro_optional_camera
{
public:
    p::ro_optional_scalar_property<int> width;
    p::ro_optional_scalar_property<double> height;
    p::ro_optional_scalar_property<std::string> name;
...
TEST(properties_test_suite, ro_optional_scalar_properties)
{
    ro_optional_camera c;
    ...
    // Copy construction
    ro_optional_camera c2(c);
    EXPECT_EQ(std::string("camera"), c2.name());
}

// Test wo_optional_scalar_property
class wo_optional_camera
{
public:
    p::wo_optional_scalar_property<int> width;
    p::wo_optional_scalar_property<double> height;
    p::wo_optional_scalar_property<std::string> name;
...
TEST(properties_test_suite, wo_optional_scalar_properties)
{
    wo_optional_camera c;
...
// Test ro_property
class ro_fps_camera : public ro_camera
{
public:
...
// Test wo_property
class wo_fps_camera : public wo_camera
{
public:
...
class fps_atomic_camera : public atomic_camera
{
public:
    p::atomic_property<int> fps;
    ...
    fps_atomic_camera(const fps_atomic_camera& v)
        : atomic_camera(v)
        , fps(v.fps)
        , _d(v._d)
    {
    ...
    fps_atomic_camera& operator=(const fps_atomic_camera& v)
    {
        atomic_camera::operator=(v);
        fps = v.fps;
        _d = v._d;
        update_bindings();
    }
...
TEST(properties_test_suite, atomic_value_properties)
{
    fps_atomic_camera c;
...
class ro_fps_atomic_camera : public ro_atomic_camera
{
public:
    p::ro_atomic_property<int> fps;

    ro_fps_atomic_camera()
        : ro_atomic_camera()
        , fps(std::string("fps"))
        , _d()
    {
    ...
    ro_fps_atomic_camera(const ro_fps_atomic_camera& v)
        : ro_atomic_camera(v)
        , fps(v.fps)
        , _d(v._d)
    {
...
TEST(properties_test_suite, ro_atomic_value_properties)
{
    ro_fps_atomic_camera c;
...
class wo_fps_atomic_camera : public wo_atomic_camera
{
public:
    p::wo_atomic_property<int> fps;

    wo_fps_atomic_camera()
        : wo_atomic_camera()
        , fps(std::string("fps"))
        , _d()
    {
    ...
    wo_fps_atomic_camera(const wo_fps_atomic_camera& v)
        : wo_atomic_camera(v)
        , fps(v.fps)
        , _d(v._d)
    {
...
TEST(properties_test_suite, wo_atomic_value_properties)
{
    wo_fps_atomic_camera c;
