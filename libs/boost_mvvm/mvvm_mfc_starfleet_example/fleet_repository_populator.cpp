...
void add_colonial_fleet(const fleet_organization_model::ptr& good_guys, output_view* object_observer)
{
    ...
    ship_battlestar_galactica->equipment()->push_back(create<equipment_model>(object_observer, L"Armament", L"Primary battery", quantity_type(50ull)));
    ship_battlestar_galactica->equipment()->push_back(create<equipment_model>(object_observer, L"Armament", L"Dual point-defense battery", quantity_type(514ull)));
    ship_battlestar_galactica->equipment()->push_back(create<equipment_model>(object_observer, L"Armament", L"Missile tube", quantity_type(12ull)));
    ...
    ship_raptor_312->equipment()->push_back(create<equipment_model>(object_observer, L"Armament", L"Rear \"Toaster Slayer\" automatic cannon", quantity_type(1ull)));
    ship_raptor_312->equipment()->push_back(create<equipment_model>(object_observer, L"Defense", L"Electronic countermeasure", quantity_type(1ull)));
    ...
    ship_viper_8757->equipment()->push_back(create<equipment_model>(object_observer, L"Armament", L"Missile", quantity_type(6ull)));
...
void add_rebel_alliance(const fleet_organization_model::ptr& good_guys, output_view* object_observer)
{
    ...
    ship_millennium_falcon->equipment()->push_back(create<equipment_model>(object_observer, L"Armament", L"Concealed BlasTech Ax-108 \"Ground Buzzer\" surface-defense blaster cannon", quantity_type(1ull)));
    ship_millennium_falcon->equipment()->push_back(create<equipment_model>(object_observer, L"Armament", L"Arakyd ST2 concussion missile", quantity_type(8ull)));
    ship_millennium_falcon->equipment()->push_back(create<equipment_model>(object_observer, L"Defense", L"Carbanti 29L electromagnetic countermeasures package", quantity_type(1ull)));
    ship_millennium_falcon->equipment()->push_back(create<equipment_model>(object_observer, L"Defense", L"Carbanti signal-augmented sensor jammer", quantity_type(1ull)));
    ship_millennium_falcon->equipment()->push_back(create<equipment_model>(object_observer, L"Defense", L"Carbanti Whistler encryption module", quantity_type(1ull)));
    ...
    ship_xwing_red_two->equipment()->push_back(create<equipment_model>(object_observer, L"Armament", L"Krupx MG7 proton torpedo launcher", quantity_type(2ull)));
    ship_xwing_red_two->equipment()->push_back(create<equipment_model>(object_observer, L"Shielding", L"Chepat \"Defender\" deflector shield projector", quantity_type(1ull)));
    ship_xwing_red_two->equipment()->push_back(create<equipment_model>(object_observer, L"Shielding", L"Deflector shield generator", quantity_type(1ull)));
    ...
    ship_xwing_red_five->equipment()->push_back(create<equipment_model>(object_observer, L"Armament", L"Krupx MG7 proton torpedo launcher", quantity_type(2ull)));
    ship_xwing_red_five->equipment()->push_back(create<equipment_model>(object_observer, L"Shielding", L"Chepat \"Defender\" deflector shield projector", quantity_type(1ull)));
    ship_xwing_red_five->equipment()->push_back(create<equipment_model>(object_observer, L"Shielding", L"Deflector shield generator", quantity_type(1ull)));
...
void add_starfleet(const fleet_organization_model::ptr& good_guys, output_view* object_observer)
{
    ...
    ship_uss_enterprise->equipment()->push_back(create<equipment_model>(object_observer, L"Armament", L"Photon torpedo launcher", quantity_type(2ull)));
    ship_uss_enterprise->equipment()->push_back(create<equipment_model>(object_observer, L"Defense", L"Deflector shield ", quantity_type(1ull)));
...
void add_galactic_empire(const fleet_organization_model::ptr& evil_menace, output_view* object_observer)
{
    ...
    ship_death_star_i->equipment()->push_back(create<equipment_model>(object_observer, L"Armament", L"XX-9 heavy turbolaser", quantity_type(5000ull)));
    ship_death_star_i->equipment()->push_back(create<equipment_model>(object_observer, L"Armament", L"SB-920 laser cannon", quantity_type(2500ull)));
    ship_death_star_i->equipment()->push_back(create<equipment_model>(object_observer, L"Armament", L"MS-1 ion cannon", quantity_type(2500ull)));
    ship_death_star_i->equipment()->push_back(create<equipment_model>(object_observer, L"Armament", L"Modified Q7 tractor beam projector", quantity_type(768ull)));
    ship_death_star_i->equipment()->push_back(create<equipment_model>(object_observer, L"Complement", L"Starfighter", quantity_type(7000ull)));
    ship_death_star_i->equipment()->push_back(create<equipment_model>(object_observer, L"Complement", L"Strike cruiser", quantity_type(4ull)));
    ship_death_star_i->equipment()->push_back(create<equipment_model>(object_observer, L"Complement", L"Assault shuttle", quantity_type(3600ull)));
    ship_death_star_i->equipment()->push_back(create<equipment_model>(object_observer, L"Complement", L"AT-AT", quantity_type(1400ull)));
    ship_death_star_i->equipment()->push_back(create<equipment_model>(object_observer, L"Complement", L"AT-ST", quantity_type(1400ull)));
    ship_death_star_i->equipment()->push_back(create<equipment_model>(object_observer, L"Complement", L"Dropship", quantity_type(1860ull)));
    ...
    ship_executor->equipment()->push_back(create<equipment_model>(object_observer, L"Armament", L"Heavy turbolaser cannon", quantity_type(2000ull)));
    ship_executor->equipment()->push_back(create<equipment_model>(object_observer, L"Armament", L"Assault concussion missile", quantity_type(7500ull)));
    ship_executor->equipment()->push_back(create<equipment_model>(object_observer, L"Armament", L"Heavy ion cannon", quantity_type(250ull)));
    ship_executor->equipment()->push_back(create<equipment_model>(object_observer, L"Armament", L"Phylon Transport Q7 tractor beam projector", quantity_type(40ull)));
    ship_executor->equipment()->push_back(create<equipment_model>(object_observer, L"Armament", L"Point-defense laser cannon", quantity_type(500ull)));
    ship_executor->equipment()->push_back(create<equipment_model>(object_observer, L"Complement", L"TIE Series starfighter", quantity_type(144ull)));
    ship_executor->equipment()->push_back(create<equipment_model>(object_observer, L"Complement", L"AT-AT", quantity_type(30ull)));
    ship_executor->equipment()->push_back(create<equipment_model>(object_observer, L"Complement", L"AT-ST", quantity_type(40ull)));
...
void add_spaceball_fleet(const fleet_organization_model::ptr& evil_menace, output_view* object_observer)
{
    ...
    ship_spaceball_one->equipment()->push_back(create<equipment_model>(object_observer, L"Armament", L"Super tractor beam", quantity_type(1ull)));
    ship_spaceball_one->equipment()->push_back(create<equipment_model>(object_observer, L"Armament", L"Tractor beam", quantity_type(50ull)));
    ship_spaceball_one->equipment()->push_back(create<equipment_model>(object_observer, L"Armament", L"Spaceball X missile tube", quantity_type(60ull)));
    ship_spaceball_one->equipment()->push_back(create<equipment_model>(object_observer, L"Armament", L"Vaccu-suck atmospheric removal system", quantity_type(1ull)));
...
void add_the_borg(const fleet_organization_model::ptr& evil_menace, output_view* object_observer)
{
    ...
    ship_tactical_cube_138->equipment()->push_back(create<equipment_model>(object_observer, L"Defense", L"Hull armor", quantity_type(1ull)));
    ship_tactical_cube_138->equipment()->push_back(create<equipment_model>(object_observer, L"Defense", L"Shield", quantity_type(1ull)));
    ship_tactical_cube_138->equipment()->push_back(create<equipment_model>(object_observer, L"Defense", L"Multi-regenerative security field", quantity_type(1ull)));
