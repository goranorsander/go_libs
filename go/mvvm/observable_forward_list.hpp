...
public:
    ...
    using container_type = typename std::forward_list<T>;
    using this_type = basic_observable_forward_list<T, S, L>;
...
public:
    ...
    using lockable_type = L;
    using container_type = typename std::forward_list<T>;
    using this_type = observable_forward_list<T, L>;
    using ptr = typename std::shared_ptr<this_type>;
    using wptr = typename std::weak_ptr<this_type>;
...
public:
    ...
    using lockable_type = L;
    using container_type = typename std::forward_list<T>;
    using this_type = wobservable_forward_list<T>;
    using ptr = typename std::shared_ptr<this_type>;
    using wptr = typename std::weak_ptr<this_type>;
