...
const char* iso_8859_1_reduced_to_ascii_non_strict_from_hex_codes =
    "\x20\x21\x22\x23\x24\x25\x26\x27\x28\x29\x2A\x2B\x2C\x2D\x2E\x2F" \
    "\x30\x31\x32\x33\x34\x35\x36\x37\x38\x39\x3A\x3B\x3C\x3D\x3E\x3F" \
    "\x40\x41\x42\x43\x44\x45\x46\x47\x48\x49\x4A\x4B\x4C\x4D\x4E\x4F" \
    "\x50\x51\x52\x53\x54\x55\x56\x57\x58\x59\x5A\x5B\x5C\x5D\x5E\x5F" \
    "\x60\x61\x62\x63\x64\x65\x66\x67\x68\x69\x6A\x6B\x6C\x6D\x6E\x6F" \
    "\x70\x71\x72\x73\x74\x75\x76\x77\x78\x79\x7A\x7B\x7C\x7D\x7E" \
    "\x20\x21\x63\x50\x6F\x59\x7C\x70\x22\x28\x63\x29\x61\x3C\x3C\x2D\x28\x52\x29\x2D" \
    "\x67\x2B\x2F\x2D\x5E\x32\x5E\x33\x27\x75\x39\x2A\x2E\x5E\x31\x5E\x30\x3E\x3E\x31\x2F\x34\x31\x2F\x32\x33\x2F\x34\x3F" \
    "\x41\x41\x41\x41\x41\x41\x41\x45\x43\x45\x45\x45\x45\x49\x49\x49\x49" \
...
const char* windows_1252_reduced_to_ascii_non_strict_from_hex_codes =
    ...
    "\x60\x61\x62\x63\x64\x65\x66\x67\x68\x69\x6A\x6B\x6C\x6D\x6E\x6F" \
    "\x70\x71\x72\x73\x74\x75\x76\x77\x78\x79\x7A\x7B\x7C\x7D\x7E" \
    "\x43\x27\x66\x22\x2E\x2E\x2E\x2B\x2B\x5E\x6F\x2F\x6F\x6F\x53\x3C\x45\x5A" \
    "\x27\x27\x22\x22\x2A\x2D\x2D\x7E\x28\x54\x4D\x29\x73\x3E\x65\x7A\x59" \
    "\x20\x21\x63\x50\x6F\x59\x7C\x70\x22\x28\x63\x29\x61\x3C\x3C\x2D\x28\x52\x29\x2D" \
    "\x67\x2B\x2F\x2D\x5E\x32\x5E\x33\x27\x75\x39\x2A\x2E\x5E\x31\x5E\x30\x3E\x3E\x31\x2F\x34\x31\x2F\x32\x33\x2F\x34\x3F" \
    "\x41\x41\x41\x41\x41\x41\x41\x45\x43\x45\x45\x45\x45\x49\x49\x49\x49" \
    "\x44\x4E\x4F\x4F\x4F\x4F\x4F\x78\x4F\x55\x55\x55\x55\x59\x50\x42" \
...
const wchar_t iso_8859_1_reduced_to_ascii_non_strict_from_hex_codes[] =
    { 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x2A, 0x2B, 0x2C, 0x2D, 0x2E, 0x2F
    , 0x30, 0x31, 0x32, 0x0033, 0x34, 0x0035, 
...
const wchar_t windows_1252_reduced_to_ascii_non_strict_from_hex_codes[] =
    ...
    , 
...
const u::char2_t iso_8859_1_reduced_to_ascii_non_strict_from_hex_codes[] =
    { 0x0020, 0x0021, 0x0022, 0x0023, 0x0024, 0x0025, 0x0026, 0x0027, 0x0028, 0x0029, 0x002A, 0x002B, 0x002C, 0x002D, 0x002E, 0x002F
    ...
    , 0x0060, 0x0061, 0x0062, 0x0063, 0x0064, 0x0065, 0x0066, 0x0067, 0x0068, 0x0069, 0x006A, 0x006B, 0x006C, 0x006D, 0x006E, 0x006F
    , 0x0070, 0x0071, 0x0072, 0x0073, 0x0074, 0x0075, 0x0076, 0x0077, 0x0078, 0x0079, 0x007A, 0x007B, 0x007C, 0x007D, 0x007E
    , 0x0020, 0x0021, 0x0063, 0x0050, 0x006F, 0x0059, 0x007C, 0x0070, 0x0022, 0x0028, 0x0063, 0x0029, 0x0061, 0x003C, 0x003C, 0x002D, 0x0028, 0x0052, 0x0029, 0x002D
    , 0x0067, 0x002B, 0x002F, 0x002D, 0x005E, 0x0032, 0x005E, 0x0033, 0x0027, 0x0075, 0x0039, 0x002A, 0x002E, 0x005E, 0x0031, 0x005E, 0x0030, 0x003E, 0x003E, 0x0031, 0x002F, 0x0034, 0x0031, 0x002F, 0x0032, 0x0033, 0x002F, 0x0034, 0x003F
    , 0x0041, 0x0041, 0x0041, 0x0041, 0x0041, 0x0041, 0x0041, 0x0045, 0x0043, 0x0045, 0x0045, 0x0045, 0x0045, 0x0049, 0x0049, 0x0049, 0x0049
    , 0x0044, 0x004E, 0x004F, 0x004F, 0x004F, 0x004F, 0x004F, 0x0078, 0x004F, 0x0055, 0x0055, 0x0055, 0x0055, 0x0059, 0x0050, 0x0042
...
const u::char2_t windows_1252_reduced_to_ascii_non_strict_from_hex_codes[] =
    ...
    , 0x0060, 0x0061, 0x0062, 0x0063, 0x0064, 0x0065, 0x0066, 0x0067, 0x0068, 0x0069, 0x006A, 0x006B, 0x006C, 0x006D, 0x006E, 0x006F
    , 0x0070, 0x0071, 0x0072, 0x0073, 0x0074, 0x0075, 0x0076, 0x0077, 0x0078, 0x0079, 0x007A, 0x007B, 0x007C, 0x007D, 0x007E
    , 0x0043, 0x0027, 0x0066, 0x0022, 0x002E, 0x002E, 0x002E, 0x002B, 0x002B, 0x005E, 0x006F, 0x002F, 0x006F, 0x006F, 0x0053, 0x003C, 0x0045, 0x005A
    , 0x0027, 0x0027, 0x0022, 0x0022, 0x002A, 0x002D, 0x002D, 0x007E, 0x0028, 0x0054, 0x004D, 0x0029, 0x0073, 0x003E, 0x0065, 0x007A, 0x0059
    , 0x0020, 0x0021, 0x0063, 0x0050, 0x006F, 0x0059, 0x007C, 0x0070, 0x0022, 0x0028, 0x0063, 0x0029, 0x0061, 0x003C, 0x003C, 0x002D, 0x0028, 0x0052, 0x0029, 0x002D
    , 0x0067, 0x002B, 0x002F, 0x002D, 0x005E, 0x0032, 0x005E, 0x0033, 0x0027, 0x0075, 0x0039, 0x002A, 0x002E, 0x005E, 0x0031, 0x005E, 0x0030, 0x003E, 0x003E, 0x0031, 0x002F, 0x0034, 0x0031, 0x002F, 0x0032, 0x0033, 0x002F, 0x0034, 0x003F
    , 0x0041, 0x0041, 0x0041, 0x0041, 0x0041, 0x0041, 0x0041, 0x0045, 0x0043, 0x0045, 0x0045, 0x0045, 0x0045, 0x0049, 0x0049, 0x0049, 0x0049
    , 0x0044, 0x004E, 0x004F, 0x004F, 0x004F, 0x004F, 0x004F, 0x0078, 0x004F, 0x0055, 0x0055, 0x0055, 0x0055, 0x0059, 0x0050, 0x0042
...
const u::char8_t* windows_1252_printable_characters_from_hex_codes = reinterpret_cast<const u::char8_t*>(
    ...
    "\xC3\xB0\xC3\xB1\xC3\xB2\xC3\xB3\xC3\xB4\xC3\xB5\xC3\xB6\xC3\xB7\xC3\xB8\xC3\xB9\xC3\xBA\xC3\xBB\xC3\xBC\xC3\xBD\xC3\xBE\xC3\xBF");
const std::size_t windows_1252_printable_characters_count = 218;
const std::size_t windows_1252_printable_characters_size = 342;
...
const char16_t iso_8859_1_reduced_to_ascii_non_strict_from_hex_codes[] =
    { 0x0020, 0x0021, 0x0022, 0x0023, 0x0024, 0x0025, 0x0026, 0x0027, 0x0028, 0x0029, 0x002A, 0x002B, 0x002C, 0x002D, 0x002E, 0x002F
    , 0x0030, 0x0031, 0x0032, 0x000033, 0x0034, 0x000035, 0x0036, 0x0037, 0x0038, 0x0039, 0x003A, 0x003B, 0x003C, 0x003D, 0x003E, 0x003F
    , 0x0040, 0x0041, 0x0042, 0x0043, 0x0044, 0x0045, 0x0046, 0x0047, 0x0048, 0x0049, 0x004A, 0x004B, 0x004C, 0x004D, 0x004E, 0x004F
    , 0x0050, 0x0051, 0x0052, 0x0053, 0x0054, 0x0055, 0x0056, 0x0057, 0x0058, 0x0059, 0x005A, 0x005B, 0x005C, 0x005D, 0x005E, 0x005F
...
const char32_t iso_8859_1_reduced_to_ascii_non_strict_from_hex_codes[] =
    { 0x00000020, 0x00000021, 0x00000022, 0x00000023, 0x00000024, 0x00000025, 0x00000026, 0x00000027, 0x00000028, 0x00000029, 0x0000002A, 0x0000002B, 0x0000002C, 0x0000002D, 0x0000002E, 0x0000002F
    ...
    , 0x00000060, 0x00000061, 0x00000062, 0x00000063, 0x00000064, 0x00000065, 0x00000066, 0x00000067, 0x00000068, 0x00000069, 0x0000006A, 0x0000006B, 0x0000006C, 0x0000006D, 0x0000006E, 0x0000006F
    , 0x00000070, 0x00000071, 0x00000072, 0x00000073, 0x00000074, 0x00000075, 0x00000076, 0x00000077, 0x00000078, 0x00000079, 0x0000007A, 0x0000007B, 0x0000007C, 0x0000007D, 0x0000007E
    , 0x00000020, 0x00000021, 0x00000063, 0x00000050, 0x0000006F, 0x00000059, 0x0000007C, 0x00000070, 0x00000022, 0x00000028, 0x00000063, 0x00000029, 0x00000061, 0x0000003C, 0x0000003C, 0x0000002D, 0x00000028, 0x00000052, 0x00000029, 0x0000002D
    , 0x00000067, 0x0000002B, 0x0000002F, 0x0000002D, 0x0000005E, 0x00000032, 0x0000005E, 0x00000033, 0x00000027, 0x00000075, 0x00000039, 0x0000002A, 0x0000002E, 0x0000005E, 0x00000031, 0x0000005E, 0x00000030, 0x0000003E, 0x0000003E, 0x00000031, 0x0000002F, 0x00000034, 0x00000031, 0x0000002F, 0x00000032, 0x00000033, 0x0000002F, 0x00000034, 0x0000003F
    , 0x00000041, 0x00000041, 0x00000041, 0x00000041, 0x00000041, 0x00000041, 0x00000041, 0x00000045, 0x00000043, 0x00000045, 0x00000045, 0x00000045, 0x00000045, 0x00000049, 0x00000049, 0x00000049, 0x00000049
    , 0x00000044, 0x0000004E, 0x0000004F, 0x0000004F, 0x0000004F, 0x0000004F, 0x0000004F, 0x00000078, 0x0000004F, 0x00000055, 0x00000055, 0x00000055, 0x00000055, 0x00000059, 0x00000050, 0x00000042
...
const char32_t windows_1252_reduced_to_ascii_non_strict_from_hex_codes[] =
    ...
    , 0x00000060, 0x00000061, 0x00000062, 0x00000063, 0x00000064, 0x00000065, 0x00000066, 0x00000067, 0x00000068, 0x00000069, 0x0000006A, 0x0000006B, 0x0000006C, 0x0000006D, 0x0000006E, 0x0000006F
    , 0x00000070, 0x00000071, 0x00000072, 0x00000073, 0x00000074, 0x00000075, 0x00000076, 0x00000077, 0x00000078, 0x00000079, 0x0000007A, 0x0000007B, 0x0000007C, 0x0000007D, 0x0000007E
    , 0x00000043, 0x00000027, 0x00000066, 0x00000022, 0x0000002E, 0x0000002E, 0x0000002E, 0x0000002B, 0x0000002B, 0x0000005E, 0x0000006F, 0x0000002F, 0x0000006F, 0x0000006F, 0x00000053, 0x0000003C, 0x00000045, 0x0000005A
    , 0x00000027, 0x00000027, 0x00000022, 0x00000022, 0x0000002A, 0x0000002D, 0x0000002D, 0x0000007E, 0x00000028, 0x00000054, 0x0000004D, 0x00000029, 0x00000073, 0x0000003E, 0x00000065, 0x0000007A, 0x00000059
    , 0x00000020, 0x00000021, 0x00000063, 0x00000050, 0x0000006F, 0x00000059, 0x0000007C, 0x00000070, 0x00000022, 0x00000028, 0x00000063, 0x00000029, 0x00000061, 0x0000003C, 0x0000003C, 0x0000002D, 0x00000028, 0x00000052, 0x00000029, 0x0000002D
    , 0x00000067, 0x0000002B, 0x0000002F, 0x0000002D, 0x0000005E, 0x00000032, 0x0000005E, 0x00000033, 0x00000027, 0x00000075, 0x00000039, 0x0000002A, 0x0000002E, 0x0000005E, 0x00000031, 0x0000005E, 0x00000030, 0x0000003E, 0x0000003E, 0x00000031, 0x0000002F, 0x00000034, 0x00000031, 0x0000002F, 0x00000032, 0x00000033, 0x0000002F, 0x00000034, 0x0000003F
    , 0x00000041, 0x00000041, 0x00000041, 0x00000041, 0x00000041, 0x00000041, 0x00000041, 0x00000045, 0x00000043, 0x00000045, 0x00000045, 0x00000045, 0x00000045, 0x00000049, 0x00000049, 0x00000049, 0x00000049
    , 0x00000044, 0x0000004E, 0x0000004F, 0x0000004F, 0x0000004F, 0x0000004F, 0x0000004F, 0x00000078, 0x0000004F, 0x00000055, 0x00000055, 0x00000055, 0x00000055, 0x00000059, 0x00000050, 0x00000042
...
TEST(std_ascii_test_suite, test_multibyte_character_count)
{
...
TEST(std_ascii_test_suite, test_system_wide_character_count)
{
...
TEST(std_ascii_test_suite, test_ucs_2_character_count)
{
...
TEST(std_ascii_test_suite, test_utf_8_character_count)
{
...
TEST(std_ascii_test_suite, test_utf_16_character_count)
{
...
TEST(std_ascii_test_suite, test_utf_32_character_count)
{
...
TEST(std_ascii_test_suite, test_wchar_t_is_7_bit_ascii_character)
{
    ...
    }
    {
        ...
        while (c < 0)
        {
            const bool is_7_bit_ascii = us::is_7_bit_ascii_character(static_cast<wchar_t>(c));
            EXPECT_EQ(is_7_bit_ascii, false);
            ++c;
        }
    }
...
TEST(std_ascii_test_suite, test_char16_t_is_7_bit_ascii_character)
{
    ...
    }
    {
        ...
        while (c < 0)
        {
            const bool is_7_bit_ascii = us::is_7_bit_ascii_character(static_cast<char16_t>(c));
            EXPECT_EQ(is_7_bit_ascii, false);
            ++c;
        }
    }
...
TEST(std_ascii_test_suite, test_char32_t_is_7_bit_ascii_character)
{
    ...
    }
    {
        ...
        while (c < 0)
        {
            const bool is_7_bit_ascii = us::is_7_bit_ascii_character(static_cast<char32_t>(c));
            EXPECT_EQ(is_7_bit_ascii, false);
            ++c;
        }
    }
...
TEST(std_ascii_test_suite, test_multibyte_reduce_iso_8859_1_to_7_bit_ascii_characters)
{
    const std::string ascii_printable_characters(multibyte::ascii_printable_characters_from_hex_codes);
    const std::string iso_8859_1_printable_characters(multibyte::iso_8859_1_printable_characters_from_hex_codes);
...
TEST(std_ascii_test_suite, test_system_wide_reduce_iso_8859_1_to_7_bit_ascii_characters)
{
    const std::wstring ascii_printable_characters(system_wide::ascii_printable_characters_from_hex_codes);
    const std::wstring iso_8859_1_printable_characters(system_wide::iso_8859_1_printable_characters_from_hex_codes);
...
TEST(std_ascii_test_suite, test_ucs_2_reduce_iso_8859_1_to_7_bit_ascii_characters)
{
    const u::u2string ascii_printable_characters(ucs_2::ascii_printable_characters_from_hex_codes);
    const u::u2string iso_8859_1_printable_characters(ucs_2::iso_8859_1_printable_characters_from_hex_codes);
...
TEST(std_ascii_test_suite, test_utf_8_reduce_iso_8859_1_to_7_bit_ascii_characters)
{
    const u::u8string ascii_printable_characters(utf_8::ascii_printable_characters_from_hex_codes);
    const u::u8string iso_8859_1_printable_characters(utf_8::iso_8859_1_printable_characters_from_hex_codes);
...
TEST(std_ascii_test_suite, test_utf_16_reduce_iso_8859_1_to_7_bit_ascii_characters)
{
    const std::u16string ascii_printable_characters(utf_16::ascii_printable_characters_from_hex_codes);
    const std::u16string iso_8859_1_printable_characters(utf_16::iso_8859_1_printable_characters_from_hex_codes);
...
TEST(std_ascii_test_suite, test_utf_32_reduce_iso_8859_1_to_7_bit_ascii_characters)
{
    const std::u32string ascii_printable_characters(utf_32::ascii_printable_characters_from_hex_codes);
    const std::u32string iso_8859_1_printable_characters(utf_32::iso_8859_1_printable_characters_from_hex_codes);
...
TEST(std_ascii_test_suite, test_multibyte_reduce_iso_8859_1_to_7_bit_ascii_non_strict_characters)
{
    const std::string ascii_printable_characters(multibyte::iso_8859_1_reduced_to_ascii_non_strict_from_hex_codes);
    const std::string iso_8859_1_printable_characters(multibyte::iso_8859_1_printable_characters_from_hex_codes);
    const std::string iso_8859_1_reduced_to_7_bit_ascii = us::reduce_iso_8859_1_to_7_bit_ascii_copy(iso_8859_1_printable_characters, false);
    EXPECT_EQ(ascii_printable_characters, iso_8859_1_reduced_to_7_bit_ascii);
}

TEST(std_ascii_test_suite, test_system_wide_reduce_iso_8859_1_to_7_bit_ascii_non_strict_characters)
{
    const std::wstring ascii_printable_characters(system_wide::iso_8859_1_reduced_to_ascii_non_strict_from_hex_codes);
    const std::wstring iso_8859_1_printable_characters(system_wide::iso_8859_1_printable_characters_from_hex_codes);
    const std::wstring iso_8859_1_reduced_to_7_bit_ascii = us::reduce_iso_8859_1_to_7_bit_ascii_copy(iso_8859_1_printable_characters, false);
    EXPECT_EQ(ascii_printable_characters, iso_8859_1_reduced_to_7_bit_ascii);
}

TEST(std_ascii_test_suite, test_ucs_2_reduce_iso_8859_1_to_7_bit_ascii_non_strict_characters)
{
    const u::u2string ascii_printable_characters(ucs_2::iso_8859_1_reduced_to_ascii_non_strict_from_hex_codes);
    const u::u2string iso_8859_1_printable_characters(ucs_2::iso_8859_1_printable_characters_from_hex_codes);
    const u::u2string iso_8859_1_reduced_to_7_bit_ascii = us::reduce_iso_8859_1_to_7_bit_ascii_copy(iso_8859_1_printable_characters, false);
    EXPECT_EQ(ascii_printable_characters, iso_8859_1_reduced_to_7_bit_ascii);
}

TEST(std_ascii_test_suite, test_utf_8_reduce_iso_8859_1_to_7_bit_ascii_non_strict_characters)
{
    const u::u8string ascii_printable_characters(utf_8::iso_8859_1_reduced_to_ascii_non_strict_from_hex_codes);
    const u::u8string iso_8859_1_printable_characters(utf_8::iso_8859_1_printable_characters_from_hex_codes);
    const u::u8string iso_8859_1_reduced_to_7_bit_ascii = us::reduce_iso_8859_1_to_7_bit_ascii_copy(iso_8859_1_printable_characters, false);
    EXPECT_EQ(ascii_printable_characters, iso_8859_1_reduced_to_7_bit_ascii);
}

TEST(std_ascii_test_suite, test_utf_16_reduce_iso_8859_1_to_7_bit_ascii_non_strict_characters)
{
    const std::u16string ascii_printable_characters(utf_16::iso_8859_1_reduced_to_ascii_non_strict_from_hex_codes);
    const std::u16string iso_8859_1_printable_characters(utf_16::iso_8859_1_printable_characters_from_hex_codes);
    const std::u16string iso_8859_1_reduced_to_7_bit_ascii = us::reduce_iso_8859_1_to_7_bit_ascii_copy(iso_8859_1_printable_characters, false);
    EXPECT_EQ(ascii_printable_characters, iso_8859_1_reduced_to_7_bit_ascii);
}

TEST(std_ascii_test_suite, test_utf_32_reduce_iso_8859_1_to_7_bit_ascii_non_strict_characters)
{
    const std::u32string ascii_printable_characters(utf_32::iso_8859_1_reduced_to_ascii_non_strict_from_hex_codes);
    const std::u32string iso_8859_1_printable_characters(utf_32::iso_8859_1_printable_characters_from_hex_codes);
    const std::u32string iso_8859_1_reduced_to_7_bit_ascii = us::reduce_iso_8859_1_to_7_bit_ascii_copy(iso_8859_1_printable_characters, false);
    EXPECT_EQ(ascii_printable_characters, iso_8859_1_reduced_to_7_bit_ascii);
}

TEST(std_ascii_test_suite, test_multibyte_reduce_windows_1252_to_7_bit_ascii_characters)
{
    const std::string ascii_printable_characters(multibyte::ascii_printable_characters_from_hex_codes);
...
TEST(std_ascii_test_suite, test_system_wide_reduce_windows_1252_to_7_bit_ascii_characters)
{
    const std::wstring ascii_printable_characters(system_wide::ascii_printable_characters_from_hex_codes);
...
TEST(std_ascii_test_suite, test_ucs_2_reduce_windows_1252_to_7_bit_ascii_characters)
{
    const u::u2string ascii_printable_characters(ucs_2::ascii_printable_characters_from_hex_codes);
...
TEST(std_ascii_test_suite, test_utf_8_reduce_windows_1252_to_7_bit_ascii_characters)
{
    const u::u8string ascii_printable_characters(utf_8::ascii_printable_characters_from_hex_codes);
...
TEST(std_ascii_test_suite, test_utf_16_reduce_windows_1252_to_7_bit_ascii_characters)
{
    const std::u16string ascii_printable_characters(utf_16::ascii_printable_characters_from_hex_codes);
...
TEST(std_ascii_test_suite, test_utf_32_reduce_windows_1252_to_7_bit_ascii_characters)
{
    const std::u32string ascii_printable_characters(utf_32::ascii_printable_characters_from_hex_codes);
...
TEST(std_ascii_test_suite, test_multibyte_reduce_windows_1252_to_7_bit_ascii_non_strict_characters)
{
    const std::string ascii_printable_characters(multibyte::windows_1252_reduced_to_ascii_non_strict_from_hex_codes);
    const std::string windows_1252_printable_characters(multibyte::windows_1252_printable_characters_from_hex_codes);
    const std::string windows_1252_reduced_to_7_bit_ascii = us::reduce_windows_1252_to_7_bit_ascii_copy(windows_1252_printable_characters, false);
    EXPECT_EQ(ascii_printable_characters, windows_1252_reduced_to_7_bit_ascii);
}

TEST(std_ascii_test_suite, test_system_wide_reduce_windows_1252_to_7_bit_ascii_non_strict_characters)
{
    const std::wstring ascii_printable_characters(system_wide::windows_1252_reduced_to_ascii_non_strict_from_hex_codes);
    const std::wstring windows_1252_printable_characters(system_wide::windows_1252_printable_characters_from_hex_codes);
    const std::wstring windows_1252_reduced_to_7_bit_ascii = us::reduce_windows_1252_to_7_bit_ascii_copy(windows_1252_printable_characters, false);
    EXPECT_EQ(ascii_printable_characters, windows_1252_reduced_to_7_bit_ascii);
}

TEST(std_ascii_test_suite, test_ucs_2_reduce_windows_1252_to_7_bit_ascii_non_strict_characters)
{
    const u::u2string ascii_printable_characters(ucs_2::windows_1252_reduced_to_ascii_non_strict_from_hex_codes);
    const u::u2string windows_1252_printable_characters(ucs_2::windows_1252_printable_characters_from_hex_codes);
    const u::u2string windows_1252_reduced_to_7_bit_ascii = us::reduce_windows_1252_to_7_bit_ascii_copy(windows_1252_printable_characters, false);
    EXPECT_EQ(ascii_printable_characters, windows_1252_reduced_to_7_bit_ascii);
}

TEST(std_ascii_test_suite, test_utf_8_reduce_windows_1252_to_7_bit_ascii_non_strict_characters)
{
    const u::u8string ascii_printable_characters(utf_8::windows_1252_reduced_to_ascii_non_strict_from_hex_codes);
    const u::u8string windows_1252_printable_characters(utf_8::windows_1252_printable_characters_from_hex_codes);
...
TEST(std_ascii_test_suite, test_utf_16_reduce_windows_1252_to_7_bit_ascii_non_strict_characters)
{
    const std::u16string ascii_printable_characters(utf_16::windows_1252_reduced_to_ascii_non_strict_from_hex_codes);
    const std::u16string windows_1252_printable_characters(utf_16::windows_1252_printable_characters_from_hex_codes);
    const std::u16string windows_1252_reduced_to_7_bit_ascii = us::reduce_windows_1252_to_7_bit_ascii_copy(windows_1252_printable_characters, false);
    EXPECT_EQ(ascii_printable_characters, windows_1252_reduced_to_7_bit_ascii);
}

TEST(std_ascii_test_suite, test_utf_32_reduce_windows_1252_to_7_bit_ascii_non_strict_characters)
{
    const std::u32string ascii_printable_characters(utf_32::windows_1252_reduced_to_ascii_non_strict_from_hex_codes);
    const std::u32string windows_1252_printable_characters(utf_32::windows_1252_printable_characters_from_hex_codes);
    const std::u32string windows_1252_reduced_to_7_bit_ascii = us::reduce_windows_1252_to_7_bit_ascii_copy(windows_1252_printable_characters, false);
    EXPECT_EQ(ascii_printable_characters, windows_1252_reduced_to_7_bit_ascii);
}
