...
TEST(boost_wobservable_deque_test_suite, test_assign_fill)
{
    ...
    m::wobservable_deque<int>::ptr d2 = m::wobservable_deque<int>::create();
    deque_observer<int> o;
    ...
    m::wobservable_deque<int>::iterator it = d1->begin() + 1;
...
TEST(boost_wobservable_deque_test_suite, test_insert_range)
{
    ...
    m::wobservable_deque<int>::iterator it = d2->begin();
