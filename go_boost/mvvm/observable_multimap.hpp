#ifndef GO_BOOST_MVVM_OBSERVABLE_MULTIMAP_HPP_INCLUDED
#define GO_BOOST_MVVM_OBSERVABLE_MULTIMAP_HPP_INCLUDED
...
template<class K, class T, class S> class basic_observable_multimap
    : public basic_observable_ordered_associative_container<S, boost::container::multimap<K, T>>
{
public:
    typedef S string_type;
    typedef typename boost::container::multimap<K, T> container_type;
    typedef basic_observable_multimap<K, T, S> this_type;
...
public:
    virtual ~basic_observable_multimap() GO_BOOST_DEFAULT_DESTRUCTOR
...
public:
    virtual ~observable_multimap() GO_BOOST_DEFAULT_DESTRUCTOR
...
public:
    virtual ~wobservable_multimap() GO_BOOST_DEFAULT_DESTRUCTOR
...
#endif  // #ifndef GO_BOOST_MVVM_OBSERVABLE_MULTIMAP_HPP_INCLUDED
