...
TEST(boost_wobservable_unordered_multimap_test_suite, test_insert_single_element)
{
    ...
    int count = 0;
    int sum = 0;
    for(const m::wobservable_unordered_multimap<int, int>::value_type& i : *m)
    {
        sum += i.second;
        ++count;
    }
...
TEST(boost_wobservable_unordered_multimap_test_suite, test_swap)
{
    ...
    int count = 0;
    int sum = 0;
    for(const m::wobservable_unordered_multimap<int, int>::value_type& i : *m1)
    {
        sum += i.second;
        ++count;
    }
    ...
    count = 0;
    sum = 0;
    for(const m::wobservable_unordered_multimap<int, int>::value_type& i : *m2)
    {
        sum += i.second;
        ++count;
    }
