...
class basic_observable_multiset
    : public basic_observable_ordered_associative_container<S, std::multiset<K>, L>
{
public:
    using string_type = S;
    using lockable_type = L;
    using container_type = typename std::multiset<K>;
    using this_type = basic_observable_multiset<K, S, L>;
...
public:
    ...
    using lockable_type = L;
    using container_type = typename std::multiset<K>;
    using this_type = observable_multiset<K, L>;
    using ptr = typename std::shared_ptr<this_type>;
    using wptr = typename std::weak_ptr<this_type>;
...
public:
    ...
    using lockable_type = L;
    using container_type = typename std::multiset<K>;
    using this_type = wobservable_multiset<K, L>;
    using ptr = typename std::shared_ptr<this_type>;
    using wptr = typename std::weak_ptr<this_type>;
