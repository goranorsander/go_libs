//
//  placebo_mutex_nameless_property_test_suite.cpp
//
...
TEST(std_nameless_property_placebo_mutex_test_suite, cpp11_not_supported) {}
#else
...
{
public:
    np::value_property<int, u::placebo_mutex> crew_complement;
    np::value_property<double, u::placebo_mutex> max_speed;
    np::value_property<std::string, u::placebo_mutex> name;
...
TEST(std_nameless_property_placebo_mutex_test_suite, value_properties)
{
    spaceship s;
...
{
public:
    roap::value_property<int, u::placebo_mutex> crew_complement;
    roap::value_property<double, u::placebo_mutex> max_speed;
    roap::value_property<std::string, u::placebo_mutex> name;
...
TEST(std_nameless_property_placebo_mutex_test_suite, read_only_value_properties)
{
...
{
public:
    woap::value_property<int, u::placebo_mutex> crew_complement;
    woap::value_property<double, u::placebo_mutex> max_speed;
    woap::value_property<std::string, u::placebo_mutex> name;
...
TEST(std_nameless_property_placebo_mutex_test_suite, write_only_value_properties)
{
...
{
public:
    np::reference_property<int, u::placebo_mutex> crew_complement;
    np::reference_property<double, u::placebo_mutex> max_speed;
    np::reference_property<std::string, u::placebo_mutex> name;
...
TEST(std_nameless_property_placebo_mutex_test_suite, reference_properties)
{
...
{
public:
    roap::reference_property<int, u::placebo_mutex> crew_complement;
    roap::reference_property<double, u::placebo_mutex> max_speed;
    roap::reference_property<std::string, u::placebo_mutex> name;
...
TEST(std_nameless_property_placebo_mutex_test_suite, read_only_reference_properties)
{
    int store_crew_complement = 1012;
    double store_max_speed = 9.8;
    std::string store_name("USS Enterprise (NCC-1701-D)");
...
{
public:
    woap::reference_property<int, u::placebo_mutex> crew_complement;
    woap::reference_property<double, u::placebo_mutex> max_speed;
    woap::reference_property<std::string, u::placebo_mutex> name;
...
TEST(std_nameless_property_placebo_mutex_test_suite, write_only_reference_properties)
{
    ...
    EXPECT_TRUE(s.max_speed.empty() == false);
    EXPECT_TRUE(s.name.empty() == false);
    EXPECT_EQ(store_crew_complement, s_cc_2);
    EXPECT_EQ(store_max_speed, s_ms_2);
    EXPECT_EQ(store_name, s_n_2);
    ...
    EXPECT_TRUE(s.max_speed.empty() == false);
    EXPECT_TRUE(s.name.empty() == false);
    EXPECT_EQ(store_crew_complement, s_cc_3);
    EXPECT_EQ(store_max_speed, s_ms_3);
    EXPECT_EQ(store_name, s_n_3);
    ...
    EXPECT_TRUE(s.max_speed.empty() == false);
    EXPECT_TRUE(s.name.empty() == false);
    EXPECT_EQ(store_crew_complement, s_cc_4);
    EXPECT_EQ(store_max_speed, s_ms_4);
    EXPECT_EQ(store_name, s_n_4);
...
{
public:
    np::property<int, u::placebo_mutex> phaser_arrays;
...
TEST(std_nameless_property_placebo_mutex_test_suite, proxy_properties)
{
    armed_spaceship s;
...
{
public:
    roap::property<int, u::placebo_mutex> phaser_arrays;
...
TEST(std_nameless_property_placebo_mutex_test_suite, read_only_proxy_properties)
{
...
{
public:
    woap::property<int, u::placebo_mutex> phaser_arrays;
...
TEST(std_nameless_property_placebo_mutex_test_suite, write_only_proxy_properties)
{
