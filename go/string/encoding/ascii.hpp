#ifndef GO_STRING_ENCODING_ASCII_HPP_INCLUDED
#define GO_STRING_ENCODING_ASCII_HPP_INCLUDED
...
inline u8string& reduce_to_7_bit_ascii(u8string& s)
{
    ...
    while (it != s.end())
    {
        ...
        {
            it = go::utility::iterator::erase(s, it, 6);
        }
    }
    return s;
}
...
#endif  // #ifndef GO_STRING_ENCODING_ASCII_HPP_INCLUDED
