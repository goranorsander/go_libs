...
{ 0x0020, 0x0021, 0x0022, 0x0023, 0x0024, 0x0025, 0x0026, 0x0027, 0x0028, 0x0029, 0x002A, 0x002B, 0x002C, 0x002D, 0x002E, 0x002F
, 0x0030, 0x0031, 0x0032, 0x000033, 0x0034, 0x000035, 0x0036, 0x0037, 0x0038, 0x0039, 0x003A, 0x003B, 0x003C, 0x003D, 0x003E, 0x003F
, 0x0040, 0x0041, 0x0042, 0x0043, 0x0044, 0x0045, 0x0046, 0x0047, 0x0048, 0x0049, 0x004A, 0x004B, 0x004C, 0x004D, 0x004E, 0x004F
, 0x0050, 0x0051, 0x0052, 0x0053, 0x0054, 0x0055, 0x0056, 0x0057, 0x0058, 0x0059, 0x005A, 0x005B, 0x005C, 0x005D, 0x005E, 0x005F
, 0x0060, 0x0061, 0x0062, 0x0063, 0x0064, 0x0065, 0x0066, 0x0067, 0x0068, 0x0069, 0x006A, 0x006B, 0x006C, 0x006D, 0x006E, 0x006F
, 0x0070, 0x0071, 0x0072, 0x0073, 0x0074, 0x0075, 0x0076, 0x0077, 0x0078, 0x0079, 0x007A, 0x007B, 0x007C, 0x007D, 0x007E
, 0x0080, 0x0082, 0x0083, 0x0084, 0x0085, 0x0086, 0x0087, 0x0088, 0x0089, 0x008A, 0x008B, 0x008C, 0x008E
, 0x0091, 0x0092, 0x0093, 0x0094, 0x0095, 0x0096, 0x0097, 0x0098, 0x0099, 0x009A, 0x009B, 0x009C, 0x009E, 0x009F
...
const u::char8_t* windows_1252_printable_characters_from_hex_codes = reinterpret_cast<const u::char8_t*>(
    ...
    "\x60\x61\x62\x63\x64\x65\x66\x67\x68\x69\x6A\x6B\x6C\x6D\x6E\x6F" \
    "\x70\x71\x72\x73\x74\x75\x76\x77\x78\x79\x7A\x7B\x7C\x7D\x7E" \
    "\xC2\x80\xC2\x82\xC2\x83\xC2\x84\xC2\x85\xC2\x86\xC2\x87\xC2\x88\xC2\x89\xC2\x8A\xC2\x8B\xC2\x8C\xC2\x8E" \
    "\xC2\x91\xC2\x92\xC2\x93\xC2\x94\xC2\x95\xC2\x96\xC2\x97\xC2\x98\xC2\x99\xC2\x9A\xC2\x9B\xC2\x9C\xC2\x9E\xC2\x9F" \
...
{ 0x00000020, 0x00000021, 0x00000022, 0x00000023, 0x00000024, 0x00000025, 0x00000026, 0x00000027, 0x00000028, 0x00000029, 0x0000002A, 0x0000002B, 0x0000002C, 0x0000002D, 0x0000002E, 0x0000002F
, 0x00000030, 0x00000031, 0x00000032, 0x0000000033, 0x00000034, 0x0000000035, 0x00000036, 0x00000037, 0x00000038, 0x00000039, 0x0000003A, 0x0000003B, 0x0000003C, 0x0000003D, 0x0000003E, 0x0000003F
, 0x00000040, 0x00000041, 0x00000042, 0x00000043, 0x00000044, 0x00000045, 0x00000046, 0x00000047, 0x00000048, 0x00000049, 0x0000004A, 0x0000004B, 0x0000004C, 0x0000004D, 0x0000004E, 0x0000004F
, 0x00000050, 0x00000051, 0x00000052, 0x00000053, 0x00000054, 0x00000055, 0x00000056, 0x00000057, 0x00000058, 0x00000059, 0x0000005A, 0x0000005B, 0x0000005C, 0x0000005D, 0x0000005E, 0x0000005F
, 0x00000060, 0x00000061, 0x00000062, 0x00000063, 0x00000064, 0x00000065, 0x00000066, 0x00000067, 0x00000068, 0x00000069, 0x0000006A, 0x0000006B, 0x0000006C, 0x0000006D, 0x0000006E, 0x0000006F
...
, 0x00000080, 0x00000082, 0x00000083, 0x00000084, 0x00000085, 0x00000086, 0x00000087, 0x00000088, 0x00000089, 0x0000008A, 0x0000008B, 0x0000008C, 0x0000008E
, 0x00000091, 0x00000092, 0x00000093, 0x00000094, 0x00000095, 0x00000096, 0x00000097, 0x00000098, 0x00000099, 0x0000009A, 0x0000009B, 0x0000009C, 0x0000009E, 0x0000009F
...
TEST(boost_windows_1252_test_suite, test_multibyte_character_count)
{
    ...
    const std::size_t windows_1252_printable_characters_count = windows_1252_printable_characters.size();
    EXPECT_EQ(multibyte::ascii_printable_characters_count, ascii_printable_characters_count);
    EXPECT_EQ(multibyte::windows_1252_printable_characters_count, windows_1252_printable_characters_count);
}

TEST(boost_windows_1252_test_suite, test_system_wide_character_count)
{
    ...
    EXPECT_EQ(system_wide::windows_1252_printable_characters_count, windows_1252_printable_characters_count);
}

TEST(boost_windows_1252_test_suite, test_ucs_2_character_count)
{
    const u::u2string ascii_printable_characters(ucs_2::ascii_printable_characters_from_hex_codes);
    const u::u2string windows_1252_printable_characters(ucs_2::windows_1252_printable_characters_from_hex_codes);
    const std::size_t ascii_printable_characters_count = ascii_printable_characters.size();
    const std::size_t windows_1252_printable_characters_count = windows_1252_printable_characters.size();
    EXPECT_EQ(ucs_2::ascii_printable_characters_count, ascii_printable_characters_count);
    EXPECT_EQ(ucs_2::windows_1252_printable_characters_count, windows_1252_printable_characters_count);
}

TEST(boost_windows_1252_test_suite, test_utf_8_character_count)
{
    ...
    const std::size_t ascii_printable_characters_count = ascii_printable_characters.size();
    const std::size_t windows_1252_printable_characters_count = windows_1252_printable_characters.characters();
    const std::size_t windows_1252_printable_characters_size = windows_1252_printable_characters.size();
    EXPECT_EQ(utf_8::ascii_printable_characters_count, ascii_printable_characters_count);
    EXPECT_EQ(utf_8::windows_1252_printable_characters_count, windows_1252_printable_characters_count);
    EXPECT_EQ(utf_8::windows_1252_printable_characters_size, windows_1252_printable_characters_size);
}

TEST(boost_windows_1252_test_suite, test_utf_16_character_count)
{
    const u::u16string ascii_printable_characters(utf_16::ascii_printable_characters_from_hex_codes);
    const u::u16string windows_1252_printable_characters(utf_16::windows_1252_printable_characters_from_hex_codes);
    const std::size_t ascii_printable_characters_count = ascii_printable_characters.size();
    const std::size_t windows_1252_printable_characters_count = windows_1252_printable_characters.size();
...
TEST(boost_windows_1252_test_suite, test_utf_32_character_count)
{
    const u::u32string ascii_printable_characters(utf_32::ascii_printable_characters_from_hex_codes);
    const u::u32string windows_1252_printable_characters(utf_32::windows_1252_printable_characters_from_hex_codes);
    const std::size_t ascii_printable_characters_count = ascii_printable_characters.size();
    const std::size_t windows_1252_printable_characters_count = windows_1252_printable_characters.size();
...
TEST(boost_windows_1252_test_suite, test_char_is_windows_1252_character)
{
    {
        char c = -1;
        while (c < 31)
...
TEST(boost_windows_1252_test_suite, test_wchar_t_is_windows_1252_character)
{
    {
        wchar_t c = 0;
        while (c < 32)
...
TEST(boost_windows_1252_test_suite, test_char2_t_is_windows_1252_character)
{
    {
        u::char2_t c = 0;
        {
...
TEST(boost_windows_1252_test_suite, test_char16_t_is_windows_1252_character)
{
    {
        char16_t c = 0;
        {
    ...
    }
    {
        ...
        while (c < 0)
        {
            const bool is_windows_1252 = us::is_windows_1252_character(static_cast<char16_t>(c));
            EXPECT_EQ(is_windows_1252, false);
            ++c;
        }
    }
...
TEST(boost_windows_1252_test_suite, test_char32_t_is_windows_1252_character)
{
    {
        char32_t c = 0;
        {
    ...
    }
    {
        ...
        while (c < 0)
        {
            const bool is_windows_1252 = us::is_windows_1252_character(static_cast<char32_t>(c));
            EXPECT_EQ(is_windows_1252, false);
            ++c;
        }
    }
...
//TEST(boost_windows_1252_test_suite, test_multibyte_reduce_windows_1252_to_7_bit_ascii_characters)
//{
//    const std::string ascii_printable_characters(multibyte::ascii_printable_characters_from_hex_codes);
//    const std::string windows_1252_printable_characters(multibyte::windows_1252_printable_characters_from_hex_codes);
//    const std::string windows_1252_reduced_to_7_bit_ascii = us::reduce_to_7_bit_ascii_copy(windows_1252_printable_characters);
//    EXPECT_EQ(ascii_printable_characters, windows_1252_reduced_to_7_bit_ascii);
//}
//
//TEST(boost_windows_1252_test_suite, test_system_wide_reduce_windows_1252_to_7_bit_ascii_characters)
//{
//    const std::wstring ascii_printable_characters(system_wide::ascii_printable_characters_from_hex_codes);
//    const std::wstring windows_1252_printable_characters(system_wide::windows_1252_printable_characters_from_hex_codes);
//    const std::wstring windows_1252_reduced_to_7_bit_ascii = us::reduce_to_7_bit_ascii_copy(windows_1252_printable_characters);
//    EXPECT_EQ(ascii_printable_characters, windows_1252_reduced_to_7_bit_ascii);
//}
//
//TEST(boost_windows_1252_test_suite, test_ucs_2_reduce_windows_1252_to_7_bit_ascii_characters)
//{
//    const u::u2string ascii_printable_characters(ucs_2::ascii_printable_characters_from_hex_codes);
//    const u::u2string windows_1252_printable_characters(ucs_2::windows_1252_printable_characters_from_hex_codes);
//    const u::u2string windows_1252_reduced_to_7_bit_ascii = us::reduce_to_7_bit_ascii_copy(windows_1252_printable_characters);
//    EXPECT_EQ(ascii_printable_characters, windows_1252_reduced_to_7_bit_ascii);
//}
//
//TEST(boost_windows_1252_test_suite, test_utf_8_reduce_windows_1252_to_7_bit_ascii_characters)
//{
//    const u::u8string ascii_printable_characters(utf_8::ascii_printable_characters_from_hex_codes);
//    const u::u8string windows_1252_printable_characters(utf_8::windows_1252_printable_characters_from_hex_codes);
//    const u::u8string windows_1252_reduced_to_7_bit_ascii = us::reduce_to_7_bit_ascii_copy(windows_1252_printable_characters);
//    EXPECT_EQ(ascii_printable_characters, windows_1252_reduced_to_7_bit_ascii);
//}
//
//TEST(boost_windows_1252_test_suite, test_utf_16_reduce_windows_1252_to_7_bit_ascii_characters)
//{
//    const u::u16string ascii_printable_characters(utf_16::ascii_printable_characters_from_hex_codes);
//    const u::u16string windows_1252_printable_characters(utf_16::windows_1252_printable_characters_from_hex_codes);
//    const u::u16string windows_1252_reduced_to_7_bit_ascii = us::reduce_to_7_bit_ascii_copy(windows_1252_printable_characters);
//    EXPECT_EQ(ascii_printable_characters, windows_1252_reduced_to_7_bit_ascii);
//}
//
//TEST(boost_windows_1252_test_suite, test_utf_32_reduce_windows_1252_to_7_bit_ascii_characters)
//{
//    const u::u32string ascii_printable_characters(utf_32::ascii_printable_characters_from_hex_codes);
//    const u::u32string windows_1252_printable_characters(utf_32::windows_1252_printable_characters_from_hex_codes);
//    const u::u32string windows_1252_reduced_to_7_bit_ascii = us::reduce_to_7_bit_ascii_copy(windows_1252_printable_characters);
//    EXPECT_EQ(ascii_printable_characters, windows_1252_reduced_to_7_bit_ascii);
//}
