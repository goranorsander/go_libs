...
TEST(std_circular_buffer_test_suite, test_swap)
{
    ...
    EXPECT_EQ(buffer_1.capacity(), 5);
    EXPECT_EQ(buffer_1.size(), 5);
    ...
    EXPECT_EQ(buffer_2.capacity(), 7);
    EXPECT_EQ(buffer_2.size(), 3);
    ...
    EXPECT_EQ(buffer_1.capacity(), 7);
    EXPECT_EQ(buffer_1.size(), 3);
    EXPECT_EQ(buffer_1.empty(), false);
    ...
    EXPECT_EQ(buffer_2.capacity(), 5);
    EXPECT_EQ(buffer_2.size(), 5);
    EXPECT_EQ(buffer_2.empty(), false);
...
TEST(std_circular_buffer_test_suite, test_insert)
{
    ...
    circular_buffer_type::iterator ret_it = buffer.insert(buffer.end(), 4);
    EXPECT_EQ(*ret_it, 4);
    EXPECT_EQ(buffer.capacity(), 5);
    EXPECT_EQ(buffer.size(), 4);
    EXPECT_EQ(buffer.empty(), false);
    ...
    ret_it = buffer.insert(buffer.begin(), 5);
    EXPECT_EQ(*ret_it, 5);
    EXPECT_EQ(buffer.capacity(), 5);
    EXPECT_EQ(buffer.size(), 4);
    EXPECT_EQ(buffer.empty(), false);
