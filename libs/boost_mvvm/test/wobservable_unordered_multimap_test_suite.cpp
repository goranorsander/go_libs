...
public:
    ...
    void connect(wobservable_unordered_multimap_ptr_type& c)
    {
    ...
    void disconnect(wobservable_unordered_multimap_ptr_type& c)
    {
...
TEST(boost_wobservable_unordered_multimap_test_suite, test_insert_single_element)
{
    // Test insert single element
    m::wobservable_unordered_multimap<int, int>::ptr m = m::wobservable_unordered_multimap<int, int>::create();
    unordered_multimap_observer<int, int> o;

    // TODO: Find a way to test insert without using insert to prepare the test
    EXPECT_EQ(0, m->size());
    m->insert(m::wobservable_multimap<int, int>::value_type(1, 10));
    m->insert(m::wobservable_multimap<int, int>::value_type(2, 20));
    m->insert(m::wobservable_multimap<int, int>::value_type(4, 40));
    m->insert(m::wobservable_multimap<int, int>::value_type(5, 50));
    m->insert(m::wobservable_multimap<int, int>::value_type(6, 60));
    m->insert(m::wobservable_multimap<int, int>::value_type(7, 70));
    EXPECT_EQ(6, m->size());

    o.connect(m);

    m->insert(m::wobservable_unordered_multimap<int, int>::value_type(3, 30));
    EXPECT_EQ(7, m->size());

    typedef m::wobservable_unordered_multimap<int, int> wobservable_unordered_multimap_type;
    int count = 0;
    int sum = 0;
    BOOST_FOREACH(const typename wobservable_unordered_multimap_type::value_type& i, *m)
    {
        sum += i.second;
        ++count;
    }
...
TEST(boost_wobservable_unordered_multimap_test_suite, test_insert_single_element_with_hint)
{
    ...
    m::wobservable_unordered_multimap<int, int>::iterator it = m->insert(m->begin(), m::wobservable_unordered_multimap<int, int>::value_type(3, 30));
    EXPECT_EQ(5, m->size());

    it = m->insert(it, m::wobservable_unordered_multimap<int, int>::value_type(4, 40));
    EXPECT_EQ(6, m->size());

    it = m->insert(it, m::wobservable_unordered_multimap<int, int>::value_type(4, 40));
    EXPECT_EQ(7, m->size());

    it = m->insert(it, m::wobservable_unordered_multimap<int, int>::value_type(6, 60));
    EXPECT_EQ(8, m->size());
...
TEST(boost_wobservable_unordered_multimap_test_suite, test_insert_range)
{
    // Test insert range
    m::wobservable_unordered_multimap<int, int>::ptr m1 = m::wobservable_unordered_multimap<int, int>::create();
    m::wobservable_unordered_multimap<int, int>::ptr m2 = m::wobservable_unordered_multimap<int, int>::create();
    unordered_multimap_observer<int, int> o;

    EXPECT_EQ(0, m1->size());
    EXPECT_EQ(0, m2->size());

    m1->insert(m::wobservable_multimap<int, int>::value_type(1, 10));
    m1->insert(m::wobservable_multimap<int, int>::value_type(2, 20));
    m1->insert(m::wobservable_multimap<int, int>::value_type(5, 50));
    m1->insert(m::wobservable_multimap<int, int>::value_type(7, 70));
    EXPECT_EQ(4, m1->size());

    m2->insert(m::wobservable_multimap<int, int>::value_type(3, 30));
    m2->insert(m::wobservable_multimap<int, int>::value_type(4, 40));
    m2->insert(m::wobservable_multimap<int, int>::value_type(6, 60));
    EXPECT_EQ(3, m2->size());
...
TEST(boost_wobservable_unordered_multimap_test_suite, test_insert_initializer_list)
{
    ...
    const std::initializer_list<m::wobservable_unordered_multimap<int, int>::value_type> il1 =
    {
        m::wobservable_unordered_multimap<int, int>::value_type(1, 10),
        m::wobservable_unordered_multimap<int, int>::value_type(2, 20),
        m::wobservable_unordered_multimap<int, int>::value_type(5, 50),
        m::wobservable_unordered_multimap<int, int>::value_type(7, 70)
    };
    *m = il1;
    EXPECT_EQ(4, m->size());

    const std::initializer_list<m::wobservable_unordered_multimap<int, int>::value_type> il2 =
    {
        m::wobservable_unordered_multimap<int, int>::value_type(3, 30),
        m::wobservable_unordered_multimap<int, int>::value_type(4, 40),
        m::wobservable_unordered_multimap<int, int>::value_type(6, 60)
    };
...
TEST(boost_wobservable_unordered_multimap_test_suite, test_erase_position)
{
    // Test erase position
    m::wobservable_unordered_multimap<int, int>::ptr m = m::wobservable_unordered_multimap<int, int>::create();
    unordered_multimap_observer<int, int> o;
    ...
    m::wobservable_unordered_multimap<int, int>::iterator it1 = m->begin();
    std::advance(it1, 3);
    m::wobservable_unordered_multimap<int, int>::iterator it2 = m->erase(it1);
    EXPECT_EQ(6, m->size());
...
TEST(boost_wobservable_unordered_multimap_test_suite, test_erase_value)
{
    // Test erase value
    m::wobservable_unordered_multimap<int, int>::ptr m = m::wobservable_unordered_multimap<int, int>::create();
    unordered_multimap_observer<int, int> o;
...
TEST(boost_wobservable_unordered_multimap_test_suite, test_erase_range)
{
    // Test erase range
    m::wobservable_unordered_multimap<int, int>::ptr m = m::wobservable_unordered_multimap<int, int>::create();
    unordered_multimap_observer<int, int> o;
    ...
    ++begin;
    m::wobservable_unordered_multimap<int, int>::iterator end = begin;
    std::advance(end, 5);
...
TEST(boost_wobservable_unordered_multimap_test_suite, test_swap)
{
    // Test swap
    m::wobservable_unordered_multimap<int, int>::ptr m1 = m::wobservable_unordered_multimap<int, int>::create();
    m::wobservable_unordered_multimap<int, int>::ptr m2 = m::wobservable_unordered_multimap<int, int>::create();
    ...
    m1->insert(m::wobservable_multimap<int, int>::value_type(1, 10));
    m1->insert(m::wobservable_multimap<int, int>::value_type(2, 20));
    m1->insert(m::wobservable_multimap<int, int>::value_type(3, 30));
    m1->insert(m::wobservable_multimap<int, int>::value_type(4, 40));
    m1->insert(m::wobservable_multimap<int, int>::value_type(5, 50));
    EXPECT_EQ(5, m1->size());

    m2->insert(m::wobservable_multimap<int, int>::value_type(10, 100));
    m2->insert(m::wobservable_multimap<int, int>::value_type(20, 200));
    m2->insert(m::wobservable_multimap<int, int>::value_type(30, 300));
    m2->insert(m::wobservable_multimap<int, int>::value_type(40, 400));
    m2->insert(m::wobservable_multimap<int, int>::value_type(50, 500));
    m2->insert(m::wobservable_multimap<int, int>::value_type(60, 600));
    m2->insert(m::wobservable_multimap<int, int>::value_type(70, 700));
    EXPECT_EQ(7, m2->size());
    ...
    int count = 0;
    int sum = 0;
    BOOST_FOREACH(const typename wobservable_unordered_multimap_type::value_type& i, *m1)
    {
        sum += i.second;
        ++count;
    }
    ...
    count = 0;
    sum = 0;
    BOOST_FOREACH(const typename wobservable_unordered_multimap_type::value_type& i, *m2)
    {
        sum += i.second;
        ++count;
    }
...
TEST(boost_wobservable_unordered_multimap_test_suite, test_clear)
{
    // Test clear
    m::wobservable_unordered_multimap<int, int>::ptr m = m::wobservable_unordered_multimap<int, int>::create();
    unordered_multimap_observer<int, int> o;
...
TEST(boost_wobservable_unordered_multimap_test_suite, test_emplace)
{
    // Test emplace
    m::wobservable_unordered_multimap<int, int>::ptr m = m::wobservable_unordered_multimap<int, int>::create();
    unordered_multimap_observer<int, int> o;
    ...
    m::wobservable_unordered_multimap<int, int>::iterator it = m->emplace(m::wobservable_unordered_multimap<int, int>::value_type(4, 40));
    EXPECT_EQ(4, it->first);
    EXPECT_EQ(40, it->second);

    it = m->emplace(m::wobservable_unordered_multimap<int, int>::value_type(5, 50));
    EXPECT_EQ(5, it->first);
    EXPECT_EQ(50, it->second);

    it = m->emplace(m::wobservable_unordered_multimap<int, int>::value_type(4, 40));
    EXPECT_EQ(4, it->first);
    EXPECT_EQ(40, it->second);

    it = m->emplace(m::wobservable_unordered_multimap<int, int>::value_type(6, 60));
    ...
    int count = 0;
    int sum = 0;
    BOOST_FOREACH(const typename observable_unordered_map_type::value_type& i, *m)
    {
        sum += i.second;
        ++count;
    }
...
TEST(boost_wobservable_unordered_multimap_test_suite, test_emplace_hint)
{
    // Test emplace hint
    m::wobservable_unordered_multimap<int, int>::ptr m = m::wobservable_unordered_multimap<int, int>::create();
    unordered_multimap_observer<int, int> o;
    ...
    m::wobservable_unordered_multimap<int, int>::iterator it = m->emplace_hint(m->begin(), m::wobservable_unordered_multimap<int, int>::value_type(3, 30));
    EXPECT_EQ(3, it->first);
    EXPECT_EQ(30, it->second);

    it = m->emplace_hint(it, m::wobservable_unordered_multimap<int, int>::value_type(4, 40));
    EXPECT_EQ(4, it->first);
    EXPECT_EQ(40, it->second);
    ...
    it = m->emplace_hint(it, m::wobservable_unordered_multimap<int, int>::value_type(6, 60));
    EXPECT_EQ(6, it->first);
    EXPECT_EQ(60, it->second);
