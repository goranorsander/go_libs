#ifndef GO_BOOST_TYPE_TRAITS_PRIMITIVE_TYPE_SPECIALIZER_HPP_INCLUDED
#define GO_BOOST_TYPE_TRAITS_PRIMITIVE_TYPE_SPECIALIZER_HPP_INCLUDED
...
#include <go_boost/type_traits/detail/primitive_type_specializer_base.hpp>

#define GO_BOOST_IMPLEMENT_PRIMITIVE_TYPE_SPECIALIZER( _class_name_, _primitive_type_ ) \
struct _class_name_##_tag {}; \
typedef go_boost::type_traits::primitive_type_specializer<_primitive_type_, _class_name_##_tag> _class_name_;
...
#define GO_BOOST_IMPLEMENT_PRIMITIVE_TYPE_SPECIALIZER_CONSTRUCTORS( _class_name_, _primitive_type_ ) \
    _class_name_() BOOST_NOEXCEPT_OR_NOTHROW : go_boost::type_traits::primitive_type_specializer<_primitive_type_>(static_cast<_primitive_type_>(0)) {} \
    _class_name_(const _class_name_& t) BOOST_NOEXCEPT_OR_NOTHROW : go_boost::type_traits::primitive_type_specializer<_primitive_type_>(t) {} \
    explicit _class_name_(const value_type& t) BOOST_NOEXCEPT_OR_NOTHROW : go_boost::type_traits::primitive_type_specializer<_primitive_type_>(t) {}

#define GO_BOOST_IMPLEMENT_PRIMITIVE_TYPE_SPECIALIZER_ASSIGNMENT_OPERATORS( _class_name_, _primitive_type_ ) \
    _class_name_& operator=(const _class_name_& t) BOOST_NOEXCEPT_OR_NOTHROW { if(&t != this) { go_boost::type_traits::primitive_type_specializer<_primitive_type_>::operator=(t); } return *this; } \
...
class _class_name_ \
    : public go_boost::type_traits::primitive_type_specializer<_primitive_type_> \
{ \
public: \
...
#endif  // #ifndef GO_BOOST_TYPE_TRAITS_PRIMITIVE_TYPE_SPECIALIZER_HPP_INCLUDED
