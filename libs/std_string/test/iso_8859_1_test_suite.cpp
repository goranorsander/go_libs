...
TEST(std_iso_8859_1_test_suite, required_cpp11_feature_not_supported) {}
#else
...
// ISO/IEC 8859-1
const s::char2_t iso_8859_1_printable_characters_from_hex_codes[] =
    { 0x0020, 0x0021, 0x0022, 0x0023, 0x0024, 0x0025, 0x0026, 0x0027, 0x0028, 0x0029, 0x002A, 0x002B, 0x002C, 0x002D, 0x002E, 0x002F
    , 0x0030, 0x0031, 0x0032, 0x0033, 0x0034, 0x0035, 0x0036, 0x0037, 0x0038, 0x0039, 0x003A, 0x003B, 0x003C, 0x003D, 0x003E, 0x003F
    , 0x0040, 0x0041, 0x0042, 0x0043, 0x0044, 0x0045, 0x0046, 0x0047, 0x0048, 0x0049, 0x004A, 0x004B, 0x004C, 0x004D, 0x004E, 0x004F
    , 0x0050, 0x0051, 0x0052, 0x0053, 0x0054, 0x0055, 0x0056, 0x0057, 0x0058, 0x0059, 0x005A, 0x005B, 0x005C, 0x005D, 0x005E, 0x005F
...
TEST(std_iso_8859_1_test_suite, test_multibyte_character_count)
{
...
TEST(std_iso_8859_1_test_suite, test_system_wide_character_count)
{
...
TEST(std_iso_8859_1_test_suite, test_ucs_2_character_count)
{
...
TEST(std_iso_8859_1_test_suite, test_utf_8_character_count)
{
...
TEST(std_iso_8859_1_test_suite, test_utf_16_character_count)
{
    const std::u16string ascii_printable_characters(utf_16::ascii_printable_characters_from_hex_codes);
    const std::u16string iso_8859_1_printable_characters(utf_16::iso_8859_1_printable_characters_from_hex_codes);
    const std::size_t ascii_printable_characters_count = ascii_printable_characters.size();
    const std::size_t iso_8859_1_printable_characters_count = iso_8859_1_printable_characters.size();
...
TEST(std_iso_8859_1_test_suite, test_utf_32_character_count)
{
    const std::u32string ascii_printable_characters(utf_32::ascii_printable_characters_from_hex_codes);
    const std::u32string iso_8859_1_printable_characters(utf_32::iso_8859_1_printable_characters_from_hex_codes);
    const std::size_t ascii_printable_characters_count = ascii_printable_characters.size();
    const std::size_t iso_8859_1_printable_characters_count = iso_8859_1_printable_characters.size();
...
TEST(std_iso_8859_1_test_suite, test_char_is_iso_8859_1_character)
{
    {
        char c = -1;
        while (c < 31)
...
TEST(std_iso_8859_1_test_suite, test_char8_t_is_iso_8859_1_character)
{
    {
        char8_t c = 0;
        {
...
TEST(std_iso_8859_1_test_suite, test_wchar_t_is_iso_8859_1_character)
{
    {
        wchar_t c = 0;
        while (c < 32)
...
TEST(std_iso_8859_1_test_suite, test_char2_t_is_iso_8859_1_character)
{
    {
        s::char2_t c = 0;
        {
...
TEST(std_iso_8859_1_test_suite, test_char16_t_is_iso_8859_1_character)
{
    {
        char16_t c = 0;
        {
...
TEST(std_iso_8859_1_test_suite, test_char32_t_is_iso_8859_1_character)
{
    {
        char32_t c = 0;
        {
...
//TEST(std_iso_8859_1_test_suite, test_multibyte_reduce_iso_8859_1_to_7_bit_ascii_characters)
//{
//    const std::string ascii_printable_characters(multibyte::ascii_printable_characters_from_hex_codes);
//    const std::string iso_8859_1_printable_characters(multibyte::iso_8859_1_printable_characters_from_hex_codes);
...
//}
//
//TEST(std_iso_8859_1_test_suite, test_system_wide_reduce_iso_8859_1_to_7_bit_ascii_characters)
//{
//    const std::wstring ascii_printable_characters(system_wide::ascii_printable_characters_from_hex_codes);
//    const std::wstring iso_8859_1_printable_characters(system_wide::iso_8859_1_printable_characters_from_hex_codes);
...
//}
//
//TEST(std_iso_8859_1_test_suite, test_ucs_2_reduce_iso_8859_1_to_7_bit_ascii_characters)
//{
//    const s::u2string ascii_printable_characters(ucs_2::ascii_printable_characters_from_hex_codes);
//    const s::u2string iso_8859_1_printable_characters(ucs_2::iso_8859_1_printable_characters_from_hex_codes);
...
//}
//
//TEST(std_iso_8859_1_test_suite, test_utf_8_reduce_iso_8859_1_to_7_bit_ascii_characters)
//{
//    const s::u8string ascii_printable_characters(utf_8::ascii_printable_characters_from_hex_codes);
//    const s::u8string iso_8859_1_printable_characters(utf_8::iso_8859_1_printable_characters_from_hex_codes);
...
//}
//
//TEST(std_iso_8859_1_test_suite, test_utf_16_reduce_iso_8859_1_to_7_bit_ascii_characters)
//{
//    const std::u16string ascii_printable_characters(utf_16::ascii_printable_characters_from_hex_codes);
//    const std::u16string iso_8859_1_printable_characters(utf_16::iso_8859_1_printable_characters_from_hex_codes);
//    const std::u16string iso_8859_1_reduced_to_7_bit_ascii = se::reduce_to_7_bit_ascii_copy(iso_8859_1_printable_characters);
//    EXPECT_EQ(ascii_printable_characters, iso_8859_1_reduced_to_7_bit_ascii);
//}
//
//TEST(std_iso_8859_1_test_suite, test_utf_32_reduce_iso_8859_1_to_7_bit_ascii_characters)
//{
//    const std::u32string ascii_printable_characters(utf_32::ascii_printable_characters_from_hex_codes);
//    const std::u32string iso_8859_1_printable_characters(utf_32::iso_8859_1_printable_characters_from_hex_codes);
//    const std::u32string iso_8859_1_reduced_to_7_bit_ascii = se::reduce_to_7_bit_ascii_copy(iso_8859_1_printable_characters);
//    EXPECT_EQ(ascii_printable_characters, iso_8859_1_reduced_to_7_bit_ascii);
//}
