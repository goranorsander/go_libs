...
main_frame_view_model::main_frame_view_model(mdi_frame_interface::pointer mdi_frame_mgr, const mst::wcommand_manager::ptr& command_mgr, const mst::wevent_manager::ptr& event_mgr, const fleet_repository::ptr& fleet_repo)
...
main_frame_view_model::ptr main_frame_view_model::create(mdi_frame_interface::pointer mdi_frame_mgr, const mst::wcommand_manager::ptr& command_mgr, const mst::wevent_manager::ptr& event_mgr, const fleet_repository::ptr& fleet_repo)
{
    struct make_shared_enabler
        : public this_type
    {
        virtual ~make_shared_enabler() GO_DEFAULT_DESTRUCTOR
        make_shared_enabler(mdi_frame_interface::pointer mdi_frame_mgr, const mst::wcommand_manager::ptr& command_mgr, const mst::wevent_manager::ptr& event_mgr, const fleet_repository::ptr& fleet_repo) : this_type(mdi_frame_mgr, command_mgr, event_mgr, fleet_repo) {}
    };

    main_frame_view_model::ptr view_model = std::make_shared<make_shared_enabler, mdi_frame_interface::pointer, const mst::wcommand_manager::ptr&, const mst::wevent_manager::ptr&, const fleet_repository::ptr&>(std::forward<mdi_frame_interface::pointer>(mdi_frame_mgr), command_mgr, event_mgr, fleet_repo);
...
void main_frame_view_model::bind_properties()
{
    open_add_equipment_view_command.getter(
        [this]()
        {
            _open_add_equipment_view_command = mst::relay_wcommand::create(L"main_frame_view_model::open_add_equipment_view_command",
    ...
    delete_dialog_view_command.getter(
        [this]()
        {
            _delete_dialog_view_command = mst::relay_wcommand::create(L"main_frame_view_model::delete_dialog_view_command",
                [this](const m::command_parameters::ptr& p)
                {
                    mdi_frame_interface::pointer mdi_frame_mgr = mdi_frame_manager;
...
{
    mst::wevent_manager::ptr event_mgr = event_manager();
    if(event_mgr)
    {
