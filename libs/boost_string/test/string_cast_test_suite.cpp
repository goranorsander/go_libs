...
const char16_t ascii_printable_characters[] =
    ...
    , 0x0060, 0x0061, 0x0062, 0x0063, 0x0064, 0x0065, 0x0066, 0x0067, 0x0068, 0x0069, 0x006A, 0x006B, 0x006C, 0x006D, 0x006E, 0x006F
    , 0x0070, 0x0071, 0x0072, 0x0073, 0x0074, 0x0075, 0x0076, 0x0077, 0x0078, 0x0079, 0x007A, 0x007B, 0x007C, 0x007D, 0x007E, 0x0000 };
#endif  // #if !defined(BOOST_NO_CXX11_UNICODE_LITERALS)
...
{
    const s::u16string from_string(utf_16::ascii_printable_characters);
    const std::string expected_result(multibyte::ascii_printable_characters);
    const std::string cast_result = s::string_cast<std::string>(from_string);
    EXPECT_EQ(expected_result, cast_result);
}
...
{
    const s::u16string from_string(utf_16::swedish);
    const std::string expected_result(multibyte::swedish);
    const std::string cast_result = s::string_cast<std::string>(from_string);
    EXPECT_EQ(expected_result, cast_result);
}
...
{
    const s::u32string from_string(utf_32::ascii_printable_characters);
    const std::string expected_result(multibyte::ascii_printable_characters);
    const std::string cast_result = s::string_cast<std::string>(from_string);
    EXPECT_EQ(expected_result, cast_result);
}
...
{
    const s::u32string from_string(utf_32::swedish);
    const std::string expected_result(multibyte::swedish);
    const std::string cast_result = s::string_cast<std::string>(from_string);
    EXPECT_EQ(expected_result, cast_result);
}
...
{
    const std::string from_string(multibyte::ascii_printable_characters);
    const s::u16string expected_result(utf_16::ascii_printable_characters);
    const s::u16string cast_result = s::string_cast<s::u16string>(from_string);
    EXPECT_EQ(expected_result, cast_result);
}
...
{
    const std::string from_string(multibyte::swedish);
    const s::u16string expected_result(utf_16::swedish);
    const s::u16string cast_result = s::string_cast<s::u16string>(from_string);
    EXPECT_EQ(expected_result, cast_result);
}
...
{
    const std::string from_string(multibyte::ascii_printable_characters);
    const s::u32string expected_result(utf_32::ascii_printable_characters);
    const s::u32string cast_result = s::string_cast<s::u32string>(from_string);
    EXPECT_EQ(expected_result, cast_result);
}
...
{
    const std::string from_string(multibyte::swedish);
    const s::u32string expected_result(utf_32::swedish);
    const s::u32string cast_result = s::string_cast<s::u32string>(from_string);
    EXPECT_EQ(expected_result, cast_result);
}
