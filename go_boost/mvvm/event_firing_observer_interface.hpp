...
typedef typename basic_event_firing_observer_interface<std::string> event_firing_observer_interface;
typedef typename basic_event_firing_observer_interface<std::wstring> wevent_firing_wobserver_interface;
