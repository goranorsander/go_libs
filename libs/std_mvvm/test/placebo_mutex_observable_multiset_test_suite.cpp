//
//  placebo_mutex_observable_multiset_test_suite.cpp
//
...
TEST(std_observable_multiset_placebo_mutex_test_suite, cpp11_not_supported) {}
#else
...
public:
    ...
    typedef typename m::observable_multiset<T, u::placebo_mutex>::ptr observable_multiset_ptr_type;
...
TEST(std_observable_multiset_placebo_mutex_test_suite, test_insert_single_element)
{
    // Test insert single element
    m::observable_multiset<int, u::placebo_mutex>::ptr s = m::observable_multiset<int, u::placebo_mutex>::create();
...
TEST(std_observable_multiset_placebo_mutex_test_suite, test_insert_single_element_with_hint)
{
    ...
    *s = il;
    ...
    m::observable_multiset<int, u::placebo_mutex>::iterator it = s->insert(s->begin(), 3);
    EXPECT_EQ(5, s->size());
...
TEST(std_observable_multiset_placebo_mutex_test_suite, test_insert_range)
{
    // Test insert range
    m::observable_multiset<int, u::placebo_mutex>::ptr s1 = m::observable_multiset<int, u::placebo_mutex>::create();
    m::observable_multiset<int, u::placebo_mutex>::ptr s2 = m::observable_multiset<int, u::placebo_mutex>::create();
    multiset_observer<int> o;
    ...
    *s2 = il2;
    ...
    m::observable_multiset<int, u::placebo_mutex>::iterator it = s2->begin();
    EXPECT_EQ(1, *it);
    ++it;
    EXPECT_EQ(2, *it);
    ++it;
...
TEST(std_observable_multiset_placebo_mutex_test_suite, test_insert_initializer_list)
{
    ...
    *s = il1;
    ...
    m::observable_multiset<int, u::placebo_mutex>::iterator it = s->begin();
    EXPECT_EQ(1, *it);
    ++it;
    EXPECT_EQ(2, *it);
    ++it;
...
TEST(std_observable_multiset_placebo_mutex_test_suite, test_erase_position)
{
    // Test erase position
    m::observable_multiset<int, u::placebo_mutex>::ptr s = m::observable_multiset<int, u::placebo_mutex>::create();
    multiset_observer<int> o;
    ...
    *s = il;
    ...
    m::observable_multiset<int, u::placebo_mutex>::iterator it1 = s->begin();
    std::advance(it1, 3);
    m::observable_multiset<int, u::placebo_mutex>::iterator it2 = s->erase(it1);
    EXPECT_EQ(6, s->size());
...
TEST(std_observable_multiset_placebo_mutex_test_suite, test_erase_value)
{
    // Test erase value
    m::observable_multiset<int, u::placebo_mutex>::ptr s = m::observable_multiset<int, u::placebo_mutex>::create();
    multiset_observer<int> o;
...
TEST(std_observable_multiset_placebo_mutex_test_suite, test_erase_range)
{
    // Test erase range
    m::observable_multiset<int, u::placebo_mutex>::ptr s = m::observable_multiset<int, u::placebo_mutex>::create();
    multiset_observer<int> o;
    ...
    *s = il;
    ...
    m::observable_multiset<int, u::placebo_mutex>::iterator begin = s->begin();
    ++begin;
    m::observable_multiset<int, u::placebo_mutex>::iterator end = s->end();
    --end;
...
TEST(std_observable_multiset_placebo_mutex_test_suite, test_swap)
{
    // Test swap
    m::observable_multiset<int, u::placebo_mutex>::ptr s1 = m::observable_multiset<int, u::placebo_mutex>::create();
    m::observable_multiset<int, u::placebo_mutex>::ptr s2 = m::observable_multiset<int, u::placebo_mutex>::create();
...
TEST(std_observable_multiset_placebo_mutex_test_suite, test_clear)
{
    // Test clear
    m::observable_multiset<int, u::placebo_mutex>::ptr s = m::observable_multiset<int, u::placebo_mutex>::create();
    multiset_observer<int> o;
...
TEST(std_observable_multiset_placebo_mutex_test_suite, test_emplace)
{
    // Test emplace
    m::observable_multiset<int, u::placebo_mutex>::ptr s = m::observable_multiset<int, u::placebo_mutex>::create();
    multiset_observer<int> o;
    ...
    *s = il;
    ...
    m::observable_multiset<int, u::placebo_mutex>::iterator it = s->emplace(4);
    EXPECT_EQ(4, *it);
...
TEST(std_observable_multiset_placebo_mutex_test_suite, test_emplace_hint)
{
    // Test emplace hint
    m::observable_multiset<int, u::placebo_mutex>::ptr s = m::observable_multiset<int, u::placebo_mutex>::create();
    multiset_observer<int> o;
    ...
    *s = il;
    ...
    m::observable_multiset<int, u::placebo_mutex>::iterator it = s->emplace_hint(s->begin(), 3);
    EXPECT_EQ(3, *it);
