...
TEST(std_observable_deque_placebo_lockable_test_suite, required_cpp11_feature_not_supported) {}
#else

using container_type = m::observable_deque<int, a::placebo_lockable>;
