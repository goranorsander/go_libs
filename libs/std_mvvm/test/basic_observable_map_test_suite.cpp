...
TEST(std_basic_observable_map_test_suite, test_insert_single_element)
{
    ...
    EXPECT_EQ(0, m->size());
    const std::initializer_list<m::basic_observable_map<int, int, u::u8string>::value_type> il =
    {
    ...
    *m = il;
    ...
    int count = 0;
    for(const m::basic_observable_map<int, int, u::u8string>::value_type& i : *m)
    {
        ++count;
...
TEST(std_basic_observable_map_test_suite, test_swap)
{
    ...
    const std::initializer_list<m::basic_observable_map<int, int, u::u8string>::value_type> il2 =
    {
        m::basic_observable_map<int, int, u::u8string>::value_type(10, 100),
        m::basic_observable_map<int, int, u::u8string>::value_type(20, 200),
        m::basic_observable_map<int, int, u::u8string>::value_type(30, 300),
        m::basic_observable_map<int, int, u::u8string>::value_type(40, 400),
        m::basic_observable_map<int, int, u::u8string>::value_type(50, 500),
        m::basic_observable_map<int, int, u::u8string>::value_type(60, 600),
        m::basic_observable_map<int, int, u::u8string>::value_type(70, 700)
    };
    *m1 = il1;
    *m2 = il2;
    EXPECT_EQ(5, m1->size());
    ...
    int count = 0;
    for(const m::basic_observable_map<int, int, u::u8string>::value_type& i : *m1)
    {
        ++count;
    ...
    count = 0;
    for(const m::basic_observable_map<int, int, u::u8string>::value_type& i : *m2)
    {
        ++count;
        EXPECT_EQ(count, i.first);
        EXPECT_EQ(count*10, i.second);
