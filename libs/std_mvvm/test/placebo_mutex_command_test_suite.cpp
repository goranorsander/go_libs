//
//  placebo_mutex_command_test_suite.cpp
//
...
TEST(std_command_placebo_mutex_test_suite, cpp11_not_supported) {}
#else
...
TEST(std_command_placebo_mutex_test_suite, test_command)
{
