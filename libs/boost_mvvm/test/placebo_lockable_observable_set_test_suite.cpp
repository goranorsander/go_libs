...
{
    go_boost_test::associative::set::unique::test_insert_single_element<container_type>();
}

TEST(boost_observable_set_placebo_lockable_test_suite, test_insert_single_element_with_hint)
{
    go_boost_test::associative::set::unique::test_insert_single_element_with_hint<container_type>();
}

TEST(boost_observable_set_placebo_lockable_test_suite, test_insert_range)
{
    go_boost_test::associative::set::unique::test_insert_range<container_type>();
}

TEST(boost_observable_set_placebo_lockable_test_suite, test_insert_initializer_list)
{
    go_boost_test::associative::set::unique::test_insert_initializer_list<container_type>();
}

TEST(boost_observable_set_placebo_lockable_test_suite, test_erase_position)
{
    go_boost_test::associative::set::unique::test_erase_position<container_type>();
}

TEST(boost_observable_set_placebo_lockable_test_suite, test_erase_value)
{
    go_boost_test::associative::set::unique::test_erase_value<container_type>();
}

TEST(boost_observable_set_placebo_lockable_test_suite, test_erase_range)
{
    go_boost_test::associative::set::unique::test_erase_range<container_type>();
}

TEST(boost_observable_set_placebo_lockable_test_suite, test_swap)
{
    go_boost_test::associative::set::unique::test_swap<container_type>();
}

TEST(boost_observable_set_placebo_lockable_test_suite, test_clear)
{
    go_boost_test::associative::set::unique::test_clear<container_type>();
}

TEST(boost_observable_set_placebo_lockable_test_suite, test_emplace)
{
    go_boost_test::associative::set::unique::test_emplace<container_type>();
}

TEST(boost_observable_set_placebo_lockable_test_suite, test_emplace_hint)
{
    go_boost_test::associative::set::unique::test_emplace_hint<container_type>();
}
