...
private:
    void bind_properties()
    {
        ...
        impulse_speed_command.getter(bp::bind(mu::get_u8property_relay_u8command, bph::arg1, bph::arg2, bph::arg3, bph::arg4, bph::arg5)(s::create<s::u8string>("impulse_speed"), boost::bind(&spaceship::go_to_impulse, this, boost::placeholders::_1), boost::bind(&spaceship::can_go_to_impulse, this, boost::placeholders::_1), m::command_parameters::create(), bp::ref(_impulse_speed_command)));
        warp_speed_command.getter(bp::bind(mu::get_u8property_relay_u8command, bph::arg1, bph::arg2, bph::arg3, bph::arg4, bph::arg5)(s::create<s::u8string>("warp_speed"), boost::bind(&spaceship::go_to_warp, this, boost::placeholders::_1), boost::bind(&spaceship::can_go_to_warp, this, boost::placeholders::_1), m::command_parameters::create(), bp::ref(_warp_speed_command)));
    }
