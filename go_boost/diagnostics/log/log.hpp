...
void initialize(const policy::guaranteed_logger<file_writer>& policy, const std::string& log_directory, const std::string& log_file_name, boost::uint32_t log_file_roll_size_mb)
{
...
void initialize(const policy::non_guaranteed_logger<file_writer>& policy, const std::string& log_directory, const std::string& log_file_name, boost::uint32_t log_file_roll_size_mb)
{
    log::logger_instance().reset(new detail::logger(policy, log_directory, log_file_name, log_file_roll_size_mb));
    log::logger_atom().store(log::logger_instance().get(), boost::memory_order_seq_cst);
}

void initialize(const policy::guaranteed_logger<wfile_writer>& policy, const std::wstring& log_directory, const std::wstring& log_file_name, boost::uint32_t log_file_roll_size_mb)
{
...
void initialize(const policy::non_guaranteed_logger<wfile_writer>& policy, const std::wstring& log_directory, const std::wstring& log_file_name, boost::uint32_t log_file_roll_size_mb)
{
    wlog::logger_instance().reset(new detail::wlogger(policy, log_directory, log_file_name, log_file_roll_size_mb));
    wlog::logger_atom().store(wlog::logger_instance().get(), boost::memory_order_seq_cst);
}
