#ifndef GO_BOOST_MVVM_TEST_CONTAINER_OBSERVER_IPP_INCLUDED
#define GO_BOOST_MVVM_TEST_CONTAINER_OBSERVER_IPP_INCLUDED
...
template<class C, class S, class L = boost::recursive_mutex>
...
public:
    ...
    virtual ~container_observer() GO_BOOST_DEFAULT_DESTRUCTOR
    ...
    void connect(container_ptr& c)
    {
        if (c)
        {
            _container_changed_connections.connect(c, c->container_changed, boost::bind(&this_type::on_container_changed, this, boost::placeholders::_1, boost::placeholders::_2));
            _property_changed_connections.connect(c, c->property_changed, boost::bind(&this_type::on_property_changed, this, boost::placeholders::_1, boost::placeholders::_2));
        }
    }
    ...
    GO_BOOST_CONSTEXPR m::notify_container_changed_action last_action() const
    {
        return _last_action;
    }

    GO_BOOST_CONSTEXPR unsigned int last_change_added() const
    {
        return _last_change_added;
    }

    GO_BOOST_CONSTEXPR unsigned int last_change_removed() const
    {
        return _last_change_removed;
    }

    GO_BOOST_CONSTEXPR unsigned int last_change_new_size() const
    {
        return _last_change_new_size;
    }

    GO_BOOST_CONSTEXPR unsigned int total_change_added() const
    {
        return _total_change_added;
    }

    GO_BOOST_CONSTEXPR unsigned int total_change_removed() const
    {
        return _total_change_removed;
    }

    GO_BOOST_CONSTEXPR unsigned int action_add_count() const
    {
        return _action_add_count;
    }

    GO_BOOST_CONSTEXPR unsigned int action_remove_count() const
    {
        return _action_remove_count;
    }

    GO_BOOST_CONSTEXPR unsigned int action_reset_count() const
    {
        return _action_reset_count;
    }

    GO_BOOST_CONSTEXPR unsigned int action_swap_count() const
    {
...
#endif  // #ifndef GO_BOOST_MVVM_TEST_CONTAINER_OBSERVER_IPP_INCLUDED
