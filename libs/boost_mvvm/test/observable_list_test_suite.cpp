...
TEST(boost_observable_list_test_suite, test_observable_insert_single_element)
{
...
TEST(boost_observable_list_test_suite, test_observable_insert_fill)
{
    // Test insert fill
    m::observable_list<int>::ptr l = m::observable_list<int>::create();
    list_observer<int> o;
...
TEST(boost_observable_list_test_suite, test_observable_insert_range)
{
    // Test insert range
    m::observable_list<int>::ptr l1 = m::observable_list<int>::create();
    m::observable_list<int>::ptr l2 = m::observable_list<int>::create();
