...
class basic_observable_unordered_map
    : public basic_observable_unordered_associative_container<S, std::unordered_map<K, T>, L>
{
public:
    using string_type = S;
    using lockable_type = L;
    using container_type = typename std::unordered_map<K, T>;
    using this_type = basic_observable_unordered_map<K, T, S, L>;
...
public:
    ...
    using lockable_type = L;
    using container_type = typename std::unordered_map<K, T>;
    using this_type = observable_unordered_map<K, T, L>;
    using ptr = typename std::shared_ptr<this_type>;
    using wptr = typename std::weak_ptr<this_type>;
...
public:
    ...
    using lockable_type = L;
    using container_type = typename std::unordered_map<K, T>;
    using this_type = wobservable_unordered_map<K, T, L>;
    using ptr = typename std::shared_ptr<this_type>;
    using wptr = typename std::weak_ptr<this_type>;
