...
TEST(std_command_manager_lambda_placebo_lockable_test_suite, required_cpp11_feature_not_supported) {}
#else

GO_MESSAGE("std_command_manager_lambda_placebo_lockable_test_suite is disabled")
TEST(std_command_manager_lambda_placebo_lockable_test_suite, test_suite_disabled) {}
