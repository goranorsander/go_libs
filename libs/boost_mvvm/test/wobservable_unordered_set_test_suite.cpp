...
public:
    ...
    {
        c->container_changed.connect(boost::bind(&unordered_set_observer::on_container_changed, this, _1, _2));
        c->property_changed.connect(boost::bind(&unordered_set_observer::on_property_changed, this, _1, _2));
    }

    void disconnect(wobservable_unordered_set_ptr_type& c)
    {
        c->container_changed.disconnect(boost::bind(&unordered_set_observer::on_container_changed, this, _1, _2));
        c->property_changed.disconnect(boost::bind(&unordered_set_observer::on_property_changed, this, _1, _2));
    }
...
TEST(boost_wobservable_unordered_set_test_suite, test_insert_single_element)
{
...
TEST(boost_wobservable_unordered_set_test_suite, test_insert_single_element_with_hint)
{
...
TEST(boost_wobservable_unordered_set_test_suite, test_insert_range)
{
    // Test insert range
...
TEST(boost_wobservable_unordered_set_test_suite, test_insert_initializer_list)
{
...
TEST(boost_wobservable_unordered_set_test_suite, test_erase_position)
{
    // Test erase position
    m::wobservable_unordered_set<int>::ptr s = m::wobservable_unordered_set<int>::create();
    unordered_set_observer<int> o;
...
TEST(boost_wobservable_unordered_set_test_suite, test_erase_value)
{
    // Test erase value
    m::wobservable_unordered_set<int>::ptr s = m::wobservable_unordered_set<int>::create();
    unordered_set_observer<int> o;
...
TEST(boost_wobservable_unordered_set_test_suite, test_erase_range)
{
    // Test erase range
    m::wobservable_unordered_set<int>::ptr s = m::wobservable_unordered_set<int>::create();
    unordered_set_observer<int> o;
    ...
    ++begin;
    m::wobservable_unordered_set<int>::iterator end = begin;
    std::advance(end, 5);
...
TEST(boost_wobservable_unordered_set_test_suite, test_swap)
{
    // Test swap
    m::wobservable_unordered_set<int>::ptr s1 = m::wobservable_unordered_set<int>::create();
    m::wobservable_unordered_set<int>::ptr s2 = m::wobservable_unordered_set<int>::create();
...
TEST(boost_wobservable_unordered_set_test_suite, test_clear)
{
    // Test clear
    m::wobservable_unordered_set<int>::ptr s = m::wobservable_unordered_set<int>::create();
    unordered_set_observer<int> o;
