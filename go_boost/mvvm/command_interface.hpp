...
typedef basic_command_interface<std::string, go_boost::async::placebo_lockable> command_interface;
typedef basic_command_interface<std::wstring, go_boost::async::placebo_lockable> wcommand_interface;
...
template<>
inline basic_command_interface<std::string, go_boost::async::placebo_lockable>::~basic_command_interface()
{
    this->can_execute_changed.disconnect_all_slots();
}

template<>
inline basic_command_interface<std::wstring, go_boost::async::placebo_lockable>::~basic_command_interface()
{
    this->can_execute_changed.disconnect_all_slots();
}
