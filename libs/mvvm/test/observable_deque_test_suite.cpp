...
TEST(std_observable_deque_test_suite, test_observable_deque_assign_range)
{
    // Test assign range
...
TEST(std_observable_deque_test_suite, test_observable_deque_assign_initializer_list)
{
...
TEST(std_observable_deque_test_suite, test_observable_deque_assign_fill)
{
    // Test assign fill
...
TEST(std_observable_deque_test_suite, test_observable_deque_push_back)
{
    // Test push back
    m::observable_deque<int>::ptr d = m::observable_deque<int>::create();
    deque_observer<int> o;
...
TEST(std_observable_deque_test_suite, test_observable_deque_push_front)
{
    // Test push front
    m::observable_deque<int>::ptr d = m::observable_deque<int>::create();
    deque_observer<int> o;
...
TEST(std_observable_deque_test_suite, test_observable_deque_pop_back)
{
    // Test pop back
    m::observable_deque<int>::ptr d = m::observable_deque<int>::create();
    deque_observer<int> o;
...
TEST(std_observable_deque_test_suite, test_observable_deque_pop_front)
{
    // Test pop front
    m::observable_deque<int>::ptr d = m::observable_deque<int>::create();
    deque_observer<int> o;
...
TEST(std_observable_deque_test_suite, test_observable_deque_erase_position)
{
    // Test erase position
    m::observable_deque<int>::ptr d = m::observable_deque<int>::create();
    deque_observer<int> o;
...
TEST(std_observable_deque_test_suite, test_observable_deque_erase_range)
{
    // Test erase range
    m::observable_deque<int>::ptr d = m::observable_deque<int>::create();
    deque_observer<int> o;
...
TEST(std_observable_deque_test_suite, test_observable_deque_swap)
{
    // Test swap
    m::observable_deque<int>::ptr v1 = m::observable_deque<int>::create();
    m::observable_deque<int>::ptr v2 = m::observable_deque<int>::create();
...
TEST(std_observable_deque_test_suite, test_observable_deque_clear)
{
    // Test clear
    m::observable_deque<int>::ptr d = m::observable_deque<int>::create();
    deque_observer<int> o;
