#ifndef GO_MVVM_TEST_SPLICE_AFTER_ELEMENT_RANGE_IPP_INCLUDED
#define GO_MVVM_TEST_SPLICE_AFTER_ELEMENT_RANGE_IPP_INCLUDED

//
//  test_splice_after_element_range.ipp
//
...
template<class C>
inline void test_splice_after_element_range()
{
    ...
    std::advance(it2last, 4);
    EXPECT_EQ(50, *it2last);

    container1->splice_after(it1, *container2, it2first, it2last);
...
#endif  // #ifndef GO_MVVM_TEST_SPLICE_AFTER_ELEMENT_RANGE_IPP_INCLUDED
