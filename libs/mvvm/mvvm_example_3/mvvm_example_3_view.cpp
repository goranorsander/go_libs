...
IMPLEMENT_DYNCREATE(mvvm_example_3_view, CFormView)

BEGIN_MESSAGE_MAP(mvvm_example_3_view, CFormView)
END_MESSAGE_MAP()
...
void mvvm_example_3_view::DoDataExchange(CDataExchange* pDX)
{
...
void mvvm_example_3_view::OnInitialUpdate()
{
...
mvvm_example_3_doc* mvvm_example_3_view::GetDocument() const
{
