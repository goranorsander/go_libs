...
// create_u32string
s::u32string create_u32string(const std::string& s)
{
    return s::string_cast<s::u32string>(s);
}
...
public:
    ...
    p::value_u32property<std::string> name;
     ...
     spaceship()
        : crew_complement(create_u32string("crew_complement"), 1012)
        , max_speed(create_u32string("max_speed"), 9.8)
        , name(create_u32string("name"), std::string("USS Enterprise (NCC-1701-D)"))
    {
    }
...
TEST(boost_u32property_test_suite, value_properties)
{
    spaceship s;

	// Property name
	EXPECT_EQ(create_u32string("crew_complement"), s.crew_complement.name());
	EXPECT_EQ(create_u32string("max_speed"), s.max_speed.name());
	EXPECT_EQ(create_u32string("name"), s.name.name());
...
{
public:
    pro::value_u32property<int> crew_complement;
    pro::value_u32property<double> max_speed;
    pro::value_u32property<std::string> name;
...
TEST(boost_u32property_test_suite, read_only_value_properties)
{
...
{
public:
    pwo::value_u32property<int> crew_complement;
    pwo::value_u32property<double> max_speed;
    pwo::value_u32property<std::string> name;
...
TEST(boost_u32property_test_suite, write_only_value_properties)
{
...
public:
    ...
    reference_spaceship()
        : crew_complement(create_u32string("crew_complement"))
        , max_speed(create_u32string("max_speed"))
        , name(create_u32string("name"))
    {
    }
};

TEST(boost_u32property_test_suite, reference_properties)
{
...
{
public:
    pro::reference_u32property<int> crew_complement;
    pro::reference_u32property<double> max_speed;
    pro::reference_u32property<std::string> name;

    read_only_reference_spaceship(const int& _crew_complement, const double& _max_speed, const std::string& _name)
        : crew_complement(create_u32string("crew_complement"), _crew_complement)
        , max_speed(create_u32string("max_speed"), _max_speed)
        , name(create_u32string("name"), _name)
    {
    }
};

TEST(boost_u32property_test_suite, read_only_reference_properties)
{
    int store_crew_complement = 1012;
    double store_max_speed = 9.8;
    std::string store_name("USS Enterprise (NCC-1701-D)");
...
{
public:
    pwo::reference_u32property<int> crew_complement;
    pwo::reference_u32property<double> max_speed;
    pwo::reference_u32property<std::string> name;
...
TEST(boost_u32property_test_suite, write_only_reference_properties)
{
    int store_crew_complement = 1012;
    double store_max_speed = 9.8;
    std::string store_name("USS Enterprise (NCC-1701-D)");
...
public:
    ...
    armed_spaceship()
        : spaceship()
        , phaser_arrays(create_u32string("phaser_arrays"))
        , _armament()
    {
        update_bindings();
    }
...
TEST(boost_u32property_test_suite, proxy_properties)
{
    armed_spaceship s;
	...
	// Property name
	EXPECT_EQ(create_u32string("phaser_arrays"), s.phaser_arrays.name());
...
{
public:
    pro::u32property<int> phaser_arrays;
...
TEST(boost_u32property_test_suite, read_only_proxy_properties)
{
...
{
public:
    pwo::u32property<int> phaser_arrays;
...
TEST(boost_u32property_test_suite, write_only_proxy_properties)
{
