...
# functor set_property_value

```c++
<go_boost/mvvm/utility/phoenix_property_value_access_functor.hpp>
```

[Boost.Phoenix](https://www.boost.org/doc/libs/1_69_0/libs/phoenix/doc/html/index.html)
...
The **set_property_value** functor enables lambda style function binding to
