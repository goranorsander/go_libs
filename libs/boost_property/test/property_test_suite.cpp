...
template <>
class TypeWithoutFormatter<p::value_property<double>, kConvertibleToInteger>
{
public:
	static void PrintValue(const p::value_property<double>& value, ::std::ostream* os)
	{
...
TEST(boost_property_test_suite, read_only_value_properties)
{
...
TEST(boost_property_test_suite, write_only_value_properties)
{
...
TEST(boost_property_test_suite, reference_properties)
{
...
TEST(boost_property_test_suite, read_only_reference_properties)
{
    int store_crew_complement = 1012;
    double store_max_speed = 9.8;
    std::string store_name("USS Enterprise (NCC-1701-D)");
...
TEST(boost_property_test_suite, write_only_reference_properties)
{
    int store_crew_complement = 1012;
    double store_max_speed = 9.8;
    std::string store_name("USS Enterprise (NCC-1701-D)");
...
TEST(boost_property_test_suite, proxy_properties)
{
    armed_spaceship s;
...
TEST(boost_property_test_suite, read_only_proxy_properties)
{
...
TEST(boost_property_test_suite, write_only_proxy_properties)
{
