...
TEST(std_observable_object_lambda_test_suite, required_cpp11_feature_not_supported) {}
#else
...
using spaceship_type = go_test::lambda::observable_spaceship<go_test::spaceship_traits<string_type>>;
