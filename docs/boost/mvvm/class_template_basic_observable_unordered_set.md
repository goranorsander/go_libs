...
keys, hashed by keys. It wraps the [**boost\::unordered_set**](https://www.boost.org/doc/libs/1_70_0/doc/html/boost/unordered_set.html)
...
Constructs a new **basic_observable_unordered_set<key_type, value_type, string_type>** object and return it as a
