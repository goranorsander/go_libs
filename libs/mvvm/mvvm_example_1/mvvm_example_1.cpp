...
mvvm_example_1_app theApp;

BEGIN_MESSAGE_MAP(mvvm_example_1_app, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()

mvvm_example_1_app::~mvvm_example_1_app()
{
}
...
BOOL mvvm_example_1_app::InitInstance()
{
...
BOOL mvvm_example_1_app::PreTranslateMessage(MSG* pMsg)
{
