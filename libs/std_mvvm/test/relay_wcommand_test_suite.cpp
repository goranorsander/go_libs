...
TEST(std_relay_wcommand_test_suite, test_relay_wcommand)
{
    ...
    std::shared_ptr<test_relay_wcommand> command(new test_relay_wcommand(std::bind(&test_relay_wcommand_exection_context::execute, &command_exection_context, std::placeholders::_1),
        std::bind(&test_relay_wcommand_exection_context::can_execute, &command_exection_context, std::placeholders::_1)));
    ...
    command->can_execute_changed.connect(std::bind(&test_relay_wcommand_observer::on_can_execute_changed, &command_observer, std::placeholders::_1));
