...
mvvm_mfc_example_2_app theApp;

BEGIN_MESSAGE_MAP(mvvm_mfc_example_2_app, CWinApp)
    ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()

mvvm_mfc_example_2_app::~mvvm_mfc_example_2_app()
{
}
...
BOOL mvvm_mfc_example_2_app::InitInstance()
{
...
BOOL mvvm_mfc_example_2_app::PreTranslateMessage(MSG* pMsg)
{
