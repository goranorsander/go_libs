...
TEST(boost_wobservable_deque_test_suite, test_wobservable_deque_assign_range)
{
    // Test assign range
...
TEST(boost_wobservable_deque_test_suite, test_wobservable_deque_assign_initializer_list)
{
...
TEST(boost_wobservable_deque_test_suite, test_wobservable_deque_assign_fill)
{
    // Test assign fill
...
TEST(boost_wobservable_deque_test_suite, test_wobservable_deque_push_back)
{
    // Test push back
    m::wobservable_deque<int>::ptr d = m::wobservable_deque<int>::create();
    deque_observer<int> o;
...
TEST(boost_wobservable_deque_test_suite, test_wobservable_deque_push_front)
{
    // Test push front
    m::wobservable_deque<int>::ptr d = m::wobservable_deque<int>::create();
    deque_observer<int> o;
...
TEST(boost_wobservable_deque_test_suite, test_wobservable_deque_pop_back)
{
    // Test pop back
    m::wobservable_deque<int>::ptr d = m::wobservable_deque<int>::create();
    deque_observer<int> o;
...
TEST(boost_wobservable_deque_test_suite, test_wobservable_deque_pop_front)
{
    // Test pop front
    m::wobservable_deque<int>::ptr d = m::wobservable_deque<int>::create();
    deque_observer<int> o;
...
TEST(boost_wobservable_deque_test_suite, test_wobservable_deque_erase_position)
{
    // Test erase position
    m::wobservable_deque<int>::ptr d = m::wobservable_deque<int>::create();
    deque_observer<int> o;
...
TEST(boost_wobservable_deque_test_suite, test_wobservable_deque_erase_range)
{
    // Test erase range
    m::wobservable_deque<int>::ptr d = m::wobservable_deque<int>::create();
    deque_observer<int> o;
...
TEST(boost_wobservable_deque_test_suite, test_wobservable_deque_swap)
{
    // Test swap
    m::wobservable_deque<int>::ptr v1 = m::wobservable_deque<int>::create();
    m::wobservable_deque<int>::ptr v2 = m::wobservable_deque<int>::create();
...
TEST(boost_wobservable_deque_test_suite, test_wobservable_deque_clear)
{
    // Test clear
    m::wobservable_deque<int>::ptr d = m::wobservable_deque<int>::create();
    deque_observer<int> o;
