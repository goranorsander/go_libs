...
TEST(std_basic_observable_list_test_suite, required_cpp11_feature_not_supported) {}
#else

using container_type = m::basic_observable_list<int, s::u8string>;
using double_container_type = m::basic_observable_list<double, s::u8string>;
...
TEST(std_basic_observable_list_test_suite, test_splice_entire_container)
{
