...
public:
    ...
    {
        c->container_changed.connect(boost::bind(&set_observer::on_container_changed, this, _1, _2));
        c->property_changed.connect(boost::bind(&set_observer::on_property_changed, this, _1, _2));
    }

    void disconnect(observable_unordered_set_ptr_type& c)
    {
        c->container_changed.disconnect(boost::bind(&set_observer::on_container_changed, this, _1, _2));
        c->property_changed.disconnect(boost::bind(&set_observer::on_property_changed, this, _1, _2));
    }
