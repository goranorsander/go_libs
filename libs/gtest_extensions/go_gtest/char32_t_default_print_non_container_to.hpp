...
#if defined(GO_GTEST_FOR_CPP03) && !(defined(GO_NO_CXX11_CHAR32_T) || defined(GO_BOOST_NO_CXX11_CHAR32_T))
...
#endif  // #if defined(GO_GTEST_FOR_CPP03) && !(defined(GO_NO_CXX11_CHAR32_T) || defined(GO_BOOST_NO_CXX11_CHAR32_T))
