...
```c++
<go/type_traits/primitive_type_implicit_specializer.hpp>
```
...
using my_integer_type = go::type_traits::primitive_type_implicit_specializer<long, my_integer_type_tag>;
```
