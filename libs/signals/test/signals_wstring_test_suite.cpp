...
TEST(signals_wstring_test_suite, test_fire_lasers)
{
    TEST_CASE_SHIPYARD
...
TEST(signals_wstring_test_suite, test_fire_proton_torpedoes)
{
    TEST_CASE_SHIPYARD
...
TEST(signals_wstring_test_suite, test_fire_all_weapons)
{
    TEST_CASE_SHIPYARD
