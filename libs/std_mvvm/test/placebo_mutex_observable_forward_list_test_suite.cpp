//
//  placebo_mutex_observable_forward_list_test_suite.cpp
//
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, cpp11_not_supported) {}
#else
...
public:
    ...
    typedef typename m::observable_forward_list<T, u::placebo_mutex>::ptr observable_forward_list_ptr_type;
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, test_assign_range)
{
    // Test assign range
    m::observable_forward_list<int, u::placebo_mutex>::ptr l = m::observable_forward_list<int, u::placebo_mutex>::create();
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, test_assign_initializer_list)
{
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, test_assign_fill)
{
    // Test assign fill
    m::observable_forward_list<int, u::placebo_mutex>::ptr l1 = m::observable_forward_list<int, u::placebo_mutex>::create();
    m::observable_forward_list<int, u::placebo_mutex>::ptr l2 = m::observable_forward_list<int, u::placebo_mutex>::create();
    forward_list_observer<int> o;
    ...
    m::observable_forward_list<int, u::placebo_mutex>::iterator begin = l1->begin();
    ++begin;
    m::observable_forward_list<int, u::placebo_mutex>::iterator end = begin;
    std::advance(end, 5);
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, test_push_front)
{
    // Test push front
    m::observable_forward_list<int, u::placebo_mutex>::ptr l = m::observable_forward_list<int, u::placebo_mutex>::create();
    forward_list_observer<int> o;
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, test_pop_front)
{
    // Test pop front
    m::observable_forward_list<int, u::placebo_mutex>::ptr l = m::observable_forward_list<int, u::placebo_mutex>::create();
    forward_list_observer<int> o;
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, test_insert_after_single_element)
{
    ...
    m::observable_forward_list<int, u::placebo_mutex>::iterator it = l->begin();
    std::advance(it, 2);
    l->insert_after(it, 4);
    EXPECT_EQ(7, l->size());
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, test_insert_after_fill)
{
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, test_insert_after_range)
{
    ...
    m::observable_forward_list<int, u::placebo_mutex>::iterator it = l2->begin();
    std::advance(it, 3);
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, test_erase_position)
{
    // Test erase position
    m::observable_forward_list<int, u::placebo_mutex>::ptr l = m::observable_forward_list<int, u::placebo_mutex>::create();
    forward_list_observer<int> o;
    ...
    m::observable_forward_list<int, u::placebo_mutex>::iterator it1 = l->begin();
    std::advance(it1, 3);
    m::observable_forward_list<int, u::placebo_mutex>::iterator it2 = l->erase_after(it1);
    EXPECT_EQ(6, l->size());
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, test_erase_range)
{
    // Test erase range
    m::observable_forward_list<int, u::placebo_mutex>::ptr l = m::observable_forward_list<int, u::placebo_mutex>::create();
    forward_list_observer<int> o;
    ...
    m::observable_forward_list<int, u::placebo_mutex>::iterator begin = l->begin();
    ++begin;
    m::observable_forward_list<int, u::placebo_mutex>::iterator end = begin;
    std::advance(end, 5);
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, test_swap)
{
    // Test swap
    m::observable_forward_list<int, u::placebo_mutex>::ptr l1 = m::observable_forward_list<int, u::placebo_mutex>::create();
    m::observable_forward_list<int, u::placebo_mutex>::ptr l2 = m::observable_forward_list<int, u::placebo_mutex>::create();
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, test_clear)
{
    // Test clear
    m::observable_forward_list<int, u::placebo_mutex>::ptr l = m::observable_forward_list<int, u::placebo_mutex>::create();
    forward_list_observer<int> o;
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, test_emplace_after)
{
    // Test emplace after
    m::observable_forward_list<int, u::placebo_mutex>::ptr l = m::observable_forward_list<int, u::placebo_mutex>::create();
    forward_list_observer<int> o;
    ...
    m::observable_forward_list<int, u::placebo_mutex>::iterator begin = l->begin();
    ++begin;
    m::observable_forward_list<int, u::placebo_mutex>::iterator it = l->emplace_after(begin, 4);
    EXPECT_EQ(4, *it);
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, test_emplace_back)
{
    // Test emplace back
    m::observable_forward_list<int, u::placebo_mutex>::ptr l = m::observable_forward_list<int, u::placebo_mutex>::create();
    forward_list_observer<int> o;
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, test_emplace_front)
{
    // Test emplace front
    m::observable_forward_list<int, u::placebo_mutex>::ptr l = m::observable_forward_list<int, u::placebo_mutex>::create();
    forward_list_observer<int> o;
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, test_splice_after_entire_forward_list)
{
    ...
    m::observable_forward_list<int, u::placebo_mutex>::iterator it1 = l1->begin();
    ++it1;
    EXPECT_EQ(2, *it1);
    ...
    m::observable_forward_list<int, u::placebo_mutex>::iterator it = l1->begin();
    EXPECT_EQ(1, *it);
    ++it;
    EXPECT_EQ(2, *it);
    ++it;
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, test_splice_after_single_element)
{
    ...
    m::observable_forward_list<int, u::placebo_mutex>::iterator it2 = l2->begin();
    std::advance(it2, 3);
    EXPECT_EQ(2, *it2);
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, test_splice_after_element_range)
{
    ...
    m::observable_forward_list<int, u::placebo_mutex>::iterator it2first = l2->begin();
    ++it2first;
    EXPECT_EQ(20, *it2first);

    m::observable_forward_list<int, u::placebo_mutex>::iterator it2last = l2->begin();
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, test_remove)
{
    // Test remove
    m::observable_forward_list<int, u::placebo_mutex>::ptr l = m::observable_forward_list<int, u::placebo_mutex>::create();
    forward_list_observer<int> o;
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, test_remove_if)
{
    // Test remove if
    m::observable_forward_list<int, u::placebo_mutex>::ptr l = m::observable_forward_list<int, u::placebo_mutex>::create();
    forward_list_observer<int> o;
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, test_unique)
{
    // Test unique
    m::observable_forward_list<int, u::placebo_mutex>::ptr l = m::observable_forward_list<int, u::placebo_mutex>::create();
    forward_list_observer<int> o;
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, test_unique_binary_predicate)
{
    // Test unique binary predicate
    m::observable_forward_list<double, u::placebo_mutex>::ptr l = m::observable_forward_list<double, u::placebo_mutex>::create();
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, test_merge)
{
    // Test merge
    m::observable_forward_list<double, u::placebo_mutex>::ptr l1 = m::observable_forward_list<double, u::placebo_mutex>::create();
    m::observable_forward_list<double, u::placebo_mutex>::ptr l2 = m::observable_forward_list<double, u::placebo_mutex>::create();
...
TEST(std_observable_forward_list_placebo_mutex_test_suite, test_merge_compare_predicate)
{
