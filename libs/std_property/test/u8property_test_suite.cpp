...
TEST(std_u8property_test_suite, required_cpp11_feature_not_supported) {}
#else
...
{
public:
    p::value_u8property<int> crew_complement;
    p::value_u8property<double> max_speed;
    p::value_u8property<std::string> name;

     spaceship()
        : crew_complement(create_u8string("crew_complement"), 1012)
        , max_speed(create_u8string("max_speed"), 9.8)
        , name(create_u8string("name"), std::string("USS Enterprise (NCC-1701-D)"))
    {
    }
...
TEST(std_u8property_test_suite, value_properties)
{
    spaceship s;

	// Property name
	EXPECT_EQ(create_u8string("crew_complement"), s.crew_complement.name());
	EXPECT_EQ(create_u8string("max_speed"), s.max_speed.name());
	EXPECT_EQ(create_u8string("name"), s.name.name());
...
// Test read_only::value_u8property
class read_only_spaceship
{
public:
    pro::value_u8property<int> crew_complement;
    pro::value_u8property<double> max_speed;
    pro::value_u8property<std::string> name;
...
TEST(std_u8property_test_suite, read_only_value_properties)
{
...
// Test write_only::value_u8property
class write_only_spaceship
{
public:
    pwo::value_u8property<int> crew_complement;
    pwo::value_u8property<double> max_speed;
    pwo::value_u8property<std::string> name;
...
TEST(std_u8property_test_suite, write_only_value_properties)
{
...
// Test reference_u8property
class reference_spaceship
{
public:
    p::reference_u8property<int> crew_complement;
    p::reference_u8property<double> max_speed;
    p::reference_u8property<std::string> name;

    reference_spaceship()
        : crew_complement(create_u8string("crew_complement"))
        , max_speed(create_u8string("max_speed"))
        , name(create_u8string("name"))
    {
    }
};

TEST(std_u8property_test_suite, reference_properties)
{
...
// Test read_only::reference_u8property
class read_only_reference_spaceship
{
public:
    pro::reference_u8property<int> crew_complement;
    pro::reference_u8property<double> max_speed;
    pro::reference_u8property<std::string> name;

    read_only_reference_spaceship(const int& _crew_complement, const double& _max_speed, const std::string& _name)
        : crew_complement(create_u8string("crew_complement"), _crew_complement)
        , max_speed(create_u8string("max_speed"), _max_speed)
        , name(create_u8string("name"), _name)
    {
    }
};

TEST(std_u8property_test_suite, read_only_reference_properties)
{
    int store_crew_complement = 1012;
    double store_max_speed = 9.8;
    std::string store_name("USS Enterprise (NCC-1701-D)");
...
// Test write_only::reference_u8property
class write_only_reference_spaceship
{
public:
    pwo::reference_u8property<int> crew_complement;
    pwo::reference_u8property<double> max_speed;
    pwo::reference_u8property<std::string> name;
...
TEST(std_u8property_test_suite, write_only_reference_properties)
{
    int store_crew_complement = 1012;
    double store_max_speed = 9.8;
    std::string store_name("USS Enterprise (NCC-1701-D)");
...
{
public:
    p::u8property<int> phaser_arrays;

    armed_spaceship()
        : spaceship()
        , phaser_arrays(create_u8string("phaser_arrays"))
        , _armament()
    {
        update_bindings();
    }
...
TEST(std_u8property_test_suite, proxy_properties)
{
    armed_spaceship s;
	...
	// Property name
	EXPECT_EQ(create_u8string("phaser_arrays"), s.phaser_arrays.name());
...
{
public:
    pro::u8property<int> phaser_arrays;
...
TEST(std_u8property_test_suite, read_only_proxy_properties)
{
...
{
public:
    pwo::u8property<int> phaser_arrays;
...
TEST(std_u8property_test_suite, write_only_proxy_properties)
{
