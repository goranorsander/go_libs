...
Constructs a new **basic_observable_forward_list<value_type, string_type, mutex_type>** object and return it as a
**basic_observable_forward_list<value_type, string_type, mutex_type>\::ptr** object.
